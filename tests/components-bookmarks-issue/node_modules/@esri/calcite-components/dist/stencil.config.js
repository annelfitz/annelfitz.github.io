...
export const create = () => ({
    ...
    outputTargets: [
        angularOutputTarget({
            ...
            directivesProxyFile: "../calcite-components-angular/projects/component-library/src/lib/stencil-generated/components.ts",
            directivesArrayFile: "../calcite-components-angular/projects/component-library/src/lib/stencil-generated/index.ts",
        }),
        reactOutputTarget({
            componentCorePackage: "@esri/calcite-components",
    ...
    testing: {
        ...
        transform: {
            "calcite-design-tokens/dist/es6/.*\\.js$": "<rootDir>../../node_modules/@stencil/core/testing/jest-preprocessor.js",
        },
    },
    hydratedFlag: {
        selector: "attribute",
