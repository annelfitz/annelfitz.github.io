...
import { d as focusElement, e as getSlotted, t as toAriaBoolean } from './dom-bea5da81.js';
import { d as debounce } from './debounce-00101a41.js';
import { h, H as Host } from './index-2e6dbb80.js';
import { I as InteractiveContainer } from './interactive-a992f5df.js';
        ...
        h(InteractiveContainer, { disabled: disabled },
            h("section", null,
                ...
                h("header", { class: { [CSS$1.sticky]: true } },
                    filterEnabled ? (h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, value: filterText, 
                        // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
...
//# sourceMappingURL=resources-75331453.js.map