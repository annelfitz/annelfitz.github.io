...
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-3f199679.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-ce4d8e83.js';
import { t as toAriaBoolean, b as slotChangeHasAssignedElement } from './dom-bea5da81.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-ccbc05e8.js';
import { c as createObserver } from './observers-fe652afa.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable, b as componentLoaded } from './loadable-0092c6b2.js';
...
const TextArea = class {
    ...
    render() {
        ...
        return (h(Host, null, h(InteractiveContainer, { disabled: this.disabled }, h("textarea", { "aria-describedby": this.guid, "aria-invalid": toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": getLabelText(this), autofocus: this.autofocus, class: {
