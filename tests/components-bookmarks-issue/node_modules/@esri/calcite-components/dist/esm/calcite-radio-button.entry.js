 ...
 * v2.6.0
 */
import { r as registerInstance, c as createEvent, f as forceUpdate, h, H as Host, g as getElement } from './index-2e6dbb80.js';
import { g as getRoundRobinIndex } from './array-1612f3a9.js';
import { g as getElementDir, d as focusElement, t as toAriaBoolean } from './dom-bea5da81.js';
...
const RadioButton = class {
    ...
    render() {
        ...
        return (h(Host, { onClick: this.clickHandler, onKeyDown: this.handleKeyDown }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { "aria-checked": toAriaBoolean(this.checked), "aria-label": getLabelText(this), class: CSS.container, onBlur: this.onContainerBlur, onFocus: this.onContainerFocus, role: "radio", tabIndex: tabIndex,
