 ...
 * v2.6.0
 */
import { r as registerInstance, h, F as Fragment, H as Host, g as getElement } from './index-2e6dbb80.js';
...
import { g as getElementDir } from './dom-bea5da81.js';
...
const TableHeader = class {
    ...
    render() {
        ...
        return (h(Host, null, h("th", { "aria-colindex": this.parentRowType === "head" ? this.positionInRow : undefined, class: {
