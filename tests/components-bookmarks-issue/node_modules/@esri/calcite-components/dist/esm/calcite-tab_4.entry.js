...
import { z as nodeListToArray, l as focusElementInGroup, g as getElementDir, A as filterDirectChildren, t as toAriaBoolean } from './dom-bea5da81.js';
import { g as guid } from './guid-9a252389.js';
import { c as createObserver } from './observers-fe652afa.js';
import { c as connectInteractive, d as disconnectInteractive, I as InteractiveContainer, u as updateHostInteraction } from './interactive-a992f5df.js';
...
const Tab = class {
    ...
    render() {
        ...
        return (h(Host, { "aria-labelledby": this.labeledBy, id: id }, h("div", { class: { [CSS$2.container]: true, [`scale-${this.scale}`]: true }, role: "tabpanel", tabIndex: this.selected ? 0 : -1 }, h("section", { class: CSS$2.content }, h("slot", null)))));
    }
    connectedCallback() {
