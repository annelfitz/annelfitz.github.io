...
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-a992f5df.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-ccbc05e8.js';
    ...
    if (mode === "offset") {
        if (!timeZoneGroups) {
            timeZoneGroups = Promise.all([
                import('./index-ba81c72a.js'),
                import('./index-1e9a7cab.js'),
            ]);
        }
