...
import { e as getSlotted, i as isPrimaryPointerButton, h as setRequestedIcon, g as getElementDir } from './dom-bea5da81.js';
import { s as submitForm, c as connectForm, i as internalHiddenInputInputEvent, d as disconnectForm, H as HiddenFormInputSlot } from './form-3f199679.js';
...
import { a as setComponentLoaded, s as setUpLoadableComponent, c as componentFocusable } from './loadable-0092c6b2.js';
import { n as numberStringFormatter, i as isValidNumber, p as parseNumberString, s as sanitizeNumberString, a as addLocalizedTrailingDecimalZeros, c as connectLocalized, d as disconnectLocalized, B as BigDecimal } from './locale-ccbc05e8.js';
import { c as createObserver } from './observers-fe652afa.js';
import { C as CSS_UTILITY } from './resources-ed5aea48.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-e5ee6b09.js';
import { g as getIconScale } from './component-ec9f9062.js';
import { V as Validation } from './Validation-3bdaf762.js';
import { s as syncHiddenFormInput } from './input-c7999a57.js';
...
const InputNumber = class {
    ...
    render() {
        ...
        return (h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.numberButtonType === "horizontal" && !this.readOnly
