 ...
 * v2.6.0
 */
import { r as registerInstance, c as createEvent, h, g as getElement, F as Fragment, H as Host } from './index-2e6dbb80.js';
import { c as createObserver } from './observers-fe652afa.js';
import { d as focusElement } from './dom-bea5da81.js';
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-3f199679.js';
...
const Select = class {
    ...
    render() {
        ...
        return (h(Host, null, h(InteractiveContainer, { disabled: disabled }, h("div", { class: CSS.wrapper }, h("select", { "aria-label": getLabelText(this), class: CSS.select, disabled: disabled, onChange: this.handleInternalSelectChange,
            ...
            ref: this.storeSelectRef }, h("slot", null)), this.renderChevron(), h(HiddenFormInputSlot, { component: this })), this.validationMessage && this.status === "invalid" ? (h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
        "value": ["valueHandler"],
