...
import { f as focusFirstTabbable, e as getSlotted, t as toAriaBoolean, g as getElementDir } from './dom-bea5da81.js';
...
const Block = class {
    ...
    render() {
        ...
        return (h(Host, null, h(InteractiveContainer, { disabled: this.disabled }, h("article", { "aria-busy": toAriaBoolean(loading), class: {
            ...
            } }, headerNode, h("section", { "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content,
