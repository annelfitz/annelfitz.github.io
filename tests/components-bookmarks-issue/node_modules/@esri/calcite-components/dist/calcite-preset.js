 ...
 */
function invert(value, flagPropName) {
    return `calc(
            ${value} *
            calc(
              1 -
...
export default {
    theme: {
        ...
        fontSize: {
            // assets/styles/_type
            n3: "var(--calcite-font-size--3)",
            n2: "var(--calcite-font-size--2)",
            n1: "var(--calcite-font-size--1)",
            ...
            n3h: ["var(--calcite-font-size--3)", { lineHeight: "0.75rem" }],
            n2h: ["var(--calcite-font-size--2)", { lineHeight: "1rem" }],
            n1h: ["var(--calcite-font-size--1)", { lineHeight: "1rem" }],
...
//# sourceMappingURL=calcite-preset.js.map
