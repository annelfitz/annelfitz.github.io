...
export declare class RadioButton implements LabelableComponent, CheckableFormComponent, InteractiveComponent, LoadableComponent {
    ...
    private updateTabIndexOfOtherRadioButtonsInGroup;
    private getTabIndex;
    /**
