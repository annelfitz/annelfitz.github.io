 ...
 */
export declare class Tooltip implements FloatingUIComponent, OpenCloseComponent {
    ...
    calciteTooltipBeforeClose: EventEmitter<void>;
    /** Fires when the component is closed and animation is complete. */
    calciteTooltipClose: EventEmitter<void>;
    /** Fires when the component is added to the DOM but not rendered, and before the opening transition begins. */
    calciteTooltipBeforeOpen: EventEmitter<void>;
    /** Fires when the component is open and animation is complete. */
    calciteTooltipOpen: EventEmitter<void>;
    /**
