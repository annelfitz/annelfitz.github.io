...
export declare function internalCalciteListFilterEvent<T extends Lists>(this: List<T>): void;
...
export declare function handleFilter<T extends Lists>(this: List<T>, emit?: boolean): void;
export declare function handleInitialFilter<T extends Lists>(this: List<T>): void;
export declare function handleFilterEvent<T extends Lists>(this: List<T>, event: CustomEvent): void;
