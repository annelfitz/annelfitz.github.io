 ...
 */
export declare class PickListItem implements ConditionalSlotComponent, InteractiveComponent, LoadableComponent, T9nComponent {
    /**
    ...
    defaultMessages: PickListItemMessages;
