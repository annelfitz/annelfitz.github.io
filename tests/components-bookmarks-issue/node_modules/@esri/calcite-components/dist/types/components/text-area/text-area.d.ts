 ...
 */
export declare class TextArea implements FormComponent, LabelableComponent, LocalizedComponent, LoadableComponent, T9nComponent, InteractiveComponent, Omit<TextualInputComponent, "pattern"> {
    /**
    ...
    private guid;
    private localizedCharacterLengthObj;
    onLabelClick(): void;
