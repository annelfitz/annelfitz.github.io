 ...
 */
export declare class InputNumber implements LabelableComponent, FormComponent, InteractiveComponent, LocalizedComponent, NumericInputComponent, T9nComponent, TextualInputComponent, LoadableComponent {
    ...
    private nudgeButtonPointerUpHandler;
    private nudgeButtonPointerOutHandler;
