 ...
 */
export declare class Input implements LabelableComponent, FormComponent, InteractiveComponent, T9nComponent, LocalizedComponent, LoadableComponent, NumericInputComponent, TextualInputComponent {
