...
const resources = require('./resources-fe1c98cd.js');
const sortableComponent = require('./sortableComponent-c4055aa2.js');
    ...
    renderHandle() {
        ...
        if (icon === resources.ICON_TYPES.grip) {
            return (index.h("span", { class: {
                ...
                ref: (el) => (this.handleEl = el) }, index.h("calcite-icon", { flipRtl: iconFlipRtl, icon: ICONS.drag, scale: "s" })));
        }
    }
    render() {
        return (index.h(index.Host, { id: this.el.id || this.guid }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, this.renderHandle(), index.h("calcite-pick-list-item", { description: this.description, deselectDisabled: this.deselectDisabled, disabled: this.disabled, label: this.label, metadata: this.metadata, nonInteractive: this.nonInteractive, onCalciteListItemChange: this.handleSelectChange, removable: this.removable, selected: this.selected, value: this.value,
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
