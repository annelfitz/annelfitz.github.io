        ...
        index.h(interactive.InteractiveContainer, { disabled: disabled },
            index.h("section", null,
                ...
                index.h("header", { class: { [CSS$1.sticky]: true } },
                    filterEnabled ? (index.h("calcite-filter", { "aria-label": filterPlaceholder, disabled: disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, value: filterText, 
                        // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
...
//# sourceMappingURL=resources-fe1c98cd.js.map