...
const locale$1 = require('./locale-a5749882.js');
const focusTrapComponent = require('./focusTrapComponent-781af75d.js');
const math = require('./math-26a12122.js');
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
    ["ar", () => Promise.resolve().then(function () { return require('./ar-f512f1cc.js'); })],
    ["bg", () => Promise.resolve().then(function () { return require('./bg-55139749.js'); })],
    ["bs", () => Promise.resolve().then(function () { return require('./bs-e80ba21a.js'); })],
    ["ca", () => Promise.resolve().then(function () { return require('./ca-eb5f79d4.js'); })],
    ["cs", () => Promise.resolve().then(function () { return require('./cs-63b0504b.js'); })],
    ["da", () => Promise.resolve().then(function () { return require('./da-82cafa51.js'); })],
    ["de", () => Promise.resolve().then(function () { return require('./de-d41e9a21.js'); })],
    ["de-at", () => Promise.resolve().then(function () { return require('./de-at-e9a63f9f.js'); })],
    ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-2e577db5.js'); })],
    ["el", () => Promise.resolve().then(function () { return require('./el-a1a0cca9.js'); })],
    ["en", () => Promise.resolve().then(function () { return en$1; })],
    ["en-au", () => Promise.resolve().then(function () { return require('./en-au-c26b0742.js'); })],
    ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-d1920660.js'); })],
    ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-1f839448.js'); })],
    ["es", () => Promise.resolve().then(function () { return require('./es-2e5cb166.js'); })],
    ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-1a5e76e4.js'); })],
    ["et", () => Promise.resolve().then(function () { return require('./et-6feea455.js'); })],
    ["fi", () => Promise.resolve().then(function () { return require('./fi-b7cba96b.js'); })],
    ["fr", () => Promise.resolve().then(function () { return require('./fr-210378cf.js'); })],
    ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-8009cc63.js'); })],
    ["he", () => Promise.resolve().then(function () { return require('./he-fcc552f8.js'); })],
    ["hi", () => Promise.resolve().then(function () { return require('./hi-c6275606.js'); })],
    ["hr", () => Promise.resolve().then(function () { return require('./hr-9e8df30a.js'); })],
    ["hu", () => Promise.resolve().then(function () { return require('./hu-63298519.js'); })],
    ["id", () => Promise.resolve().then(function () { return require('./id-9d594158.js'); })],
    ["it", () => Promise.resolve().then(function () { return require('./it-a4fe59ba.js'); })],
    ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-6c3c624e.js'); })],
    ["ja", () => Promise.resolve().then(function () { return require('./ja-b694414a.js'); })],
    ["ko", () => Promise.resolve().then(function () { return require('./ko-9830a155.js'); })],
    ["lt", () => Promise.resolve().then(function () { return require('./lt-ca47b9ab.js'); })],
    ["lv", () => Promise.resolve().then(function () { return require('./lv-61cfcb38.js'); })],
    ["mk", () => Promise.resolve().then(function () { return require('./mk-b6ac028f.js'); })],
    ["nl", () => Promise.resolve().then(function () { return require('./nl-3fa99395.js'); })],
    ["nb", () => Promise.resolve().then(function () { return require('./nb-70325887.js'); })],
    ["pl", () => Promise.resolve().then(function () { return require('./pl-c83f7179.js'); })],
    ["pt", () => Promise.resolve().then(function () { return require('./pt-0e143e29.js'); })],
    ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-4e90e86a.js'); })],
    ["ro", () => Promise.resolve().then(function () { return require('./ro-c40e0db4.js'); })],
    ["ru", () => Promise.resolve().then(function () { return require('./ru-8b31107d.js'); })],
    ["sk", () => Promise.resolve().then(function () { return require('./sk-6bd85072.js'); })],
    ["sl", () => Promise.resolve().then(function () { return require('./sl-6d6828e5.js'); })],
    ["sr", () => Promise.resolve().then(function () { return require('./sr-f6bf952f.js'); })],
    ["sv", () => Promise.resolve().then(function () { return require('./sv-eb789fa2.js'); })],
    ["th", () => Promise.resolve().then(function () { return require('./th-00b9b238.js'); })],
    ["tr", () => Promise.resolve().then(function () { return require('./tr-d06e3ff0.js'); })],
    ["uk", () => Promise.resolve().then(function () { return require('./uk-c1581986.js'); })],
    ["vi", () => Promise.resolve().then(function () { return require('./vi-173c5b64.js'); })],
    ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-9a524a19.js'); })],
    ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-46bb5d4f.js'); })],
    ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-f16f27f2.js'); })],
]);
...
const InputTimePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { onBlur: this.hostBlurHandler, onKeyDown: this.keyDownHandler }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick }, index.h("calcite-input-text", { "aria-autocomplete": "none", "aria-haspopup": "dialog", disabled: disabled, icon: "clock", id: this.referenceElementId, label: label.getLabelText(this), lang: this.effectiveLocale, onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextFocus: this.calciteInternalInputFocusHandler, readOnly: readOnly, role: "combobox", scale: this.scale, status: this.status,
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setCalciteTimePickerEl })), index.h(form.HiddenFormInputSlot, { component: this }), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null)));
    }
...
const TimePicker = class {
    ...
    render() {
        ...
        return (index.h("div", { class: {
            ...
            }, onClick: this.hourUpClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
                [CSS.input]: true,
                [CSS.hour]: true,
            ...
            }, onClick: this.hourDownClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), index.h("span", { class: CSS.delimiter }, this.localizedHourSuffix), index.h("div", { class: CSS.column, role: "group" }, index.h("span", { "aria-label": this.messages.minuteUp, class: {
                [CSS.button]: true,
                [CSS.buttonMinuteUp]: true,
            }, onClick: this.minuteUpClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
                [CSS.input]: true,
                [CSS.minute]: true,
            ...
            }, onClick: this.minuteDownClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), this.showSecond && index.h("span", { class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (index.h("div", { class: CSS.column, role: "group" }, index.h("span", { "aria-label": this.messages.secondUp, class: {
                [CSS.button]: true,
                [CSS.buttonSecondUp]: true,
            }, onClick: this.secondUpClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
                [CSS.input]: true,
                [CSS.second]: true,
            ...
            }, onClick: this.fractionalSecondDownClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (index.h("span", { class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (index.h("div", { class: {
                [CSS.column]: true,
            ...
            }, onClick: this.meridiemUpClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
                [CSS.input]: true,
                [CSS.meridiem]: true,
            ...
            }, onClick: this.meridiemDownClickHandler, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))))));
    }
    static get delegatesFocus() { return true; }
    static get assetsDirs() { return ["assets"]; }
    get el() { return index.getElement(this); }
...
//# sourceMappingURL=calcite-input-time-picker.calcite-time-picker-d8ae72cb.js.map