...
const TileSelect = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { disabled: disabled }, index.h("div", { class: {
            ...
            } }, index.h("div", { class: { [CSS.tile]: true, [CSS.tileLargeVisual]: isLargeVisual } }, icon && (index.h("div", { class: { [CSS.icon]: renderIcon } }, index.h("calcite-icon", { flipRtl: iconFlipRtl, icon: icon, scale: "l" }))), index.h("div", { class: CSS.tileContentContainer }, index.h("div", { class: CSS.tileContent }, heading && index.h("div", { class: CSS.tileHeading }, heading), description && index.h("div", { class: CSS.tileDescription }, description)))), index.h("slot", null))));
    }
