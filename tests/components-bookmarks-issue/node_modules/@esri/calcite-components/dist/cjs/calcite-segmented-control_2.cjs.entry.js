...
const SegmentedControl = class {
    ...
    render() {
        return (index.h(index.Host, { onClick: this.handleClick, role: "radiogroup" }, index.h("div", { class: CSS$1.itemWrapper }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("slot", null), index.h(form.HiddenFormInputSlot, { component: this }))), this.validationMessage && this.status === "invalid" ? (index.h(Validation.Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status })) : null));
    }
