...
const PickListItem = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { disabled: this.disabled }, this.renderIcon(), this.renderActionsStart(), index.h("label", { "aria-label": label, class: resources.CSS.label, onClick: this.pickListClickHandler, onKeyDown: this.pickListKeyDownHandler, tabIndex: 0,
