...
const FloatingArrow = ({ floatingLayout, key, ref, }) => {
    ...
    const dValue = "M0,0" +
        ...
        " Z";
    return (index.h("svg", { "aria-hidden": "true", class: CSS.arrow, height: width, key: key, viewBox: `0 0 ${width} ${width + (!isVertical ? strokeWidth : 0)}`, width: width + (isVertical ? strokeWidth : 0), 
...
//# sourceMappingURL=FloatingArrow-3ef3c4a4.js.map