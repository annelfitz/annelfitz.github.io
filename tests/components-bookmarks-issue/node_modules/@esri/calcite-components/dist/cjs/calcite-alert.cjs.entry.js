...
const resources = require('./resources-f27d7edb.js');
...
const Alert = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "aria-hidden": dom.toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role: role }, index.h("div", { class: {
            ...
            ref: this.setTransitionEl }, effectiveIcon && this.renderIcon(effectiveIcon), index.h("div", { class: CSS.textContainer }, index.h("slot", { name: SLOTS.title }), index.h("slot", { name: SLOTS.message }), index.h("slot", { name: SLOTS.link })), this.renderActionsEnd(), hasQueuedAlerts ? this.renderQueueCount() : null, this.renderCloseButton(), open && !queued && autoClose ? index.h("div", { class: CSS.dismissProgress }) : null)));
    }
    renderCloseButton() {
        return (index.h("button", { "aria-label": this.messages.close, class: CSS.close, key: "close", onClick: this.closeAlert, type: "button",
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
