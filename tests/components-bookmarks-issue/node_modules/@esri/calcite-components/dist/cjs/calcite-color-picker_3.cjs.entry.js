...
const utils = require('./utils-ad113cb7.js');
...
const throttle = require('./throttle-a02507f8.js');
...
const ColorPicker = class {
    ...
    render() {
        ...
        return (index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { class: CSS$2.container }, index.h("div", { class: CSS$2.controlAndScope }, index.h("canvas", { class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
