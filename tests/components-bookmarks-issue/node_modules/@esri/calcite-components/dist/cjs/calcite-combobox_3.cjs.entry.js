...
const filter = require('./filter-36b57d64.js');
...
const debounce = require('./debounce-5a998889.js');
...
const Combobox = class {
    ...
    renderSelectedOrPlaceholderIcon() {
        ...
        const selectedItem = selectedItems[0];
        const selectedIcon = selectedItem?.icon;
        return (this.showingInlineIcon && (index.h("span", { class: "icon-start", key: "selected-placeholder-icon" }, index.h("calcite-icon", { class: "selected-icon", flipRtl: this.open && selectedItem ? selectedItem.iconFlipRtl : placeholderIconFlipRtl, icon: !this.open && selectedItem ? selectedIcon : placeholderIcon, scale: component.getIconScale(this.scale) }))));
    }
    renderChevronIcon() {
        const { open } = this;
        return (index.h("span", { class: "icon-end", key: "chevron" }, index.h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: component.getIconScale(this.scale) })));
    }
    render() {
        ...
        return (index.h(index.Host, { onClick: this.comboboxFocusHandler }, index.h(interactive.InteractiveContainer, { disabled: this.disabled }, index.h("div", { "aria-autocomplete": "list", "aria-controls": `${listboxUidPrefix}${guid}`, "aria-expanded": dom.toAriaBoolean(open), "aria-haspopup": "listbox", "aria-label": label.getLabelText(this), "aria-live": "polite", "aria-owns": `${listboxUidPrefix}${guid}`, class: {
            ...
            // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
            ref: this.setReferenceEl }, this.renderSelectedOrPlaceholderIcon(), index.h("div", { class: {
                "grid-input": true,
