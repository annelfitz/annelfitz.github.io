 ...
 * v2.6.0
 */
import { dateTimeFormatCache, defaultLocale, defaultNumberingSystem, getDateTimeFormat, getSupportedLocale, locales, numberingSystems, numberStringFormatter, } from "./locale";
...
describe("getDateTimeFormat()", () => {
    ...
    it("supports passing options", () => {
        const options = { dateStyle: "full", numberingSystem: "latn" }; // using a subset and assuming other props will work the same
...
describe("getSupportedLocale", () => {
    function assertAllContexts(locale, expectedLocale) {
