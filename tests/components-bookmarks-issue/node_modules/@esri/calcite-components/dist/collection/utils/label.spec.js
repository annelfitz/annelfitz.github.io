 ...
 * v2.6.0
 */
import { connectLabel, disconnectLabel, getLabelText, labelClickEvent } from "./label";
describe("label", () => {
    function createFakeLabelable(overrides) {
        const base = {
            disabled: null,
            el: null,
            label: null,
    ...
    describe("connectLabel/disconnectLabel", () => {
        describe("wires up the associated label", () => {
             ...
             * @param label
             */
            function wireUpFakeLabel(label) {
      ...
      `;
                const fakeLabelableEl = document.querySelector("#unlabeled");
      ...
      `;
                ...
                const fakeLabelableEl = document.querySelector("#for");
      ...
      `;
                const labelEl = document.querySelector("calcite-label");
                const fakeLabelableEl = document.querySelector("fake-labelable");
                wireUpFakeLabel(labelEl);
                const labelable = createFakeLabelable({
                    el: fakeLabelableEl,
                });
      ...
      `;
                const labelEl = document.querySelector("calcite-label");
                const fakeInnerLabelableEl = document.querySelector("#inner");
                const fakeOuterLabelableEl = document.querySelector("#outer");
                wireUpFakeLabel(labelEl);
      ...
      `;
                const labelEl = document.querySelector("calcite-label");
                const fakeLabelableEl1 = document.querySelector("#first");
                const fakeLabelableEl2 = document.querySelector("#second");
                const fakeLabelableEl3 = document.querySelector("#third");
                wireUpFakeLabel(labelEl);
    ...
    it("getLabelText", () => {
        ...
        expect(getLabelText(createFakeLabelable({
            labelEl,
