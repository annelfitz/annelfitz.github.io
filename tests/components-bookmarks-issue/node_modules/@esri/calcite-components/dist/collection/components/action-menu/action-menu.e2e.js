...
import { accessible, defaults, delegatesToFloatingUiOwningComponent, focusable, hidden, reflects, renders, slots, } from "../../tests/commonTests";
...
describe("calcite-action-menu", () => {
    ...
    describe("delegates to floating-ui-owner component", () => {
        delegatesToFloatingUiOwningComponent(html `<calcite-action-menu>
    ...
    describe("Keyboard navigation", () => {
        ...
        it("should click the active action when clicked and close the menu", async () => {
          ...
          <calcite-action id="third" text="Add" icon="banana" text-enabled></calcite-action>
            ...
            await page.$eval("calcite-action", (el) => el.click());
            expect(await actionMenu.getProperty("open")).toBe(false);
            expect(clickSpy).toHaveReceivedEventTimes(1);
        });
    });
});
//# sourceMappingURL=action-menu.e2e.js.map
