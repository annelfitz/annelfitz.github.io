...
import { accessible, defaults, floatingUIOwner, focusable, hidden, openClose, renders, t9n, } from "../../tests/commonTests";
...
describe("calcite-popover", () => {
    ...
    it("should have zIndex of 900", async () => {
        ...
        await page.setContent(`<calcite-popover placement="auto" reference-element="ref" open>content</calcite-popover><div id="ref">referenceElement</div>`);
    ...
    describe("accessible with close button", () => {
        accessible(`<calcite-popover label="test" open closable reference-element="ref"></calcite-popover><div id="ref">😄</div>`);
    });
    ...
    it("popover positions when referenceElement is set", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-popover open placement="auto"></calcite-popover>
        <div id="ref">referenceElement</div>`);
        ...
        await page.$eval("calcite-popover", (el) => {
    ...
    it("open popover should be visible", async () => {
        ...
        const element = await page.find("calcite-popover");
        await page.$eval("calcite-popover", (elm) => {
    ...
    it("should accept referenceElement as a virtual element", async () => {
        ...
        await page.$eval("calcite-popover", (popover) => {
    ...
    it("should honor click interaction", async () => {
        const page = await newE2EPage();
        await page.setContent(`<calcite-popover placement="auto" reference-element="ref">content</calcite-popover><div id="ref">referenceElement</div>`);
        await page.waitForChanges();
        const popover = await page.find(`calcite-popover`);
        expect(await popover.isVisible()).toBe(false);
    ...
    it("should not be visible if reference is hidden", async () => {
        const page = await newE2EPage();
        await page.setContent(html ` <calcite-popover placement="auto" reference-element="ref" open>content</calcite-popover>
    ...
    it("should not be visible if ui has escaped", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<div id="scrollEl" style="height: 200px; overflow: auto;">
    ...
    it("should not toggle popovers with triggerDisabled", async () => {
        const page = await newE2EPage();
        await page.setContent(html ` <div id="outsideNode">Outside node</div>
    ...
    describe("owns a floating-ui", () => {
        floatingUIOwner(`<calcite-popover placement="auto" reference-element="ref">content</calcite-popover><div id="ref">referenceElement</div>`, "open");
    });
    ...
    it("should still function when disconnected and reconnected", async () => {
        const page = await newE2EPage();
        await page.setContent(`<calcite-popover placement="auto" reference-element="ref" open>content</calcite-popover>
      <div id="transfer"></div>
      <div id="ref">referenceElement</div>`);
        await page.waitForChanges();
        const popover = await page.find(`calcite-popover`);
        ...
        await ref.click();
        expect(await popover.isVisible()).toBe(false);
        await page.$eval("calcite-popover", (popoverEl) => {
    ...
    describe("setFocus", () => {
        const createPopoverHTML = (contentHTML, attrs) => `<calcite-popover open ${attrs} reference-element="ref">${contentHTML}</calcite-popover><button id="ref">Button</button>`;
...
//# sourceMappingURL=popover.e2e.js.map
