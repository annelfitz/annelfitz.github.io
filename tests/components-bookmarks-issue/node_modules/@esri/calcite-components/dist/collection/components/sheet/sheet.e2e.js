...
describe("calcite-sheet properties", () => {
    ...
    describe("setFocus", () => {
        const createSheetHTML = (contentHTML, attrs) => `<calcite-sheet open ${attrs}>${contentHTML}</calcite-sheet>`;
    ...
    it("sets custom width correctly", async () => {
        ...
        await page.setContent(`<calcite-sheet position="inline-start" style="--calcite-sheet-width:600px;"></calcite-sheet>`);
        const sheet = await page.find("calcite-sheet");
        sheet.setProperty("open", true);
        await page.waitForChanges();
        const style = await page.$eval("calcite-sheet", (elm, selector) => {
    ...
    it("sets custom width and max correctly", async () => {
        ...
        // set large page to ensure test sheet isn't becoming fullscreen
        await page.setViewport({ width: 1440, height: 1440 });
        await page.setContent(`<calcite-sheet position="inline-start" style="--calcite-sheet-width:600px;--calcite-sheet-max-width:600px;"></calcite-sheet>`);
        const sheet = await page.find("calcite-sheet");
        sheet.setProperty("open", true);
        await page.waitForChanges();
        const style = await page.$eval("calcite-sheet", (elm, selector) => {
    ...
    it("sets custom height correctly", async () => {
        ...
        // set large page to ensure test sheet isn't becoming fullscreen
        await page.setViewport({ width: 1440, height: 1440 });
        await page.setContent(`<calcite-sheet position="block-start" style="--calcite-sheet-height:600px;" open></calcite-sheet>`);
        const sheet = await page.find("calcite-sheet");
        sheet.setProperty("open", true);
        await page.waitForChanges();
        const style = await page.$eval("calcite-sheet", (elm, selector) => {
    ...
    `);
        const sheet = await page.find("calcite-sheet");
        await page.$eval("calcite-sheet", (elm) => (elm.beforeClose = window.beforeClose));
        await page.waitForChanges();
    ...
    describe("opening and closing behavior", () => {
        it("opens and closes", async () => {
            ...
            const sheet = await page.find("calcite-sheet");
            await page.$eval("calcite-sheet", (sheet) => {
                const receivedEvents = [];
                window.events = receivedEvents;
                ["calciteSheetBeforeOpen", "calciteSheetOpen", "calciteSheetBeforeClose", "calciteSheetClose"].forEach((eventType) => {
...
//# sourceMappingURL=sheet.e2e.js.map
