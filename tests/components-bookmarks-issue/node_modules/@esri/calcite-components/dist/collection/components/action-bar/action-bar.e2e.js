...
describe("calcite-action-bar", () => {
    ...
    describe("delegates to floating-ui-owner component", () => {
        delegatesToFloatingUiOwningComponent(html `<calcite-action-bar>
    ...
    describe("expand functionality", () => {
        ...
        it("should modify textEnabled on actions when expanded is true and new children are added", async () => {
            const page = await newE2EPage();
            await page.setContent(`<calcite-action-bar expanded><calcite-action text="hello"></calcite-action></calcite-action-bar>`);
            await page.evaluate(() => {
    ...
    describe("overflow actions", () => {
        it("should slot 'menu-actions' on sublist changes", async () => {
          ...
          <calcite-action-bar style="height: 290px">
            ...
            await page.$eval("calcite-action-bar", (element) => {
                element.ownerDocument.getElementById("second-action").insertAdjacentHTML("afterend", `
...
//# sourceMappingURL=action-bar.e2e.js.map
