...
describe("calcite-table", () => {
    describe("renders", () => {
        renders(html `<calcite-table caption="Simple table">
    ...
    describe("accessible", () => {
        describe("is accessible simple", () => {
            accessible(html `<calcite-table caption="Simple table">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with selection mode multiple", () => {
            accessible(html `<calcite-table caption="Simple table" selection-mode="multiple">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with selection mode single", () => {
            accessible(html `<calcite-table caption="Simple table" selection-mode="single">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with numbered", () => {
            accessible(html `<calcite-table caption="Simple table" numbered>
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with numbered and selection", () => {
            accessible(html `<calcite-table caption="Simple table" numbered selection-mode="multiple">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with pagination", () => {
            accessible(html `<calcite-table page-size="4" caption="Simple table">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with pagination and interaction mode static", () => {
            accessible(html `<calcite-table page-size="4" caption="Simple table" interaction-mode="static">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
        ...
        describe("is accessible with pagination and selection mode", () => {
            accessible(html `<calcite-table page-size="4" selection-mode="multiple" caption="Simple table">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
            <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          </calcite-table-row>
...
describe("selection modes", () => {
    it("selection mode single allows one or no rows to be selected", async () => {
        ...
        await page.setContent(html `<calcite-table selection-mode="single" caption="Simple table">
        <calcite-table-row slot=${SLOTS.tableHeader}>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.$eval("calcite-table", () => {
            ...
            const cell = row.shadowRoot.querySelector("calcite-table-cell:first-child");
            cell.click();
        });
        await page.waitForChanges();
    ...
    it("selection mode multiple allows one, multiple, or no rows to be selected", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table selection-mode="multiple" caption="Simple table">
        <calcite-table-row slot=${SLOTS.tableHeader}>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
    ...
    it("correctly has all items selected after user uses select all cell while none selected", async () => {
        ...
        await page.$eval("calcite-table", () => {
            ...
            const cell = row.shadowRoot.querySelector("calcite-table-header:first-child");
            cell.click();
        });
        await page.waitForChanges();
        expect(tableSelectSpy).toHaveReceivedEventTimes(1);
    ...
    it("correctly has all items selected after user uses select all cell while none selected and multiple pages", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table selection-mode="multiple" caption="Simple table" page-size="1">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
    ...
    it("correctly maintains selected items if they are paginated out of view", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table selection-mode="multiple" caption="Simple table" page-size="2" style="width:800px">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.$eval("calcite-table", () => {
            ...
            const button = pagination.shadowRoot.querySelector("button.page:nth-of-type(2)");
            button?.click();
        });
        await page.waitForChanges();
        expect(tableSelectSpy).toHaveReceivedEventTimes(0);
...
describe("pagination event", () => {
    it("correctly emits pagination event", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table selection-mode="multiple" caption="Simple table" page-size="1" style="width:800px">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.$eval("calcite-table", () => {
            const table = document.querySelector("calcite-table");
            const pagination = table.shadowRoot.querySelector("calcite-pagination");
            const button = pagination.shadowRoot.querySelector("button.page:nth-of-type(3)");
            button?.click();
        });
        await page.waitForChanges();
        ...
        await page.$eval("calcite-table", () => {
            const table = document.querySelector("calcite-table");
            const pagination = table.shadowRoot.querySelector("calcite-pagination");
            const button = pagination.shadowRoot.querySelector("button.page:nth-of-type(4)");
            button?.click();
        });
        await page.waitForChanges();
...
describe("keyboard navigation", () => {
    it("navigates correctly when no pagination or selection present", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table caption="Simple table" style="width:800px">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
    ...
    it("navigates correctly when pagination present and first page displayed", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table caption="Simple table" page-size="2" style="width:800px">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
    ...
    it("navigates correctly skipping disabled rows", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table caption="Simple table">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
    ...
    it("navigates correctly when multiple header and multiple footer rows", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table caption="Multiple headers using col-span table">
          <calcite-table-row slot=${SLOTS.tableHeader}>
    ...
    it("navigates correctly when multiple header and multiple footer rows, pagination present, and navigation to other page occurs", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table caption="Multiple headers using col-span table" page-size="2" style="width:800px">
          <calcite-table-row slot=${SLOTS.tableHeader}>
            <calcite-table-header id="head-1a" col-span="2" heading="Name"></calcite-table-header>
            <calcite-table-header id="head-1b" col-span="2" heading="Information"></calcite-table-header>
          </calcite-table-row>
    ...
    it("navigates correctly when selection column present", async () => {
        ...
        await page.keyboard.press("Tab");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowHead.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("th").classList)).toEqual({ "0": CSS.selectionCell, "1": CSS.multipleSelectionCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("head-1a");
        await page.keyboard.press("ArrowRight");
        ...
        await page.keyboard.press("PageDown");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowFoot.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CELL_CSS.footerCell, "1": CSS.selectionCell });
        await page.keyboard.press("ArrowUp");
        await page.waitForChanges();
        expect(await page.$eval(`#${row3.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.selectionCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("cell-3a");
        page.keyboard.press("ControlRight");
    ...
    it("navigates correctly when number column present", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table numbered caption="Simple table">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.keyboard.press("Tab");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowHead.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("th").classList)).toEqual({ "0": CSS.numberCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("head-1a");
        await page.keyboard.press("ArrowRight");
        ...
        await page.keyboard.press("PageDown");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowFoot.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CELL_CSS.footerCell, "1": CSS.numberCell });
        await page.keyboard.press("ArrowUp");
        await page.waitForChanges();
        expect(await page.$eval(`#${row3.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.numberCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("cell-3a");
        page.keyboard.press("ControlRight");
    ...
    it("navigates correctly when number and selection column present numbered", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table numbered selection-mode="single" caption="Simple table">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowHead.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("th").classList)).toEqual({ "0": CSS.selectionCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("head-1a");
    ...
    it("navigates correctly when pagination present and selection and number and first page displayed", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table numbered selection-mode="multiple" page-size="2" caption="Simple table">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.keyboard.press("ArrowUp");
        await page.waitForChanges();
        expect(await page.$eval(`#${row2.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.selectionCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("cell-2a");
        page.keyboard.press("ControlRight");
    ...
    it("navigates correctly when pagination present, and selection and number and navigation to two other pages occurs", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table numbered selection-mode="single" page-size="2" caption="Simple table" style="width:800px">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
        ...
        await page.keyboard.press("ArrowDown");
        await page.waitForChanges();
        expect(await page.$eval(`#${row1.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.selectionCell });
        await page.keyboard.press("ArrowLeft");
        await page.waitForChanges();
        expect(await page.$eval(`#${row1.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.numberCell });
        await page.keyboard.press("PageDown");
        await page.waitForChanges();
        expect(await page.$eval(`#${rowFoot.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CELL_CSS.footerCell, "1": CSS.numberCell });
        await page.keyboard.press("ArrowUp");
        await page.waitForChanges();
        expect(await page.$eval(`#${row2.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.numberCell });
        await page.keyboard.press("ArrowRight");
        await page.waitForChanges();
        expect(await page.$eval(`#${row2.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.selectionCell });
        page.keyboard.press("ControlRight");
        ...
        await page.keyboard.press("ArrowUp");
        await page.waitForChanges();
        expect(await page.$eval(`#${row4.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.selectionCell });
        await page.keyboard.press("ArrowLeft");
        await page.waitForChanges();
        expect(await page.$eval(`#${row4.id}`, (el) => el.shadowRoot?.activeElement.shadowRoot?.querySelector("td").classList)).toEqual({ "0": CSS.numberCell });
        page.keyboard.press("ControlRight");
        await page.keyboard.press("End");
        await page.waitForChanges();
        expect(await getFocusedElementProp(page, "id")).toBe("foot-1b");
    ...
    it("navigates correctly when number and selection column present numbered and interaction-mode static - only focusing selection cells", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-table numbered selection-mode="multiple" caption="Simple table" interaction-mode="static">
        <calcite-table-row id="row-head" slot=${SLOTS.tableHeader}>
          <calcite-table-header id="head-1a" heading="Heading" description="Description"></calcite-table-header>
          <calcite-table-header id="head-1b" heading="Heading" description="Description"></calcite-table-header>
        </calcite-table-row>
...
assertSelectedItems.setUpEvents = async (page) => {
    await page.evaluate(() => {
        document.addEventListener("calciteTableSelect", ({ detail }) => {
