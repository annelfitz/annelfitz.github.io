...
import { accessible, defaults, disabled, focusable, formAssociated, hidden, labelable, reflects, renders, } from "../../tests/commonTests";
...
describe("calcite-radio-button", () => {
    ...
    describe("accessible", () => {
        accessible(`<calcite-label><calcite-radio-button id="example" name="example" value="one"></calcite-radio-button>label</calcite-label>`);
    });
    ...
    it("appropriately triggers the custom internal focus and blur events on click", async () => {
        const page = await newE2EPage();
        await page.setContent(`<calcite-radio-button></calcite-radio-button><calcite-radio-button id="two"></calcite-radio-button>`);
        const radio = await page.find("calcite-radio-button");
    ...
    it.skip("appropriately triggers the custom internal focus and blur events with keyboard", async () => {
        const page = await newE2EPage();
        await page.setContent(`<calcite-radio-button name="example"></calcite-radio-button><calcite-radio-button name="example"></calcite-radio-button>`);
        const radio = await page.find("calcite-radio-button");
        const focusEvent = await radio.spyOnEvent("calciteInternalRadioButtonFocus");
        const blurEvent = await radio.spyOnEvent("calciteInternalRadioButtonBlur");
        expect(focusEvent).toHaveReceivedEventTimes(0);
    ...
    it("round robins to the first or last radio when pressing right arrow on the last radio or left arrow on the first radio", async () => {
        const page = await newE2EPage();
        await page.setContent(`<calcite-radio-button name="example"></calcite-radio-button><calcite-radio-button id="two" name="example"></calcite-radio-button>`);
        const radio = await page.find("calcite-radio-button");
        const radio2 = await page.find("calcite-radio-button#two");
        await page.keyboard.press("Tab");
        await page.keyboard.press("ArrowRight");
