...
describe("calcite-block-section", () => {
    ...
    describe("setFocus", () => {
        describe("focuses toggle switch", () => {
            focusable(html `<calcite-block-section text="text" toggle-display="switch" open>
        ...
        describe("focuses toggle button", () => {
            focusable(html `<calcite-block-section text="text" toggle-display="button" open>
          <div>some content</div>
        </calcite-block-section>`, {
                shadowFocusTargetSelector: `.${CSS.toggle}`,
            });
    ...
    async function assertContentIsDisplayedAndHidden(page) {
    ...
    async function assertToggleBehavior(page) {
        ...
        expect(toggle.getAttribute("aria-expanded")).toBe("false");
        const keyboardToggleEmitter = toggle.tagName === "CALCITE-ACTION"
...
//# sourceMappingURL=block-section.e2e.js.map
