...
describe("calcite-color-picker-hex-input", () => {
    ...
    it("normalizes hexa value when initialized", async () => {
        const page = await newE2EPage();
        await page.setContent("<calcite-color-picker-hex-input alpha-channel value='#f0f0'></calcite-color-picker-hex-input>");
        const input = await page.find(`calcite-color-picker-hex-input`);
    ...
    it("ignores invalid hexa", async () => {
        const hex = "#b33f33ff";
        const page = await newE2EPage();
        await page.setContent(`<calcite-color-picker-hex-input alpha-channel value='${hex}'></calcite-color-picker-hex-input>`);
        const input = await page.find(`calcite-color-picker-hex-input`);
        input.setProperty("value", null);
        await page.waitForChanges();
        expect(await input.getProperty("value")).toBe(hex);
    ...
    it("prevents entering chars if invalid hex chars or it exceeds max hex length", async () => {
        ...
        await page.setContent("<calcite-color-picker-hex-input value='#b33f33'></calcite-color-picker-hex-input>");
        const input = await page.find("calcite-color-picker-hex-input");
        const selectAllText = async () => await input.click({ clickCount: 3 });
        await selectAllText();
    ...
    it("prevents entering chars if invalid hexa chars or it exceeds max hexa length", async () => {
        const page = await newE2EPage();
        await page.setContent("<calcite-color-picker-hex-input alpha-channel value='#b33f33'></calcite-color-picker-hex-input>");
        const input = await page.find("calcite-color-picker-hex-input");
    ...
    describe("keyboard interaction", () => {
        let page;
        let input;
        async function assertTabAndEnterBehavior(hexInputChars, expectedValue, alphaChannel = false) {
        ...
        async function typeHexValue(text, commitKey) {
            await clearText();
        ...
        describe("when color value is required", () => {
            describe("hex", () => {
                ...
                beforeEach(async () => {
                    ...
                    await page.setContent(`<calcite-color-picker-hex-input value=${startingHex}></calcite-color-picker-hex-input>`);
                    await page.waitForChanges();
            ...
            describe("hexa", () => {
                ...
                beforeEach(async () => {
                    page = await newE2EPage();
                    await page.setContent(`<calcite-color-picker-hex-input alpha-channel value=${startingHexa}></calcite-color-picker-hex-input>`);
                    input = await page.find("calcite-color-picker-hex-input");
                });
...
//# sourceMappingURL=color-picker-hex-input.e2e.js.map
