...
describe("calcite-radio-button-group", () => {
    ...
    describe("accessible", () => {
        accessible(`<calcite-radio-button-group><calcite-label><calcite-radio-button></calcite-radio-button>Label</calcite-label></calcite-radio-button-group>`);
    });
    describe("defaults", () => {
    ...
    describe("is focusable", () => {
        focusable(html `<calcite-radio-button-group name="Options" layout="vertical">
      ...
      </calcite-radio-button-group>`, { focusTargetSelector: "calcite-radio-button" });
    });
    ...
    it("when multiple items are checked, last one wins", async () => {
        const page = await newE2EPage();
        await page.setContent(html `<calcite-radio-button-group name="multiple-checked">
        <calcite-label>
          1
    ...
    `);
        const getSelectedItemValue = async () => {
...
//# sourceMappingURL=radio-button-group.e2e.js.map
