...
describe("calcite-filter", () => {
    ...
    describe("clear button", () => {
        ...
        describe("clearing value", () => {
            const filterIsFocused = async () => page.evaluate(() => document.querySelector("calcite-filter") === document.activeElement);
            it("should clear the value in the input when pressed", async () => {
                ...
                await page.$eval("calcite-filter", async (filter, buttonSelector) => {
                    return filter.shadowRoot
                        .querySelector("calcite-input")
                        .shadowRoot.querySelector(buttonSelector)
                        .click();
    ...
    function assertMatchingItems(filtered, values) {
    ...
    describe("filter behavior", () => {
        ...
        it("updates filtered items after filtering", async () => {
            ...
            await page.$eval("calcite-filter", (filter) => {
...
//# sourceMappingURL=filter.e2e.js.map
