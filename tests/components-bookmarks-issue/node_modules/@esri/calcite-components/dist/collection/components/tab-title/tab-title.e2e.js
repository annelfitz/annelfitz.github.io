...
describe("calcite-tab-title", () => {
  ...
  `;
    ...
    describe("closing sequence", () => {
        let page;
        let matchingTabEl;
        let tabTitleCloseButtonEl;
        const closeTabsInSequenceOfGivenArrayOfIds = async (arrayOfIds) => {
            for (let i = 0; i < arrayOfIds.length - 1; i++) {
                let tabEl;
                let tabTitleContainerEl;
        ...
        `,
            ...
            expect(await page.evaluate(() => {
                return document
                    ...
                    .shadowRoot.querySelector(".tab-nav-active-indicator").style.left;
            })).not.toEqual("0px");
...
//# sourceMappingURL=tab-title.e2e.js.map
