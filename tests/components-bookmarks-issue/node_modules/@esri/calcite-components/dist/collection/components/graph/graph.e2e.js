...
describe("calcite-graph", () => {
    ...
    describe("accessible: with data", () => {
        ...
        beforeEach(async () => {
            ...
            await page.$eval("calcite-graph", (el) => {
                el.data = [
                    [0, 4],
                    [1, 7],
                    [4, 6],
    ...
    it("draws an area graph", async () => {
        ...
        await page.$eval("calcite-graph", (elm) => {
            elm.data = [
                [0, 4],
                [1, 7],
                [4, 6],
        ...
        expect(d).toBe("M 0,60 L 0,20 L 0,20 C 16.666666666666664,-10.000000000000014 33.333333333333336,-40 50,-40 C 100,-40 150,-33.33333333333334 200,-20 C 233.33333333333334,-11.111111111111114 266.66666666666663,24.444444444444443 300,60 L 300,60 Z");
    });
...
//# sourceMappingURL=graph.e2e.js.map
