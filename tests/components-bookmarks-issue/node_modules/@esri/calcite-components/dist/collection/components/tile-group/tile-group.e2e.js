...
describe("calcite-tile-group", () => {
    ...
    describe("disabled", () => {
        disabled(html `<calcite-tile-group>
        <calcite-tile></calcite-tile>
        <calcite-tile></calcite-tile>
        <calcite-tile></calcite-tile>
      </calcite-tile-group>`, { focusTarget: "none" });
    });
    describe("disabled with link tiles", () => {
        ...
        <calcite-tile
          ...
          icon="layers"
        ></calcite-tile>
      </calcite-tile-group>`, { focusTarget: "child" });
    });
    describe("prop passing", () => {
      ...
      `);
            ...
            await page.$eval("calcite-tile-group", (element) => element.setAttribute("scale", "l"));
...
//# sourceMappingURL=tile-group.e2e.js.map
