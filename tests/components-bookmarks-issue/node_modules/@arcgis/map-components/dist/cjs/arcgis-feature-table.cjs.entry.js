...
const ArcgisFeatureTable = class {
    constructor(hostRef) {
        ...
        this.arcgisFeatureTableReady = index.createEvent(this, "arcgisFeatureTableReady", 7);
        this.featureTableSelectionChange = index.createEvent(this, "featureTableSelectionChange", 7);
        this._watchHandles = [];
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.activeFilters, (value) => (this.activeFilters = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.activeSortOrders, (value) => (this.activeSortOrders = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.columns, (value) => (this.columns = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.menu, (value) => (this.menu = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.state, (value) => (this.state = value), {
            initial: true
        }));
    }
    async _createParams() {
