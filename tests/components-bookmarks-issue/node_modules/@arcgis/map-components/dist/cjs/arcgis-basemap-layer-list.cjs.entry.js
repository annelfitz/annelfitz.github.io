...
const ArcgisBasemapLayerList = class {
    constructor(hostRef) {
        ...
        this.arcgisBasemapLayerListReady = index.createEvent(this, "arcgisBasemapLayerListReady", 7);
        this.basemapLayerListTriggerAction = index.createEvent(this, "basemapLayerListTriggerAction", 7);
        this._watchHandles = [];
