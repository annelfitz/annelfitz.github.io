...
const ArcgisBuildingExplorer = class {
    constructor(hostRef) {
        ...
        this.arcgisBuildingExplorerReady = index.createEvent(this, "arcgisBuildingExplorerReady", 7);
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsBuildingExplorer(params);
        this.widget = widget;
...
exports.arcgis_building_explorer = ArcgisBuildingExplorer;
