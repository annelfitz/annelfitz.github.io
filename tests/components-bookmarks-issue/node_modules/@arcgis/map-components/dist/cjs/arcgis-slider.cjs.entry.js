...
const ArcgisSlider = class {
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.effectiveSegmentElements, (value) => (this.effectiveSegmentElements = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.labelElements, (value) => (this.labelElements = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.maxLabelElement, (value) => (this.maxLabelElement = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.minLabelElement, (value) => (this.minLabelElement = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.segmentElements, (value) => (this.segmentElements = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.thumbElements, (value) => (this.thumbElements = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.tickElements, (value) => (this.tickElements = value), {
            initial: true
        }));
        componentUtils.addHandles(this, watch(() => this.widget.trackElement, (value) => (this.trackElement = value), {
            initial: true
        }));
    }
    _createParams() {
