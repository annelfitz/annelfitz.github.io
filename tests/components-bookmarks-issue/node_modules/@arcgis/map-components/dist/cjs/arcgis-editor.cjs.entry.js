...
const ArcgisEditor = class {
    constructor(hostRef) {
        ...
        this.arcgisEditorReady = index.createEvent(this, "arcgisEditorReady", 7);
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsEditor(params);
        this.widget = widget;
    ...
    async _addWatchers() {
        ...
        componentUtils.addHandles(this, watch(() => this.widget.activeWorkflow, (value) => {
