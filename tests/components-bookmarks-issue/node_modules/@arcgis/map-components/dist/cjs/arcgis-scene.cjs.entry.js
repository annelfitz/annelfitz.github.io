...
const ArcgisScene = class {
    ...
    basemapWatcher(value) {
        if (typeof value === "string" && this.view?.map && !componentUtils.isNullOrEmptyString(value)) {
    ...
    cameraWatcher(value) {
        if (this.view && value && componentUtils.isNotSameCamera(this.view.camera, value)) {
    ...
    environmentWatcher(value) {
        if (this.view &&
            value &&
            componentUtils.isNotSameEnvironment(this.view.environment, value)) {
    ...
    viewpointWatcher(value) {
        if (this.view && componentUtils.isNotSameViewpoint(this.view.viewpoint, value)) {
            this.view.viewpoint = value;
        }
    }
    zoomWatcher(value, old) {
        if (this.view && this.view.stationary && !this.view.interacting && value !== old && componentUtils.isValidInteger(value)) {
