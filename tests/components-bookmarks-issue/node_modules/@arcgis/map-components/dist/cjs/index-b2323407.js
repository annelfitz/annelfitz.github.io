...
async function importWidgetsHome() {
    ...
    const module = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@arcgis/core/widgets/Home.js')); });
    return isDefaultModule(module) ? module.default : module;
}
...
exports.newWidgetsHome = newWidgetsHome;
