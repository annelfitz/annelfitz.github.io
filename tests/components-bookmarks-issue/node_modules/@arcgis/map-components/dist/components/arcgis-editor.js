...
import { s as newWidgetsEditor, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisEditor$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisEditor extends HTMLElement {
    ...
    static get style() { return editorCss; }
        ...
        "activeWorkflow": [1040],
        "allowedWorkflows": [1, "allowed-workflows"],
        "icon": [1],
        "labelOptions": [16],
        "layerInfos": [16],
        "snappingOptions": [16],
        "supportingWidgetDefaults": [16],
        "tooltipOptions": [16],
        "visibleElementsCreateFeaturesSection": [4, "visible-elements-create-features-section"],
        "visibleElementsEditFeaturesSection": [4, "visible-elements-edit-features-section"],
        "visibleElementsLabelsToggle": [4, "visible-elements-labels-toggle"],
        "visibleElementsTooltipsToggle": [4, "visible-elements-tooltips-toggle"],
        "visibleElementsSnappingControls": [4, "visible-elements-snapping-controls"],
        "visibleElementsSnappingControlsHeader": [4, "visible-elements-snapping-controls-header"],
        "visibleElementsSnappingControlsEnabledToggle": [4, "visible-elements-snapping-controls-enabled-toggle"],
        "visibleElementsSnappingControlsSelfEnabledToggle": [4, "visible-elements-snapping-controls-self-enabled-toggle"],
        "visibleElementsSnappingControlsFeatureEnabledToggle": [4, "visible-elements-snapping-controls-feature-enabled-toggle"],
        "visibleElementsSnappingControlsLayerList": [4, "visible-elements-snapping-controls-layer-list"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "cancelWorkflow": [64],
        "deleteFeatureFromWorkflow": [64],
        "startCreateFeaturesWorkflowAtFeatureCreation": [64],
        "startCreateFeaturesWorkflowAtFeatureTypeSelection": [64],
        "startUpdateWorkflowAtFeatureEdit": [64],
        "startUpdateWorkflowAtFeatureSelection": [64],
        "startUpdateWorkflowAtMultipleFeatureSelection": [64]
    }, undefined, {
        "referenceElement": ["referenceElementWatcher"],
        "allowedWorkflows": ["allowedWorkflowsWatcher"],
        "icon": ["iconWatcher"],
