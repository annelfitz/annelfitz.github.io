...
const ArcgisShadowCast$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisShadowCast extends HTMLElement {
    ...
    static get style() { return shadowCastCss; }
        ...
        "discreteOptions": [16],
        "durationOptions": [16],
        "endTimeOfDay": [2, "end-time-of-day"],
        "startTimeOfDay": [2, "start-time-of-day"],
        "thresholdOptions": [16],
        "utcOffset": [2, "utc-offset"],
        "visualizationType": [1, "visualization-type"],
        "icon": [1],
        "visibleElementsTimeRangeSlider": [4, "visible-elements-time-range-slider"],
        "visibleElementsTimezone": [4, "visible-elements-timezone"],
        "visibleElementsDatePicker": [4, "visible-elements-date-picker"],
        "visibleElementsVisualizationOptions": [4, "visible-elements-visualization-options"],
        "visibleElementsColorPicker": [4, "visible-elements-color-picker"],
        "visibleElementsTooltip": [4, "visible-elements-tooltip"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "getDuration": [64],
