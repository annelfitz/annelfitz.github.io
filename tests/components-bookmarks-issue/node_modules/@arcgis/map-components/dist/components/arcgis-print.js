...
const ArcgisPrint$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisPrint extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.arcgisPrintReady = createEvent(this, "arcgisPrintReady", 7);
        this.printComplete = createEvent(this, "printComplete", 7);
    ...
    async componentDidLoad() {
        ...
        const widget = await newWidgetsPrint(params);
        this.widget = widget;
    ...
    async _addWatchers() {
        ...
        addHandles(this, watch(() => this.widget.exportedLinks, (value) => (this.exportedLinks = value), {
            initial: true
        }));
    }
    _createParams() {
    ...
    static get style() { return printCss; }
}, [0, "arcgis-print", {
        "referenceElement": [1, "reference-element"],
        "allowedFormats": [1, "allowed-formats"],
        "allowedLayouts": [1, "allowed-layouts"],
        "exportedLinks": [1040],
        "extraParameters": [8, "extra-parameters"],
        "icon": [1],
        "includeDefaultTemplates": [4, "include-default-templates"],
        "portal": [16],
        "printServiceUrl": [1, "print-service-url"],
        "templateCustomTextElements": [16],
        "templateOptions": [16],
        "position": [1],
        "view": [1040],
        "widget": [1040]
