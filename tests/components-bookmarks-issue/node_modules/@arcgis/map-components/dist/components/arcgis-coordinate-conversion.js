...
import { k as newWidgetsCoordinateConversion, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisCoordinateConversion$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisCoordinateConversion extends HTMLElement {
    ...
    static get style() { return coordinateConversionCss; }
}, [0, "arcgis-coordinate-conversion", {
        "referenceElement": [1, "reference-element"],
        "conversions": [16],
        "currentLocation": [1040],
        "formats": [16],
        "icon": [1],
        "locationSymbol": [16],
        "mode": [1],
        "multipleConversions": [4, "multiple-conversions"],
        "orientation": [1],
        "storageEnabled": [4, "storage-enabled"],
        "storageType": [1, "storage-type"],
        "visibleElementsSettingsButton": [4, "visible-elements-settings-button"],
        "visibleElementsEditButton": [4, "visible-elements-edit-button"],
        "visibleElementsExpandButton": [4, "visible-elements-expand-button"],
        "visibleElementsCaptureButton": [4, "visible-elements-capture-button"],
        "position": [1],
        "view": [1040],
        "widget": [1040],
        "reverseConvert": [64]
