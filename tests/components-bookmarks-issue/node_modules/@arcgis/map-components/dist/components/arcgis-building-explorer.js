...
import { h as newWidgetsBuildingExplorer, i as importCoreReactiveUtils } from './index2.js';
...
const ArcgisBuildingExplorer$1 = /*@__PURE__*/ proxyCustomElement(class ArcgisBuildingExplorer extends HTMLElement {
    ...
    static get style() { return buildingExplorerCss; }
}, [0, "arcgis-building-explorer", {
        ...
        "phase": [1040],
        "state": [1025],
        "visibleElementsLevels": [4, "visible-elements-levels"],
        "visibleElementsPhases": [4, "visible-elements-phases"],
        "visibleElementsDisciplines": [4, "visible-elements-disciplines"],
        "position": [1],
        "view": [1040],
        "widget": [1040]
    }, undefined, {
