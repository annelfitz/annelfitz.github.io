...
var Input = class {
  ...
  async setFocus() {
    ...
    if (this.type === "number") {
      ...
      (_b = this.childEl) == null ? void 0 : _b.focus();
    }
  }
  ...
  async selectText() {
    ...
    if (this.type === "number") {
      ...
      (_b = this.childEl) == null ? void 0 : _b.select();
    }
  }
  onLabelClick() {
    this.setFocus();
  ...
  render() {
    ...
    const localeNumberInput = this.type === "number" ? h("input", {
      accept: this.accept,
    ...
    return h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { class: { [CSS.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalDown : null, this.prefixText ? prefixText : null, h("div", { class: CSS.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { class: CSS.actionWrapper }, h("slot", { name: SLOTS.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly ? numberButtonsVertical : null, this.suffixText ? suffixText : null, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly ? numberButtonsHorizontalUp : null, h(HiddenFormInputSlot, { component: this })), this.validationMessage && this.status === "invalid" ? h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status }) : null));
  }
...
export {
  Input as calcite_input
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-input.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-input.entry-MP6QCIIJ.js.map
