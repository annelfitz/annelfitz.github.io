...
// node_modules/@esri/calcite-components/dist/esm/ExpandToggle-6e6d607b.js
var overflowActionsDebounceInMs = 150;
var groupBufferPx = 2;
var getAverage = (arr) => arr.reduce((p, c) => p + c, 0) / arr.length;
var geActionDimensions = (actions) => {
  const actionsNotSlotted = actions.filter((action) => action.slot !== SLOTS.menuActions);
...
var queryActions = (el) => {
  return Array.from(el.querySelectorAll("calcite-action")).filter((action) => action.closest("calcite-action-menu") ? action.slot === SLOTS2.trigger : true);
};
...
@esri/calcite-components/dist/esm/ExpandToggle-6e6d607b.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=chunk-RJOTSOHF.js.map
