...
var Modal = class {
  ...
  connectedCallback() {
    ...
    (_b = this.cssVarObserver) == null ? void 0 : _b.observe(this.el, { attributeFilter: ["style"] });
    this.updateSizeCssVars();
    this.updateFooterVisibility();
  ...
  disconnectedCallback() {
    ...
    (_b = this.cssVarObserver) == null ? void 0 : _b.disconnect();
  ...
  render() {
    ...
    } }, h("calcite-scrim", { class: CSS.scrim, onClick: this.handleOutsideClose }), this.renderStyle(), h("div", {
      class: {
        [CSS.modal]: true
      },
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setTransitionEl
    }, h("div", { class: CSS.header }, this.renderCloseButton(), h("header", { class: CSS.title }, h("slot", { name: CSS.header }))), this.renderContentTop(), h("div", {
      class: {
        [CSS.content]: true,
    ...
    }, h("slot", { name: SLOTS.content })), this.renderContentBottom(), this.renderFooter())));
  }
  renderFooter() {
...
export {
  Modal as calcite_modal
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-modal.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-modal.entry-6DJYIJV7.js.map
