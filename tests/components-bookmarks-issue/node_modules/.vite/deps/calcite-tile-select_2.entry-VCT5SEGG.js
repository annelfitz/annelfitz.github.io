...
var TileSelect = class {
  ...
  async setFocus() {
    ...
    return (_a = this.input) == null ? void 0 : _a.setFocus();
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
  ...
  render() {
    ...
    } }, h("div", { class: { [CSS.tile]: true, [CSS.tileLargeVisual]: isLargeVisual } }, icon && h("div", { class: { [CSS.icon]: renderIcon } }, h("calcite-icon", { flipRtl: iconFlipRtl, icon, scale: "l" })), h("div", { class: CSS.tileContentContainer }, h("div", { class: CSS.tileContent }, heading && h("div", { class: CSS.tileHeading }, heading), description && h("div", { class: CSS.tileDescription }, description)))), h("slot", null)));
  }
  get el() {
...
export {
  TileSelect as calcite_tile_select,
  TileSelectGroup as calcite_tile_select_group
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-tile-select_2.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-tile-select_2.entry-VCT5SEGG.js.map
