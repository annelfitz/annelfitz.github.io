...
var InputDatePicker = class {
  constructor(hostRef) {
    ...
    this.onInputWrapperClick = (event) => {
      ...
      const wasToggleClicked = path.find((el) => {
        var _a;
        return (_a = el.classList) == null ? void 0 : _a.contains(CSS.toggleIcon);
      });
      if (wasToggleClicked) {
  ...
  render() {
    ...
    return h(Host, { onBlur: this.blurHandler, onKeyDown: this.keyDownHandler }, h(InteractiveContainer, { disabled: this.disabled }, this.localeData && h("div", { class: CSS.inputContainer }, h("div", {
    ...
    }), !this.readOnly && this.renderToggleIcon(this.open && this.focusedInput === "start"), h("span", { "aria-hidden": "true", class: CSS.assistiveText, id: this.placeholderTextId }, "Date Format: ", (_b = this.localeData) == null ? void 0 : _b.placeholder)), h("div", {
    ...
    }))), this.range && this.layout === "horizontal" && h("div", { class: CSS.horizontalArrowContainer }, h("calcite-icon", { flipRtl: true, icon: "arrow-right", scale: getIconScale(this.scale) })), this.range && this.layout === "vertical" && this.scale !== "s" && h("div", { class: CSS.verticalArrowContainer }, h("calcite-icon", { icon: "arrow-down", scale: getIconScale(this.scale) })), this.range && h("div", {
      class: CSS.inputWrapper,
      "data-position": "end",
      onClick: this.onInputWrapperClick,
      onPointerDown: this.onInputWrapperPointerDown,
...
export {
  InputDatePicker as calcite_input_date_picker
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-input-date-picker.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-input-date-picker.entry-OMBC5QBJ.js.map
