...
function ie2(e2, t) {
  var i2 = k2(true), s2 = null, a2 = $, o2 = null, n3 = V(r2);
  function r2(r3) {
    var l2, h, d, c = (r3 = J(r3)).length, u = false;
    for (null == s2 && (o2 = a2(d = n3())), l2 = 0; l2 <= c; ++l2)
      !(l2 < c && i2(h = r3[l2], l2, r3)) === u && ((u = !u) ? o2.lineStart() : o2.lineEnd()), u && o2.point(+e2(h, l2, r3), +t(h, l2, r3));
    if (d)
      return o2 = null, d + "" || null;
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? ee2 : k2(e2), t = "function" == typeof t ? t : void 0 === t ? te : k2(t), r2.x = function(t2) {
...
function se2(e2, t, i2) {
  var s2 = null, a2 = k2(true), o2 = null, n3 = $, r2 = null, l2 = V(h);
  function h(h2) {
    var d2, c, u, g3, p, m = (h2 = J(h2)).length, _2 = false, b = new Array(m), x2 = new Array(m);
    for (null == o2 && (r2 = n3(p = l2())), d2 = 0; d2 <= m; ++d2) {
      if (!(d2 < m && a2(g3 = h2[d2], d2, h2)) === _2)
        if (_2 = !_2)
          c = d2, r2.areaStart(), r2.lineStart();
        else {
          for (r2.lineEnd(), r2.lineStart(), u = d2 - 1; u >= c; --u)
            r2.point(b[u], x2[u]);
  ...
  function d() {
    return ie2().defined(a2).curve(n3).context(o2);
  }
  return e2 = "function" == typeof e2 ? e2 : void 0 === e2 ? ee2 : k2(+e2), t = "function" == typeof t ? t : k2(void 0 === t ? 0 : +t), i2 = "function" == typeof i2 ? i2 : void 0 === i2 ? te : k2(+i2), h.x = function(t2) {
...
var ae = class extends ai {
  setupDefaultRules() {
    super.setupDefaultRules();
    const e2 = this._root.interfaceColors, l2 = this._root.language, h = this.rule.bind(this);
    ...
    h("RoundedRectangle", ["xy", "scrollbar", "thumb"]).setAll({ cornerRadiusTR: 0, cornerRadiusTL: 0, cornerRadiusBR: 0, cornerRadiusBL: 0, fillOpacity: 0, focusable: true }), h("RoundedRectangle", ["xy", "scrollbar", "thumb"]).states.create("hover", { fillOpacity: 0.4 }), h("RoundedRectangle", ["xy", "scrollbar", "chart", "background"]).setAll({ cornerRadiusTL: 0, cornerRadiusBL: 0, cornerRadiusTR: 0, cornerRadiusBR: 0 }), h("RoundedRectangle", ["xy", "scrollbar", "chart", "background", "resize", "button"]).setAll({ cornerRadiusBL: 40, cornerRadiusBR: 40, cornerRadiusTL: 40, cornerRadiusTR: 40 }), h("AxisRendererX", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: true }), h("AxisRendererY", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: true, minGridDistance: 5 }), h("AxisLabel", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5, centerY: r, minPosition: 0.01, maxPosition: 0.99, fontSize: "0.8em" }), h("AxisLabel", ["category"]).setAll({ text: "{category}", populateText: true }), h("AxisLabel", ["x"]).setAll({ centerY: 0 }), h("AxisLabel", ["x", "inside"]).setAll({ centerY: r }), h("AxisLabel", ["x", "inside", "opposite"]).setAll({ centerY: 0 }), h("AxisLabel", ["x", "opposite"]).setAll({ centerY: r }), h("AxisLabel", ["y"]).setAll({ centerX: r }), h("AxisLabel", ["y", "inside"]).setAll({ centerX: 0 }), h("AxisLabel", ["y", "inside", "opposite"]).setAll({ centerX: r }), h("AxisLabel", ["y", "opposite"]).setAll({ centerX: 0 }), h("AxisLabel", ["minor"]).setAll({ fontSize: "0.6em" }), h("AxisLabel", ["xy", "scrollbar", "y"]).setAll({ visible: false }), h("Grid", ["xy", "scrollbar", "y"]).setAll({ visible: false }), h("Grid", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5 }), h("XYCursor").setAll({ behavior: "none", layer: 30, exportable: false, snapToSeriesBy: "xy", moveThreshold: 1 });
    {
      ...
      t.setAll({ forceInactive: true, strokeOpacity: 0.8, strokeDasharray: [2, 2], ariaLabel: l2.translate("Use left and right arrows to move selection") }), l(t, "stroke", e2, "alternativeBackground");
    }
    {
      const t = h("Grid", ["cursor", "y"]);
      t.setAll({ forceInactive: true, strokeOpacity: 0.8, strokeDasharray: [2, 2], ariaLabel: l2.translate("Use up and down arrows to move selection") }), l(t, "stroke", e2, "alternativeBackground");
    }
    {
    ...
    const d = [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 5 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 50 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "millisecond", count: 500 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 5 }, { timeUnit: "second", count: 10 }, { timeUnit: "second", count: 30 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 5 }, { timeUnit: "minute", count: 10 }, { timeUnit: "minute", count: 15 }, { timeUnit: "minute", count: 30 }, { timeUnit: "hour", count: 1 }, { timeUnit: "hour", count: 3 }, { timeUnit: "hour", count: 6 }, { timeUnit: "hour", count: 12 }, { timeUnit: "day", count: 1 }, { timeUnit: "day", count: 2 }, { timeUnit: "day", count: 3 }, { timeUnit: "day", count: 4 }, { timeUnit: "day", count: 5 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "month", count: 2 }, { timeUnit: "month", count: 3 }, { timeUnit: "month", count: 6 }, { timeUnit: "year", count: 1 }, { timeUnit: "year", count: 2 }, { timeUnit: "year", count: 5 }, { timeUnit: "year", count: 10 }, { timeUnit: "year", count: 50 }, { timeUnit: "year", count: 100 }, { timeUnit: "year", count: 200 }, { timeUnit: "year", count: 500 }, { timeUnit: "year", count: 1e3 }, { timeUnit: "year", count: 2e3 }, { timeUnit: "year", count: 5e3 }, { timeUnit: "year", count: 1e4 }, { timeUnit: "year", count: 1e5 }], c = { millisecond: l2.translate("_date_millisecond"), second: l2.translate("_date_second"), minute: l2.translate("_date_minute"), hour: l2.translate("_date_hour"), day: l2.translate("_date_day"), week: l2.translate("_date_day"), month: l2.translate("_date_month"), year: l2.translate("_date_year") }, u = { millisecond: l2.translate("_date_millisecond"), second: l2.translate("_date_second"), minute: l2.translate("_date_minute"), hour: l2.translate("_date_day"), day: l2.translate("_date_day"), week: l2.translate("_date_day"), month: l2.translate("_date_month") + " " + l2.translate("_date_year"), year: l2.translate("_date_year") }, g3 = { millisecond: l2.translate("_date_millisecond_full"), second: l2.translate("_date_second_full"), minute: l2.translate("_date_minute_full"), hour: l2.translate("_date_hour_full"), day: l2.translate("_date_day_full"), week: l2.translate("_date_week_full"), month: l2.translate("_date_month_full"), year: l2.translate("_date_year") };
    h("CategoryDateAxis").setAll({ markUnitChange: true, gridIntervals: S(d), dateFormats: F(c), periodChangeDateFormats: F(u) }), h("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: true, startLocation: 0, endLocation: 1, markUnitChange: true, groupData: false, groupCount: 500, gridIntervals: S(d), dateFormats: F(c), periodChangeDateFormats: F(u), tooltipDateFormats: g3, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (e3) => {
      ...
      if (t) {
        ...
        let l3 = i2.getPrivate("min", 0);
        if (l3 = I(new Date(l3), r2.timeUnit, r2.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(), null != s2 && null != a2) {
          const e4 = Math.round(Math.round((s2 - l3) / o2)) / 2;
      ...
      if (t) {
        ...
        g(a2) && g(o2) && (he(a2 / o2 / 2, 5) == Math.round(a2 / o2 / 2) ? t.setPrivate("visible", false) : t.setPrivate("visible", true));
      }
...
var oe = class extends R {
  ...
  arrangeTooltips() {
    const e2 = this.plotContainer, t = e2.width(), i2 = e2.height(), a2 = this.height();
    let o2 = e2._display.toGlobal({ x: 0, y: 0 }), n3 = e2._display.toGlobal({ x: t, y: i2 });
    const r2 = [];
        ...
        if (s2) {
          if (g3 >= 0) {
            ...
            if (s3 && h && e3 != l2) {
              ...
              "x" == p ? e4 = Math.abs(h.x - s3.x) : "y" == p && (e4 = Math.abs(h.y - s3.y)), e4 > g3 && (i3 = true);
            }
          } else
            -1 == g3 && e3 != l2 && (i3 = true);
          this.inPlot(this._tooltipToLocal(s2)) && t2.dataItem ? i3 || (d += s2.y) : i3 = true, i3 || e3.isHidden() || e3.isHiding() ? t2.hide(0) : (t2.show(), r2.push(t2), m.push(e3));
        }
      }
    }), this.setPrivate("tooltipSeries", m), this.get("arrangeTooltips")) {
      const e3 = this._root.tooltipContainer, t2 = r2.length;
      if (d / t2 > i2 / 2 + o2.y) {
        r2.sort((e4, t4) => Se(t4.get("pointTo").y, e4.get("pointTo").y));
        let t3 = n3.y;
        if (w(r2, (i3) => {
          let s2 = i3.height(), a3 = i3.get("centerY");
          a3 instanceof e && (s2 *= a3.value), s2 += i3.get("marginBottom", 0), i3.set("bounds", { left: o2.x, top: o2.y, right: n3.x, bottom: t3 }), i3.setPrivate("customData", { left: o2.x, top: o2.y, right: n3.x, bottom: t3 }), t3 = Math.min(t3 - s2, i3._fy - s2), i3.parent == e3 && e3.children.moveValue(i3, 0);
        }), t3 < 0) {
          r2.reverse();
          let e4 = t3;
          w(r2, (i3) => {
            ...
            if (s2) {
              ...
              a3 < e4 && (a3 = e4, o3 = a3 + i3.height()), i3.set("bounds", { left: s2.left, top: a3, right: s2.right, bottom: o3 }), e4 = s2.bottom - t3 + i3.get("marginBottom", 0);
            }
          });
        }
      } else {
        r2.reverse(), r2.sort((e4, t4) => Se(e4.get("pointTo").y, t4.get("pointTo").y));
        let t3 = 0;
        if (w(r2, (i3) => {
          let s2 = i3.height(), r3 = i3.get("centerY");
          r3 instanceof e && (s2 *= r3.value), s2 += i3.get("marginBottom", 0), i3.set("bounds", { left: o2.x, top: t3, right: n3.x, bottom: Math.max(o2.y + a2, t3 + s2) }), i3.parent == e3 && e3.children.moveValue(i3, 0), t3 = Math.max(t3 + s2, i3._fy + s2);
        }), t3 > a2) {
          r2.reverse();
          let e4 = a2;
          w(r2, (i3) => {
            let s2 = i3.get("bounds");
            if (s2) {
              let o3 = s2.top - (a2 - t3), n4 = s2.bottom - (a2 - t3);
              n4 > e4 && (n4 = e4, o3 = n4 - i3.height()), i3.set("bounds", { left: s2.left, top: o3, right: s2.right, bottom: n4 }), e4 = n4 - i3.height() - i3.get("marginBottom", 0);
            }
          });
        }
      }
  ...
  handleMove(e2, t, i2) {
    ...
    if (n3 && (this._inPlot(o2) || this._downPoint)) {
      ...
      if (r2 = m.x, l2 = m.y, n3.xAxes.each((e3) => {
        e3._handleCursorPosition(u, d), a2 && e3.handleCursorShow();
      }), n3.yAxes.each((e3) => {
...
var de2 = class extends D {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_xField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_yField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_xOpenField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_yOpenField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_xLowField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_xHighField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_yLowField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_yHighField", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_axesDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_stackDirty", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_selectionProcessed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_dataSets", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_mainContainerMask", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_x", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_y", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_bullets", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "mainContainer", { enumerable: true, configurable: true, writable: true, value: this.children.push(ii.new(this._root, {})) }), Object.defineProperty(this, "axisRanges", { enumerable: true, configurable: true, writable: true, value: new ee() }), Object.defineProperty(this, "_skipped", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_couldStackTo", { enumerable: true, configurable: true, writable: true, value: [] }), Object.defineProperty(this, "_reallyStackedTo", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_stackedSeries", { enumerable: true, configurable: true, writable: true, value: {} }), Object.defineProperty(this, "_aLocationX0", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_aLocationX1", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_aLocationY0", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_aLocationY1", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_showBullets", { enumerable: true, configurable: true, writable: true, value: true }), Object.defineProperty(this, "valueXFields", { enumerable: true, configurable: true, writable: true, value: ["valueX", "openValueX", "lowValueX", "highValueX"] }), Object.defineProperty(this, "valueYFields", { enumerable: true, configurable: true, writable: true, value: ["valueY", "openValueY", "lowValueY", "highValueY"] }), Object.defineProperty(this, "_valueXFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_valueYFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_valueXShowFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_valueYShowFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "__valueXShowFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "__valueYShowFields", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_emptyDataItem", { enumerable: true, configurable: true, writable: true, value: new g2(this, void 0, {}) }), Object.defineProperty(this, "_dataSetId", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_tooltipFieldX", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_tooltipFieldY", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_posXDp", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_posYDp", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  _afterNew() {
  ...
  _min(e2, t) {
    let i2 = le2(this.getPrivate(e2), t);
    this.setPrivate(e2, i2);
  }
  _max(e2, t) {
    let i2 = he2(this.getPrivate(e2), t);
    this.setPrivate(e2, i2);
  }
  ...
  _makeFieldNames() {
    const e2 = this.get("xAxis"), t = this.get("yAxis"), i2 = e2.getPrivate("name"), s2 = Ct(i2), a2 = t.getPrivate("name"), o2 = Ct(a2), n3 = e2.get("renderer").getPrivate("letter"), r2 = t.get("renderer").getPrivate("letter"), l2 = "open", h = "low", d = "high", c = "Show";
        ...
        if (i2 === e2 || !i2)
          if (t._calculateTotals(), this.setPrivateRaw("selectionMinY", void 0), this.setPrivateRaw("selectionMaxY", void 0), l2)
            ...
            for (let e3 = s3; e3 < a3; e3++)
              this.processYSelectionDataItem(this.dataItems[e3], n3, r2);
        if (i2 === t || !i2)
  ...
  _stackDataItems() {
    ...
    this._reallyStackedTo = {}, w(this.dataItems, (e3) => {
      for (let t2 = 0; t2 < n3; t2++) {
        let i3 = this._couldStackTo[t2], n4 = i3.dataItems[r2], h = e3.get(a2);
        if (n4) {
          let t3 = n4.get(a2);
          if (l2) {
            if (!g(h))
  ...
  hideDataItem(e2, t) {
    ...
    return n(this, void 0, void 0, function* () {
      ...
      if (h !== r2 && h || w(this._valueYFields, (i3) => {
        ...
        g(o3) && o3 > r3 && (r3 = o3), d && (r3 = 0), null != e2.get(i3) && a2.push(e2.animate({ key: i3 + "Working", to: r3, duration: t, easing: n3 }).waitForStop());
      }), h === l2 || !h) {
        let i3 = r2.getPrivate("min"), o3 = r2.baseValue();
        g(i3) && i3 > o3 && (o3 = i3), d && (o3 = 0), w(this._valueXFields, (i4) => {
          null != e2.get(i4) && a2.push(e2.animate({ key: i4 + "Working", to: o3, duration: t, easing: n3 }).waitForStop());
        });
      }
      yield Promise.all(a2);
    });
...
var ce = class extends _ {
  ...
  _afterNew() {
    ...
    e2 && (e2.axis = this, e2.processAxis()), this.children.push(e2), this.ghostLabel = e2.makeLabel(new g2(this, void 0, {}), []), this.ghostLabel.adapters.disable("text"), this.ghostLabel.setAll({ opacity: 0, tooltipText: void 0, tooltipHTML: void 0, interactive: false }), this.ghostLabel.events.disable();
  }
  _updateFinals(e2, t) {
  }
  zoom(e2, t, i2, a2) {
    if (this.get("zoomable", true))
      if (this._updateFinals(e2, t), this.get("start") !== e2 || this.get("end") != t) {
        ...
        g(d) && (l2 = h / d);
        let u = 1;
        if (g(c) && (u = h / c), "start" === a2 ? (c > 0 && 1 / (t - e2) < u && (t = e2 + 1 / u), 1 / (t - e2) > l2 && (t = e2 + 1 / l2), t > 1 && t - e2 < 1 / l2 && (e2 = t - 1 / l2)) : (c > 0 && 1 / (t - e2) < u && (e2 = t - 1 / u), 1 / (t - e2) > l2 && (e2 = t - 1 / l2), e2 < 0 && t - e2 < 1 / l2 && (t = e2 + 1 / l2)), 1 / (t - e2) > l2 && (t = e2 + 1 / l2), 1 / (t - e2) > l2 && (e2 = t - 1 / l2), null != c && null != d && e2 == this.get("start") && t == this.get("end")) {
          const e3 = this.chart;
          e3 && e3._handleAxisSelection(this, true);
        }
        if ((o2 && o2.playing && o2.to == e2 || this.get("start") == e2) && (n3 && n3.playing && n3.to == t || this.get("end") == t))
          return;
        if (i2 > 0) {
  ...
  updateTooltip() {
    ...
    g(t) && (w(this.series, (i3) => {
      if (i3.get("baseAxis") === this) {
        ...
        e2 && -1 != e2.indexOf(i3) ? (i3.updateLegendMarker(s2), i3.updateLegendValue(s2), i3._settings.tooltipDataItem = s2) : (i3.showDataItemTooltip(s2), i3.setRaw("tooltipDataItem", s2));
      }
    }), i2 && (a2.updateTooltipBounds(i2), this.get("snapTooltip") && (t = this.roundAxisPosition(t, this.get("tooltipLocation", 0.5))), n2(t) ? i2.hide(0) : (this.setPrivateRaw("tooltipPosition", t), this._updateTooltipText(i2, t), a2.positionTooltip(i2, t), t < this.get("start", 0) || t > this.get("end", 1) ? i2.hide(0) : i2.show(0))));
  }
...
Object.defineProperty(ce, "className", { enumerable: true, configurable: true, writable: true, value: "Axis" }), Object.defineProperty(ce, "classNames", { enumerable: true, configurable: true, writable: true, value: _.classNames.concat([ce.className]) });
var ue = class extends ce {
  ...
  _prepareAxisItems() {
    ...
    if (g(e2) && g(t)) {
      ...
      let u = Math.pow(10, Math.floor(Math.log(Math.abs(i2)) * Math.LOG10E));
      const g3 = Math.round(i2 / u);
      let p = 2;
      he(g3 / 5, 10) % 1 == 0 && (p = 5), he(g3 / 10, 10) % 1 == 0 && (p = 10);
      let m = i2 / p, _2 = 0, x2 = 0, f = -1 / 0;
      for (; o2 < a2; ) {
        let e3;
        this.dataItems.length < _2 + 1 ? (e3 = new g2(this, void 0, {}), this._dataItems.push(e3), this.processDataItem(e3)) : e3 = this.dataItems[_2], this._createAssets(e3, []), this._toggleDataItem(e3, true), e3.setRaw("value", o2);
        ...
        if (t2 && r2 > 2 ? a3 = Math.pow(10, Math.log(l2) * Math.LOG10E + _2 - 5) : a3 += i2, c) {
          ...
          for (; e4 < a3 - 1e-11 * i2; ) {
            let t3;
            this.minorDataItems.length < x2 + 1 ? (t3 = new g2(this, void 0, {}), this.minorDataItems.push(t3), this.processDataItem(t3)) : t3 = this.minorDataItems[x2], this._createAssets(t3, ["minor"], true), this._toggleDataItem(t3, true), t3.setRaw("value", e4);
  ...
  _prepareDataItem(e2, t) {
    let i2 = this.get("renderer"), a2 = e2.get("value"), o2 = e2.get("endValue"), n3 = this.valueToPosition(a2), r2 = n3, l2 = this.valueToPosition(a2 + this.getPrivate("step"));
    ...
    const c = e2.get("grid");
    if (i2.updateGrid(c, n3, r2), c && (a2 == this.get("baseValue", 0) ? (c.addTag("base"), c._applyThemes()) : c.hasTag("base") && (c.removeTag("base"), c._applyThemes())), i2.updateTick(e2.get("tick"), n3, h, t), i2.updateFill(e2.get("axisFill"), n3, l2), this._processBullet(e2), i2.updateBullet(e2.get("bullet"), n3, r2), !e2.get("isRange")) {
  ...
  _handleRangeChange() {
    ...
    this.setPrivateRaw("stepDecimalPlaces", a2), e2 = he(e2, a2), t = he(t, a2), s2 = this._adjustMinMax(e2, t, i2, true);
    let o2 = s2.step;
  ...
  _getSelectionMinMax() {
    ...
    if (g(e2) && g(t)) {
      ...
      }), c > u && ([c, u] = [u, c]), g(i2) ? c = d ? i2 : e2 : d && g(this._minReal) && (c = this._minReal), g(a2) ? u = d ? a2 : t : d && g(this._maxReal) && (u = this._maxReal), c === u) {
        let t2 = c;
      ...
      c = m.min, u = m.max, c = de(c, e2, t), u = de(u, e2, t), m = this._adjustMinMax(c, u, l2, true), d || (c = m.min, u = m.max);
      const _2 = this.get("syncWithAxis");
      _2 && (m = this._syncAxes(c, u, m.step, _2.getPrivate("selectionMinFinal", _2.getPrivate("minFinal", 0)), _2.getPrivate("selectionMaxFinal", _2.getPrivate("maxFinal", 1)), _2.getPrivate("selectionStepFinal", _2.getPrivate("step", 1))), m.min < e2 && (m.min = e2), m.max > t && (m.max = t), c = m.min, u = m.max), d && (g(i2) && (c = Math.max(c, i2)), g(a2) && (u = Math.min(u, a2))), h && (c = g3 - (u - c) * o2, u = p + (u - c) * r2), this.get("logarithmic") && (c <= 0 && (c = g3 * (1 - Math.min(o2, 0.99))), c < e2 && (c = e2), u > t && (u = t));
      let x2 = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2), f = he(this.valueToFinalPosition(c), x2), v = he(this.valueToFinalPosition(u), x2);
  ...
  _getMinMax() {
    ...
    const h = i2, d = a2;
    let c = this.adapters.fold("min", i2), u = this.adapters.fold("max", a2);
    g(c) && (i2 = c), g(u) && (a2 = u), i2 = this._fixMin(i2), a2 = this._fixMax(a2), a2 - i2 <= 1 / Math.pow(10, 15) && (a2 - i2 != 0 ? this._deltaMinMax = (a2 - i2) / 2 : this._getDelta(a2), i2 -= this._deltaMinMax, a2 += this._deltaMinMax), i2 -= (a2 - i2) * o2, a2 += (a2 - i2) * r2, this.get("logarithmic") && (i2 < 0 && h >= 0 && (i2 = 0), a2 > 0 && d <= 0 && (a2 = 0)), this._minReal = i2, this._maxReal = a2;
    ...
    i2 = x2.min, a2 = x2.max, x2 = this._adjustMinMax(i2, a2, _2, true), i2 = x2.min, a2 = x2.max, g3 && (i2 = g(e2) ? e2 : this._minReal, a2 = g(t) ? t : this._maxReal, a2 - i2 <= 1e-8 && (i2 -= this._deltaMinMax, a2 += this._deltaMinMax), i2 -= (a2 - i2) * o2, a2 += (a2 - i2) * r2), c = this.adapters.fold("min", i2), u = this.adapters.fold("max", a2), g(c) && (i2 = c), g(u) && (a2 = u), l2 == 1 / 0 && (l2 = a2 - i2);
    let f = Math.round(Math.abs(Math.log(Math.abs(a2 - i2)) * Math.LOG10E)) + 5;
    i2 = he(i2, f), a2 = he(a2, f);
  ...
  _adjustMinMax(e2, t, i2, a2) {
    ...
    if (g(m)) {
      let e3 = le(u, m);
      m < Number.MAX_VALUE && u !== e3 && (u = e3);
    }
    let _2 = 0;
    g3 < 1 && (_2 = Math.round(Math.abs(Math.log(Math.abs(g3)) * Math.LOG10E)) + 1, u = he(u, _2));
    let b, x2 = Math.floor(e2 / u);
    return e2 = he(u * x2, _2), b = a2 ? Math.floor(t / u) : Math.ceil(t / u), b === x2 && b++, (t = he(u * b, _2)) < r2 && (t += u), e2 > o2 && (e2 -= u), u = this.fixSmallStep(u), { min: e2, max: t, step: u };
  }
  getTooltipText(e2, t) {
    const i2 = this.get("tooltipNumberFormat", this.get("numberFormat")), s2 = this.getNumberFormatter(), a2 = this.get("extraTooltipPrecision", 0), o2 = this.getPrivate("stepDecimalPlaces", 0) + a2, r2 = he(this.positionToValue(e2), o2);
  ...
  _syncAxes(e2, t, i2, a2, o2, n3) {
    if (this.get("syncWithAxis")) {
      let r2 = Math.round(o2 - a2) / n3, l2 = Math.round((t - e2) / i2), h = this.get("renderer").gridCount();
      if (g(r2) && g(l2)) {
        let s2 = false, a3 = 0, o3 = 0.01 * (t - e2), n4 = e2, l3 = t, d = i2;
        for (; 1 != s2; )
          if (s2 = this._checkSync(n4, l3, d, r2), a3++, a3 > 500 && (s2 = true), s2)
            e2 = n4, t = l3, i2 = d;
          else {
            a3 / 3 == Math.round(a3 / 3) ? (n4 = e2 - o3 * a3, e2 >= 0 && n4 < 0 && (n4 = 0)) : (l3 = t + o3 * a3, l3 <= 0 && l3 > 0 && (l3 = 0));
...
var me = class extends Ke {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_axisLength", { enumerable: true, configurable: true, writable: true, value: 100 }), Object.defineProperty(this, "_start", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_end", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_inversed", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_minSize", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "chart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_lc", { enumerable: true, configurable: true, writable: true, value: 1 }), Object.defineProperty(this, "_ls", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_thumbDownPoint", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downStart", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_downEnd", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "ticks", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => pe._new(this._root, { themeTags: Ft(this.ticks.template.get("themeTags", []), this.get("themeTags", [])) }, [this.ticks.template])) }), Object.defineProperty(this, "grid", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => ne._new(this._root, { themeTags: Ft(this.grid.template.get("themeTags", []), this.get("themeTags", [])) }, [this.grid.template])) }), Object.defineProperty(this, "axisFills", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => Ke._new(this._root, { themeTags: Ft(this.axisFills.template.get("themeTags", ["axis", "fill"]), this.get("themeTags", [])) }, [this.axisFills.template])) }), Object.defineProperty(this, "labels", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => ge._new(this._root, { themeTags: Ft(this.labels.template.get("themeTags", []), this.get("themeTags", [])) }, [this.labels.template])) }), Object.defineProperty(this, "axis", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "thumb", { enumerable: true, configurable: true, writable: true, value: void 0 });
  }
  makeTick(e2, t) {
...
var _e = class extends me {
  ...
  _updatePositions() {
    ...
    if (i2) {
      ...
      const n3 = e2.parent;
      n3 && (o2 -= n3.get("paddingLeft", 0)), s2.children.length > 0 ? (a2 = e2.axisHeader.width(), e2.set("marginLeft", a2 + 1)) : s2.set("width", a2), s2.setAll({ x: o2, y: -1, height: t2.height() + 2 });
    }
  }
  processAxis() {
    super.processAxis();
  ...
  updateTick(e2, i2, a2, o2) {
    if (e2) {
      g(i2) || (i2 = 0);
      let n3 = 0.5;
      n3 = g(o2) && o2 > 1 ? e2.get("multiLocation", n3) : e2.get("location", n3), g(a2) && a2 != i2 && (i2 += (a2 - i2) * n3), e2.set("x", this.positionToCoordinate(i2));
  ...
  updateLabel(e2, i2, a2, o2) {
    if (e2) {
      let n3 = 0.5;
      n3 = g(o2) && o2 > 1 ? e2.get("multiLocation", n3) : e2.get("location", n3), g(i2) || (i2 = 0);
      const r2 = e2.get("inside", this.get("inside", false));
      this.get("opposite") ? r2 ? (e2.set("position", "absolute"), e2.set("y", 0)) : (e2.set("position", "relative"), e2.set("y", r)) : r2 ? (e2.set("y", 0), e2.set("position", "absolute")) : (e2.set("y", void 0), e2.set("position", "relative")), g(a2) && a2 != i2 && (i2 += (a2 - i2) * n3), e2.set("x", this.positionToCoordinate(i2)), this.toggleVisibility(e2, i2, e2.get("minPosition", 0), e2.get("maxPosition", 1));
    }
  }
  updateGrid(e2, t, i2) {
    if (e2) {
      ...
      if (a2) {
        ...
        if (this.get("opposite") && (l2 = 1), e2.get("stacked"))
          if (r2) {
            ...
            a2.set("y", 0);
        this.axis._bullets[n3] = e2, a2.set("x", this.positionToCoordinate(t)), this.toggleVisibility(a2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    ...
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.x, o2 = 0, n3 = this.axisLength(), r2 = i2, l2 = "up";
    this.get("opposite") ? t ? (l2 = "up", o2 = s2.y, r2 = i2) : (l2 = "down", o2 = s2.y - i2, r2 = i2) : t ? (l2 = "down", o2 = s2.y - i2, r2 = i2) : (l2 = "up", o2 = s2.y, r2 = i2);
    const h = { left: a2, right: a2 + n3, top: o2, bottom: o2 + r2 }, d = e2.get("bounds");
...
var be = class extends me {
      ...
      if (a2) {
        ...
        if (this.get("opposite") && (l2 = -1), e2.get("stacked"))
          if (r2) {
            ...
            a2.set("x", 0);
        this.axis._bullets[n3] = e2, a2.set("y", this.positionToCoordinate(t)), this.toggleVisibility(a2, t, 0, 1);
      }
    }
  }
  updateFill(e2, t, i2) {
  ...
  updateTooltipBounds(e2) {
    const t = this.get("inside"), i2 = 1e5;
    let s2 = this._display.toGlobal({ x: 0, y: 0 }), a2 = s2.y, o2 = 0, n3 = this.axisLength(), r2 = i2, l2 = "right";
    this.get("opposite") ? t ? (l2 = "right", o2 = s2.x - i2, r2 = i2) : (l2 = "left", o2 = s2.x, r2 = i2) : t ? (l2 = "left", o2 = s2.x, r2 = i2) : (l2 = "right", o2 = s2.x - i2, r2 = i2);
    const h = { left: o2, right: o2 + r2, top: a2, bottom: a2 + n3 }, d = e2.get("bounds");
    Wt(h, d) || (e2.set("bounds", h), e2.set("pointerOrientation", l2));
  }
  _updateLC() {
    const e2 = this.axis, t = e2.parent;
...
var xe = class extends de2 {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_endIndex", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_strokeGenerator", { enumerable: true, configurable: true, writable: true, value: ie2() }), Object.defineProperty(this, "_fillGenerator", { enumerable: true, configurable: true, writable: true, value: se2() }), Object.defineProperty(this, "_legendStroke", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_legendFill", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "strokes", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => Ke._new(this._root, { themeTags: Ft(this.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template])) }), Object.defineProperty(this, "fills", { enumerable: true, configurable: true, writable: true, value: new se(Le.new({}), () => Ke._new(this._root, { themeTags: Ft(this.strokes.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template])) }), Object.defineProperty(this, "_fillTemplate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_strokeTemplate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_previousPoint", { enumerable: true, configurable: true, writable: true, value: [0, 0, 0, 0] }), Object.defineProperty(this, "_dindex", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_sindex", { enumerable: true, configurable: true, writable: true, value: 0 });
  }
  _afterNew() {
  ...
  _startSegment(e2) {
    ...
    let R2 = false;
    (y || f || v) && (R2 = true);
    const j = { points: D2, segments: k3, stacked: y, getOpen: R2, basePosX: w2, basePosY: P, fillVisible: F2, xField: m, yField: _2, xOpenField: b, yOpenField: x2, vcx: g3, vcy: p, baseAxis: u, xAxis: d, yAxis: c, locationX: S2, locationY: O2, openLocationX: C, openLocationY: X, minDistance: Y2 };
    for (L = e2; L < i2; L++) {
      this._dindex = L;
    ...
    o2.setRaw("userData", [e2, L]), l2.setRaw("userData", [e2, L]), L === t && this._endLine(D2, k3[0][0]), l2 && this._drawStroke(l2, k3), o2 && this._drawFill(o2, k3), this.axisRanges.each((t2) => {
      ...
      i3 && i3.children.push(n4), n4.setPrivate("visible", true), this._drawStroke(n4, k3), a3.setRaw("userData", [e2, L]), n4.setRaw("userData", [e2, L]);
    });
  }
  _getPoints(e2, t) {
  ...
  _processAxisRange(e2) {
    super._processAxisRange(e2), e2.fills = new se(Le.new({}), () => Ke._new(this._root, { themeTags: Ft(e2.fills.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template, e2.fills.template])), e2.strokes = new se(Le.new({}), () => Ke._new(this._root, { themeTags: Ft(e2.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template, e2.strokes.template]));
  }
  createLegendMarker(e2) {
    const t = this.get("legendDataItem");
    if (t) {
      ...
      if (s2.states.create("disabled", { fill: o2, stroke: o2 }), a2.states.create("disabled", { fill: o2, stroke: o2 }), this.bullets.length > 0) {
        ...
        if (t2) {
          const i3 = t2(e3._root, this, new g2(this, { legend: true }, {}));
          if (i3) {
...
Object.defineProperty(xe, "className", { enumerable: true, configurable: true, writable: true, value: "LineSeries" }), Object.defineProperty(xe, "classNames", { enumerable: true, configurable: true, writable: true, value: de2.classNames.concat([xe.className]) });
...
//# sourceMappingURL=chunk-JQXQ7AT7.js.map
