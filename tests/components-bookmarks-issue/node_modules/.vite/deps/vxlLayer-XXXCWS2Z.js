...
var n;
var o2 = { exports: {} };
r = o2, t = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, n = function(e = {}) {
  var r2, n2, o3 = e;
  o3.ready = new Promise((e2, t2) => {
    r2 = e2, n2 = t2;
  });
  var a2, i2, s = Object.assign({}, o3), u = "./this.program", l = true, d = "";
  function c(e2) {
    return o3.locateFile ? o3.locateFile(e2, d) : d + e2;
  }
  ...
  var f, m, h = o3.print || console.log.bind(console), p = o3.printErr || console.error.bind(console);
  Object.assign(o3, s), s = null, o3.arguments && o3.arguments, o3.thisProgram && (u = o3.thisProgram), o3.quit && o3.quit, o3.wasmBinary && (f = o3.wasmBinary), "object" != typeof WebAssembly && H("no native wasm support detected");
  ...
  function S() {
    var e2 = m.buffer;
    o3.HEAP8 = v = new Int8Array(e2), o3.HEAP16 = y = new Int16Array(e2), o3.HEAPU8 = g = new Uint8Array(e2), o3.HEAPU16 = w = new Uint16Array(e2), o3.HEAP32 = E = new Int32Array(e2), o3.HEAPU32 = _ = new Uint32Array(e2), o3.HEAPF32 = b = new Float32Array(e2), o3.HEAPF64 = k = new Float64Array(e2);
  }
  var A = [], P = [], C = [];
  function D() {
    if (o3.preRun)
  ...
  function T() {
    o3.noFSInit || Fe.init.initialized || Fe.init(), Fe.ignorePermissions = false, K(P);
  }
  function M() {
    if (o3.postRun)
  ...
  function N(e2) {
    R++, o3.monitorRunDependencies && o3.monitorRunDependencies(R);
  }
  function W(e2) {
    if (R--, o3.monitorRunDependencies && o3.monitorRunDependencies(R), 0 == R && I) {
      var r3 = I;
      I = null, r3();
    }
  }
  function H(e2) {
    o3.onAbort && o3.onAbort(e2), p(e2 = "Aborted(" + e2 + ")"), x = true, e2 += ". Build with -sASSERTIONS for more info.";
  ...
  function J() {
    ...
    if (N(), o3.instantiateWasm)
      try {
        return o3.instantiateWasm(e2, r3);
      } catch (a3) {
  ...
  var Z = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, ee = (e2, r3, t2) => {
    for (var n3 = r3 + t2, o4 = r3; e2[o4] && !(o4 >= n3); )
      ++o4;
    if (o4 - r3 > 16 && e2.buffer && Z)
      return Z.decode(e2.subarray(r3, o4));
    for (var a3 = ""; r3 < o4; ) {
      var i3 = e2[r3++];
      if (128 & i3) {
        var s2 = 63 & e2[r3++];
  ...
  var oe = (e2, r3, t2) => {
    ...
    for (var t2 = 0, n3 = e2.length - 1; n3 >= 0; n3--) {
      var o4 = e2[n3];
      "." === o4 ? e2.splice(n3, 1) : ".." === o4 ? (e2.splice(n3, 1), t2++) : t2 && (e2.splice(n3, 1), t2--);
    }
    if (r3)
      for (; t2; t2--)
        e2.unshift("..");
    ...
    for (var n3 = t2(e2.split("/")), o4 = t2(r3.split("/")), a3 = Math.min(n3.length, o4.length), i3 = a3, s2 = 0; s2 < a3; s2++)
      if (n3[s2] !== o4[s2]) {
        i3 = s2;
        break;
      }
    ...
    if (!(n3 > 0))
      return 0;
    for (var o4 = t2, a3 = t2 + n3 - 1, i3 = 0; i3 < e2.length; ++i3) {
    ...
    return r3[t2] = 0, t2 - o4;
  };
  function me(e2, r3, t2) {
    var n3 = t2 > 0 ? t2 : ce(e2) + 1, o4 = new Array(n3), a3 = fe(e2, o4, 0, o4.length);
    return r3 && (o4.length = a3), o4;
  }
  var he = () => {
    if (!de.length) {
      var e2 = null;
    ...
    var o4 = Fe.createNode(e2, r3, t2, n3);
    return Fe.isDir(o4.mode) ? (o4.node_ops = ge.ops_table.dir.node, o4.stream_ops = ge.ops_table.dir.stream, o4.contents = {}) : Fe.isFile(o4.mode) ? (o4.node_ops = ge.ops_table.file.node, o4.stream_ops = ge.ops_table.file.stream, o4.usedBytes = 0, o4.contents = null) : Fe.isLink(o4.mode) ? (o4.node_ops = ge.ops_table.link.node, o4.stream_ops = ge.ops_table.link.stream) : Fe.isChrdev(o4.mode) && (o4.node_ops = ge.ops_table.chrdev.node, o4.stream_ops = ge.ops_table.chrdev.stream), o4.timestamp = Date.now(), e2 && (e2.contents[r3] = o4, e2.timestamp = o4.timestamp), o4;
    ...
    if (!(t2 >= r3)) {
      ...
      var o4 = e2.contents;
      e2.contents = new Uint8Array(r3), e2.usedBytes > 0 && e2.contents.set(o4.subarray(0, e2.usedBytes), 0);
    }
    ...
    return e2.link;
  } }, stream_ops: { read(e2, r3, t2, n3, o4) {
    var a3 = e2.node.contents;
    if (o4 >= e2.node.usedBytes)
      return 0;
    var i3 = Math.min(e2.node.usedBytes - o4, n3);
    if (i3 > 8 && a3.subarray)
      r3.set(a3.subarray(o4, o4 + i3), t2);
    else
      for (var s2 = 0; s2 < i3; s2++)
        r3[t2 + s2] = a3[o4 + s2];
    return i3;
  }, write(e2, r3, t2, n3, o4, a3) {
    ...
    if (i3.timestamp = Date.now(), r3.subarray && (!i3.contents || i3.contents.subarray)) {
      ...
      if (0 === i3.usedBytes && 0 === o4)
        return i3.contents = r3.slice(t2, t2 + n3), i3.usedBytes = n3, n3;
      if (o4 + n3 <= i3.usedBytes)
        return i3.contents.set(r3.subarray(t2, t2 + n3), o4), n3;
    }
    if (ge.expandFileStorage(i3, o4 + n3), i3.contents.subarray && r3.subarray)
      i3.contents.set(r3.subarray(t2, t2 + n3), o4);
    else
      for (var s2 = 0; s2 < n3; s2++)
        i3.contents[o4 + s2] = r3[t2 + s2];
  ...
  }, msync: (e2, r3, t2, n3, o4) => (ge.stream_ops.write(e2, r3, 0, n3, t2, false), 0) } }, ye = (e2, r3, t2, n3) => {
    var o4 = n3 ? "" : O(`al ${e2}`);
    i2(e2, (t3) => {
      F(t3, `Loading data file "${e2}" failed (no arrayBuffer).`), r3(new Uint8Array(t3)), o4 && W();
    }, (r4) => {
      if (!t2)
        throw `Loading data file "${e2}" failed.`;
      t2();
    }), o4 && N();
  }, we = (e2, r3, t2, n3, o4, a3) => Fe.createDataFile(e2, r3, t2, n3, o4, a3), Ee = o3.preloadPlugins || [], _e = (e2, r3, t2, n3) => {
    "undefined" != typeof Browser && Browser.init();
    var o4 = false;
    return Ee.forEach((a3) => {
      o4 || a3.canHandle(r3) && (a3.handle(e2, r3, t2, n3), o4 = true);
    }), o4;
  }, be = (e2, r3, t2, n3, o4, a3, i3, s2, u2, l2) => {
    var d2 = r3 ? le.resolve(ie.join2(e2, r3)) : e2;
    function c2(t3) {
      function c3(t4) {
        l2 && l2(), s2 || we(e2, r3, t4, n3, o4, u2), a3 && a3(), W();
      }
      _e(t3, d2, c3, () => {
        i3 && i3(), W();
      }) || c3(t3);
    ...
    for (var n3 = e2.split("/").filter((e3) => !!e3), o4 = Fe.root, a3 = "/", i3 = 0; i3 < n3.length; i3++) {
      var s2 = i3 === n3.length - 1;
      if (s2 && r3.parent)
        break;
      if (o4 = Fe.lookupNode(o4, n3[i3]), a3 = ie.join2(a3, n3[i3]), Fe.isMountpoint(o4) && (!s2 || s2 && r3.follow_mount) && (o4 = o4.mounted.root), !s2 || r3.follow)
        for (var u2 = 0; Fe.isLink(o4.mode); ) {
          var l2 = Fe.readlink(a3);
          if (a3 = le.resolve(ie.dirname(a3), l2), o4 = Fe.lookupPath(a3, { recurse_count: r3.recurse_count + 1 }).node, u2++ > 40)
            throw new Fe.ErrnoError(32);
        }
    }
    return { path: a3, node: o4 };
  }, getPath(e2) {
    for (var r3; ; ) {
      if (Fe.isRoot(e2)) {
    ...
    for (var n3 = Fe.hashName(e2.id, r3), o4 = Fe.nameTable[n3]; o4; o4 = o4.name_next) {
      var a3 = o4.name;
      if (o4.parent.id === e2.id && a3 === r3)
        return o4;
    }
    return Fe.lookup(e2, r3);
  }, createNode(e2, r3, t2, n3) {
    var o4 = new Fe.FSNode(e2, r3, t2, n3);
    return Fe.hashAddNode(o4), o4;
  }, destroyNode(e2) {
    Fe.hashRemoveNode(e2);
  }, isRoot: (e2) => e2 === e2.parent, isMountpoint: (e2) => !!e2.mounted, isFile: (e2) => 32768 == (61440 & e2), isDir: (e2) => 16384 == (61440 & e2), isLink: (e2) => 40960 == (61440 & e2), isChrdev: (e2) => 8192 == (61440 & e2), isBlkdev: (e2) => 24576 == (61440 & e2), isFIFO: (e2) => 4096 == (61440 & e2), isSocket: (e2) => !(49152 & ~e2), flagsToPermissionString(e2) {
    var r3 = ["r", "w", "rw"][3 & e2];
    ...
    var o4 = Fe.nodePermissions(e2, "wx");
    if (o4)
      return o4;
    if (t2) {
      if (!Fe.isDir(n3.mode))
    ...
    function a3(e3) {
      if (e3)
        return a3.errored ? void 0 : (a3.errored = true, o4(e3));
      ++n3 >= t2.length && o4(null);
    }
    t2.forEach((r4) => {
      if (!r4.type.syncfs)
        return a3(null);
    ...
    return u2.mount = s2, s2.root = u2, o4 ? Fe.root = u2 : n3 && (n3.mounted = s2, n3.mount && n3.mount.mounts.push(s2)), u2;
  }, unmount(e2) {
    var r3 = Fe.lookupPath(e2, { follow_mount: false });
    if (!Fe.isMountpoint(r3.node))
      throw new Fe.ErrnoError(28);
    var t2 = r3.node, n3 = t2.mounted, o4 = Fe.getMounts(n3);
    Object.keys(Fe.nameTable).forEach((e3) => {
      for (var r4 = Fe.nameTable[e3]; r4; ) {
        var t3 = r4.name_next;
        o4.includes(r4.mount) && Fe.destroyNode(r4), r4 = t3;
      }
    }), t2.mounted = null;
    var a3 = t2.mount.mounts.indexOf(n3);
    t2.mount.mounts.splice(a3, 1);
  }, lookup: (e2, r3) => e2.node_ops.lookup(e2, r3), mknod(e2, r3, t2) {
    var n3 = Fe.lookupPath(e2, { parent: true }).node, o4 = ie.basename(e2);
    if (!o4 || "." === o4 || ".." === o4)
      throw new Fe.ErrnoError(28);
    var a3 = Fe.mayCreate(n3, o4);
    if (a3)
      throw new Fe.ErrnoError(a3);
    if (!n3.node_ops.mknod)
      throw new Fe.ErrnoError(63);
    return n3.node_ops.mknod(n3, o4, r3, t2);
    ...
    for (var t2 = e2.split("/"), n3 = "", o4 = 0; o4 < t2.length; ++o4)
      if (t2[o4]) {
        n3 += "/" + t2[o4];
        try {
          Fe.mkdir(n3, r3);
    ...
    if (!t2)
      throw new Fe.ErrnoError(44);
    var n3 = ie.basename(r3), o4 = Fe.mayCreate(t2, n3);
    if (o4)
      throw new Fe.ErrnoError(o4);
    if (!t2.node_ops.symlink)
      throw new Fe.ErrnoError(63);
    return t2.node_ops.symlink(t2, n3, e2);
  }, rename(e2, r3) {
    var t2, n3, o4 = ie.dirname(e2), a3 = ie.dirname(r3), i3 = ie.basename(e2), s2 = ie.basename(r3);
    ...
    if ("." !== d2.charAt(0))
      throw new Fe.ErrnoError(28);
    if ("." !== (d2 = le.relative(r3, o4)).charAt(0))
      throw new Fe.ErrnoError(55);
    try {
    ...
    var r3 = Fe.lookupPath(e2, { parent: true }).node, t2 = ie.basename(e2), n3 = Fe.lookupNode(r3, t2), o4 = Fe.mayDelete(r3, t2, true);
    if (o4)
      throw new Fe.ErrnoError(o4);
    ...
    if (!r3)
      throw new Fe.ErrnoError(44);
    var t2 = ie.basename(e2), n3 = Fe.lookupNode(r3, t2), o4 = Fe.mayDelete(r3, t2, false);
    if (o4)
      throw new Fe.ErrnoError(o4);
    ...
    var o4;
    if (!(o4 = "string" == typeof e2 ? Fe.lookupPath(e2, { follow: !n3 }).node : e2).node_ops.setattr)
      throw new Fe.ErrnoError(63);
    ...
    return s2.stream_ops.open && s2.stream_ops.open(s2), !o3.logReadFiles || 1 & r3 || (Fe.readFiles || (Fe.readFiles = {}), e2 in Fe.readFiles || (Fe.readFiles[e2] = 1)), s2;
  }, close(e2) {
    if (Fe.isClosed(e2))
      throw new Fe.ErrnoError(8);
    ...
    if (a3) {
      ...
      o4 = e2.position;
    var i3 = e2.stream_ops.read(e2, r3, t2, n3, o4);
    ...
    if (i3) {
      ...
      o4 = e2.position;
    var s2 = e2.stream_ops.write(e2, r3, t2, n3, o4, a3);
    ...
    if (2 & n3 && !(2 & o4) && 2 != (2097155 & e2.flags))
      throw new Fe.ErrnoError(2);
    if (1 == (2097155 & e2.flags))
      throw new Fe.ErrnoError(2);
    if (!e2.stream_ops.mmap)
      throw new Fe.ErrnoError(43);
    return e2.stream_ops.mmap(e2, r3, t2, n3, o4);
  }, msync: (e2, r3, t2, n3, o4) => e2.stream_ops.msync ? e2.stream_ops.msync(e2, r3, t2, n3, o4) : 0, munmap: (e2) => 0, ioctl(e2, r3, t2) {
    ...
    var t2, n3 = Fe.open(e2, r3.flags), o4 = Fe.stat(e2).size, a3 = new Uint8Array(o4);
    return Fe.read(n3, a3, 0, o4, 0), "utf8" === r3.encoding ? t2 = ee(a3, 0) : "binary" === r3.encoding && (t2 = a3), Fe.close(n3), t2;
  }, writeFile(e2, r3, t2 = {}) {
    t2.flags = t2.flags || 577;
    var n3 = Fe.open(e2, t2.flags, t2.mode);
    if ("string" == typeof r3) {
      var o4 = new Uint8Array(ce(r3) + 1), a3 = fe(r3, o4, 0, o4.length);
      Fe.write(n3, o4, 0, a3, void 0, t2.canOwn);
    } else {
    ...
    Fe.mkdir("/dev"), Fe.registerDevice(Fe.makedev(1, 3), { read: () => 0, write: (e3, r4, t3, n3, o4) => n3 }), Fe.mkdev("/dev/null", Fe.makedev(1, 3)), pe.register(Fe.makedev(5, 0), pe.default_tty_ops), pe.register(Fe.makedev(6, 0), pe.default_tty1_ops), Fe.mkdev("/dev/tty", Fe.makedev(5, 0)), Fe.mkdev("/dev/tty1", Fe.makedev(6, 0));
    ...
    Fe.mkdir("/proc/self/fd"), Fe.mount({ mount() {
      ...
      return r3.node_ops = { lookup(e3, r4) {
        var t2 = +r4, n3 = Fe.getStreamChecked(t2), o4 = { parent: null, mount: { mountpoint: "fake" }, node_ops: { readlink: () => n3.path } };
        return o4.parent = o4, o4;
      } }, r3;
    } }, {}, "/proc/self/fd");
  }, createStandardStreams() {
    o3.stdin ? Fe.createDevice("/dev", "stdin", o3.stdin) : Fe.symlink("/dev/tty", "/dev/stdin"), o3.stdout ? Fe.createDevice("/dev", "stdout", null, o3.stdout) : Fe.symlink("/dev/tty", "/dev/stdout"), o3.stderr ? Fe.createDevice("/dev", "stderr", null, o3.stderr) : Fe.symlink("/dev/tty1", "/dev/stderr"), Fe.open("/dev/stdin", 0), Fe.open("/dev/stdout", 1), Fe.open("/dev/stderr", 1);
  }, ensureErrnoError() {
    ...
    Fe.init.initialized = true, Fe.ensureErrnoError(), o3.stdin = e2 || o3.stdin, o3.stdout = r3 || o3.stdout, o3.stderr = t2 || o3.stderr, Fe.createStandardStreams();
  }, quit() {
    ...
    for (var o4 = r3.split("/").reverse(); o4.length; ) {
      var a3 = o4.pop();
      if (a3) {
    ...
    return i3;
  }, createFile(e2, r3, t2, n3, o4) {
    var a3 = ie.join2("string" == typeof e2 ? e2 : Fe.getPath(e2), r3), i3 = xe(n3, o4);
    return Fe.create(a3, i3);
  }, createDataFile(e2, r3, t2, n3, o4, a3) {
    var i3 = r3;
    e2 && (e2 = "string" == typeof e2 ? e2 : Fe.getPath(e2), i3 = r3 ? ie.join2(e2, r3) : e2);
    var s2 = xe(n3, o4), u2 = Fe.create(i3, s2);
    if (t2) {
      if ("string" == typeof t2) {
    ...
    var o4 = ie.join2("string" == typeof e2 ? e2 : Fe.getPath(e2), r3), a3 = xe(!!t2, !!n3);
    ...
    }, write(e3, r4, t3, o5, a4) {
      for (var i4 = 0; i4 < o5; i4++)
        try {
          n3(r4[t3 + i4]);
        } catch (s2) {
          throw new Fe.ErrnoError(29);
        }
      return o5 && (e3.node.timestamp = Date.now()), i4;
    } }), Fe.mkdev(o4, a3, i3);
  }, forceLoadFile(e2) {
  ...
  }, createLazyFile(e2, r3, t2, n3, o4) {
    function a3() {
      this.lengthKnown = false, this.chunks = [];
    }
    if (a3.prototype.get = function(e3) {
      if (!(e3 > this.length - 1 || e3 < 0)) {
        var r4 = e3 % this.chunkSize, t3 = e3 / this.chunkSize | 0;
        return this.getter(t3)[r4];
      }
    }, a3.prototype.setDataGetter = function(e3) {
      this.getter = e3;
    }, a3.prototype.cacheLength = function() {
      var e3 = new XMLHttpRequest();
      if (e3.open("HEAD", t2, false), e3.send(null), !(e3.status >= 200 && e3.status < 300 || 304 === e3.status))
        throw new Error("Couldn't load " + t2 + ". Status: " + e3.status);
      var r4, n4 = Number(e3.getResponseHeader("Content-length")), o5 = (r4 = e3.getResponseHeader("Accept-Ranges")) && "bytes" === r4, a4 = (r4 = e3.getResponseHeader("Content-Encoding")) && "gzip" === r4, i4 = 1048576;
      o5 || (i4 = n4);
      var s3 = (e4, r5) => {
        if (e4 > r5)
        ...
        if (o6.open("GET", t2, false), n4 !== i4 && o6.setRequestHeader("Range", "bytes=" + e4 + "-" + r5), o6.responseType = "arraybuffer", o6.overrideMimeType && o6.overrideMimeType("text/plain; charset=x-user-defined"), o6.send(null), !(o6.status >= 200 && o6.status < 300 || 304 === o6.status))
          throw new Error("Couldn't load " + t2 + ". Status: " + o6.status);
        return void 0 !== o6.response ? new Uint8Array(o6.response || []) : me(o6.responseText || "", true);
      }, u3 = this;
      u3.setDataGetter((e4) => {
        var r5 = e4 * i4, t3 = (e4 + 1) * i4 - 1;
        if (t3 = Math.min(t3, n4 - 1), void 0 === u3.chunks[e4] && (u3.chunks[e4] = s3(r5, t3)), void 0 === u3.chunks[e4])
          throw new Error("doXHR failed!");
        return u3.chunks[e4];
      }), !a4 && n4 || (i4 = n4 = 1, n4 = this.getter(0).length, i4 = n4, h("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n4, this._chunkSize = i4, this.lengthKnown = true;
    }, "undefined" != typeof XMLHttpRequest)
      throw "Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc";
    var i3 = { isDevice: false, url: t2 }, s2 = Fe.createFile(e2, r3, i3, n3, o4);
    ...
    var u2 = {};
    function l2(e3, r4, t3, n4, o5) {
      var a4 = e3.node.contents;
      if (o5 >= a4.length)
        return 0;
      var i4 = Math.min(a4.length - o5, n4);
      if (a4.slice)
        for (var s3 = 0; s3 < i4; s3++)
          r4[t3 + s3] = a4[o5 + s3];
      else
        for (s3 = 0; s3 < i4; s3++)
          r4[t3 + s3] = a4.get(o5 + s3);
      return i4;
    }
    ...
    }), u2.read = (e3, r4, t3, n4, o5) => (Fe.forceLoadFile(s2), l2(e3, r4, t3, n4, o5)), u2.mmap = (e3, r4, t3, n4, o5) => {
      Fe.forceLoadFile(s2);
      var a4 = ve();
      if (!a4)
        throw new Fe.ErrnoError(48);
      return l2(e3, v, a4, r4, t3), { ptr: a4, allocated: true };
    }, s2.stream_ops = u2, s2;
    ...
    var o4 = n3.atime.getTime(), a3 = n3.mtime.getTime(), i3 = n3.ctime.getTime();
    return $ = [Math.floor(o4 / 1e3) >>> 0, (U = Math.floor(o4 / 1e3), +Math.abs(U) >= 1 ? U > 0 ? +Math.floor(U / 4294967296) >>> 0 : ~~+Math.ceil((U - +(~~U >>> 0)) / 4294967296) >>> 0 : 0)], E[t2 + 40 >> 2] = $[0], E[t2 + 44 >> 2] = $[1], _[t2 + 48 >> 2] = o4 % 1e3 * 1e3, $ = [Math.floor(a3 / 1e3) >>> 0, (U = Math.floor(a3 / 1e3), +Math.abs(U) >= 1 ? U > 0 ? +Math.floor(U / 4294967296) >>> 0 : ~~+Math.ceil((U - +(~~U >>> 0)) / 4294967296) >>> 0 : 0)], E[t2 + 56 >> 2] = $[0], E[t2 + 60 >> 2] = $[1], _[t2 + 64 >> 2] = a3 % 1e3 * 1e3, $ = [Math.floor(i3 / 1e3) >>> 0, (U = Math.floor(i3 / 1e3), +Math.abs(U) >= 1 ? U > 0 ? +Math.floor(U / 4294967296) >>> 0 : ~~+Math.ceil((U - +(~~U >>> 0)) / 4294967296) >>> 0 : 0)], E[t2 + 72 >> 2] = $[0], E[t2 + 76 >> 2] = $[1], _[t2 + 80 >> 2] = i3 % 1e3 * 1e3, $ = [n3.ino >>> 0, (U = n3.ino, +Math.abs(U) >= 1 ? U > 0 ? +Math.floor(U / 4294967296) >>> 0 : ~~+Math.ceil((U - +(~~U >>> 0)) / 4294967296) >>> 0 : 0)], E[t2 + 88 >> 2] = $[0], E[t2 + 92 >> 2] = $[1], 0;
  }, doMsync(e2, r3, t2, n3, o4) {
    if (!Fe.isFile(r3.node.mode))
      throw new Fe.ErrnoError(43);
    if (2 & n3)
      return 0;
    var a3 = g.slice(e2, e2 + t2);
    Fe.msync(r3, a3, o4, t2, n3);
  }, varargs: void 0, get() {
    ...
    try {
      ...
      switch (r3) {
        case 0:
          ...
          for (; Fe.streams[o4]; )
            o4++;
          return Fe.createStream(n3, o4).fd;
        case 1:
        case 2:
        case 6:
        case 7:
        ...
        case 5:
          return o4 = Se.getp(), y[o4 + 0 >> 1] = 2, 0;
        case 16:
        case 8:
        default:
          return -28;
      ...
      switch (r3) {
        ...
        case 21505:
          ...
          if (n3.tty.ops.ioctl_tcgets) {
            var o4 = n3.tty.ops.ioctl_tcgets(n3), a3 = Se.getp();
            E[a3 >> 2] = o4.c_iflag || 0, E[a3 + 4 >> 2] = o4.c_oflag || 0, E[a3 + 8 >> 2] = o4.c_cflag || 0, E[a3 + 12 >> 2] = o4.c_lflag || 0;
            for (var i3 = 0; i3 < 32; i3++)
              v[a3 + i3 + 17 | 0] = o4.c_cc[i3] || 0;
            return 0;
          }
          return 0;
        case 21506:
  ...
  var Be, je, Le, Re = {}, Ie = {}, Oe = {}, Ne = (e2) => {
    ...
    function n3(r4) {
      ...
      for (var o5 = 0; o5 < e2.length; ++o5)
        qe(e2[o5], n4[o5]);
    }
    e2.forEach(function(e3) {
      Oe[e3] = r3;
    });
    var o4 = new Array(r3.length), a3 = [], i3 = 0;
    r3.forEach((e3, r4) => {
      Ie.hasOwnProperty(e3) ? o4[r4] = Ie[e3] : (a3.push(e3), Re.hasOwnProperty(e3) || (Re[e3] = []), Re[e3].push(() => {
        o4[r4] = Ie[e3], ++i3 === a3.length && n3(o4);
      }));
    }), 0 === a3.length && n3(o4);
  }, He = (e2) => {
    var r3 = De[e2];
    delete De[e2];
    var t2 = r3.rawConstructor, n3 = r3.rawDestructor, o4 = r3.fields, a3 = o4.map((e3) => e3.getterReturnType).concat(o4.map((e3) => e3.setterArgumentType));
    We([e2], a3, (e3) => {
      var a4 = {};
      return o4.forEach((r4, t3) => {
        var n4 = r4.fieldName, i3 = e3[t3], s2 = r4.getter, u2 = r4.getterContext, l2 = e3[t3 + o4.length], d2 = r4.setter, c2 = r4.setterContext;
        ...
        for (var o5 in a4)
          if (!(o5 in r4))
            throw new TypeError(`Missing field: "${o5}"`);
        var i3 = t2();
        for (o5 in a4)
          a4[o5].write(i3, r4[o5]);
  ...
  var Ke = new Je(), Ze = (e2) => {
    ...
    Ke.allocated.push({ value: void 0 }, { value: null }, { value: true }, { value: false }), Ke.reserved = Ke.allocated.length, o3.count_emval_handles = er;
    ...
    o3.hasOwnProperty(e2) ? ((void 0 === t2 || void 0 !== o3[e2].overloadTable && void 0 !== o3[e2].overloadTable[t2]) && Ve(`Cannot register public name '${e2}' twice`), or(o3, e2, e2), o3.hasOwnProperty(t2) && Ve(`Cannot register multiple overloads of a function with the same number of arguments (${t2})!`), o3[e2].overloadTable[t2] = r3) : (o3[e2] = r3, void 0 !== t2 && (o3[e2].numArguments = t2));
  }, ir = (e2, r3, t2) => {
    switch (r3) {
      case 1:
        return t2 ? function(e3) {
          return this.fromWireType(v[0 | e3]);
        } : function(e3) {
          return this.fromWireType(g[0 | e3]);
        };
      case 2:
        return t2 ? function(e3) {
    ...
    r3 = $e(r3), o4.values = {}, qe(e2, { name: r3, constructor: o4, fromWireType: function(e3) {
      return this.constructor.values[e3];
    }, toWireType: (e3, r4) => r4.value, argPackAdvance: Ye, readValueFromPointer: ir(r3, t2, n3), destructorFunction: null }), ar(r3, o4);
  }, ur = 48, lr = 57, dr = (e2) => {
    if (void 0 === e2)
      return "_unknown";
  ...
  var fr = (e2) => {
    ...
    var n3 = mr(e2, "enum");
    r3 = $e(r3);
    var o4 = n3.constructor, a3 = Object.create(n3.constructor.prototype, { value: { value: t2 }, constructor: { value: cr(`${n3.name}_${r3}`, function() {
    }) } });
    o4.values[t2] = a3, o4[r3] = a3;
  }, pr = (e2, r3) => {
    switch (r3) {
      case 4:
        return function(e3) {
  ...
  function gr(e2, r3, t2, n3, o4, a3) {
    ...
    return function() {
      var t3;
      arguments.length !== c2 && Ve(`function ${e2} called with ${arguments.length} arguments, expected ${c2}`), h2.length = 0, m2.length = s2 ? 2 : 1, m2[0] = o4, s2 && (t3 = r3[1].toWireType(h2, this), m2[1] = t3);
      ...
      function i4(e3) {
        if (u2)
          ...
          for (var n4 = s2 ? 1 : 2; n4 < r3.length; n4++) {
            var o5 = 1 === n4 ? t3 : f2[n4 - 2];
            null !== r3[n4].destructorFunction && r3[n4].destructorFunction(o5);
          }
        if (d2)
  ...
  var yr, wr, Er = (e2, r3) => {
    ...
    o3.hasOwnProperty(e2) || Ne("Replacing nonexistant public symbol"), void 0 !== o3[e2].overloadTable && void 0 !== t2 ? o3[e2].overloadTable[t2] = r3 : (o3[e2] = r3, o3[e2].argCount = t2);
  }, br = (e2, r3, t2) => {
    var n3 = o3["dynCall_" + e2];
    ...
    var t2 = [], n3 = {};
    function o4(e3) {
      n3[e3] || Ie[e3] || (Oe[e3] ? Oe[e3].forEach(o4) : (t2.push(e3), n3[e3] = true));
    }
    throw r3.forEach(o4), new wr(`${e2}: ` + t2.map(fr).join([", "]));
  }, Dr = (e2) => {
    const r3 = (e2 = e2.trim()).indexOf("(");
    return -1 !== r3 ? (F(")" == e2[e2.length - 1], "Parentheses for argument names should match."), e2.substr(0, r3)) : e2;
  }, Tr = (e2, r3, t2, n3, o4, a3, i3) => {
    var s2 = Er(r3, t2);
    e2 = $e(e2), e2 = Dr(e2), o4 = Ar(n3, o4), ar(e2, function() {
      Cr(`Cannot call ${e2} due to unbound types`, s2);
    }, r3 - 1), We([], s2, function(t3) {
      var n4 = [t3[0], null].concat(t3.slice(1));
      return _r(e2, gr(e2, n4, null, o4, a3), r3 - 1), [];
    });
  }, Mr = (e2, r3, t2) => {
    switch (r3) {
      case 1:
        return t2 ? (e3) => v[0 | e3] : (e3) => g[0 | e3];
      case 2:
    ...
    qe(e2, { name: t2 = $e(t2), fromWireType: o4, argPackAdvance: Ye, readValueFromPointer: o4 }, { ignoreDuplicateRegistrations: true });
  };
  function Lr(e2) {
  ...
  var Rr = (e2, r3, t2) => fe(e2, g, r3, t2), Ir = (e2, r3) => {
    ...
    qe(e2, { name: r3, fromWireType(e3) {
      var r4, n3 = _[e3 >> 2], o4 = e3 + 4;
      if (t2)
        for (var a3 = o4, i3 = 0; i3 <= n3; ++i3) {
          var s2 = o4 + i3;
          if (i3 == n3 || 0 == g[s2]) {
            var u2 = re(a3, s2 - a3);
        ...
        var l2 = new Array(n3);
        for (i3 = 0; i3 < n3; ++i3)
          l2[i3] = String.fromCharCode(g[o4 + i3]);
        r4 = l2.join("");
      }
      return Ao(e3), r4;
    }, toWireType(e3, r4) {
      ...
      var o4 = "string" == typeof r4;
      o4 || r4 instanceof Uint8Array || r4 instanceof Uint8ClampedArray || r4 instanceof Int8Array || Ve("Cannot pass non-string to std::string"), n3 = t2 && o4 ? ce(r4) : r4.length;
    ...
    for (var t2 = e2, n3 = t2 >> 1, o4 = n3 + r3 / 2; !(n3 >= o4) && w[n3]; )
      ++n3;
    if ((t2 = n3 << 1) - e2 > 32 && Or)
    ...
    if (void 0 === t2 && (t2 = 2147483647), t2 < 2)
      return 0;
    for (var n3 = r3, o4 = (t2 -= 2) < 2 * e2.length ? t2 / 2 : e2.length, a3 = 0; a3 < o4; ++a3) {
    ...
    if (void 0 === t2 && (t2 = 2147483647), t2 < 4)
      return 0;
    for (var n3 = r3, o4 = n3 + t2 - 4, a3 = 0; a3 < e2.length; ++a3) {
      var i3 = e2.charCodeAt(a3);
      if (i3 >= 55296 && i3 <= 57343 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & e2.charCodeAt(++a3)), E[r3 >> 2] = i3, (r3 += 4) + 4 > o4)
        break;
    }
    ...
    var n3, o4, a3, i3, s2;
    t2 = $e(t2), 2 === r3 ? (n3 = Nr, o4 = Wr, i3 = Hr, a3 = () => w, s2 = 1) : 4 === r3 && (n3 = zr, o4 = Ur, i3 = $r, a3 = () => _, s2 = 2), qe(e2, { name: t2, fromWireType: (e3) => {
      for (var t3, o5 = _[e3 >> 2], i4 = a3(), u2 = e3 + 4, l2 = 0; l2 <= o5; ++l2) {
        var d2 = e3 + 4 + l2 * r3;
        if (l2 == o5 || 0 == i4[d2 >> s2]) {
          var c2 = n3(u2, d2 - u2);
      ...
      return _[u2 >> 2] = a4 >> s2, o4(n4, u2 + 4, a4 + r3), null !== e3 && e3.push(Ao, u2), u2;
    }, argPackAdvance: Ye, readValueFromPointer: Me, destructorFunction(e3) {
      Ao(e3);
    } });
  }, Gr = (e2, r3, t2, n3, o4, a3) => {
    De[e2] = { name: $e(r3), rawConstructor: Ar(t2, n3), rawDestructor: Ar(o4, a3), fields: [] };
  }, qr = (e2, r3, t2, n3, o4, a3, i3, s2, u2, l2) => {
    De[e2].fields.push({ fieldName: $e(r3), getterReturnType: t2, getter: Ar(n3, o4), getterContext: a3, setterArgumentType: i3, setter: Ar(s2, u2), setterContext: l2 });
  }, Yr = (e2, r3) => {
    ...
    do {
      ...
      e2 += 4;
      var o4 = re(r3);
      Fe.createPath("/", ie.dirname(o4), true, true), Fe.createDataFile(o4, null, v.subarray(n3, n3 + t2), true, true, true);
    } while (_[e2 >> 2]);
  }, Qr = (e2) => {
    ...
    if (e2 > t2)
      return false;
    for (var n3 = (e3, r4) => e3 + (r4 - e3 % r4) % r4, o4 = 1; o4 <= 4; o4 *= 2) {
      var a3 = r3 * (1 + 0.2 / o4);
    ...
    for (var o4 = "", a3 = 0; a3 < r3; ++a3) {
      var i3 = n3 ? E[n3 + 4 * a3 >> 2] : -1;
      o4 += re(E[t2 + 4 * a3 >> 2], i3 < 0 ? void 0 : i3);
    }
    return o4;
  }, createContext: (e2, r3) => {
    if (o3.preinitializedWebGLContext) {
      var t2 = o3.preinitializedWebGLContext;
  ...
  }, makeContextCurrent: (e2) => (ct.currentContext = ct.contexts[e2], o3.ctx = qn = ct.currentContext && ct.currentContext.GLctx, !(e2 && !qn)), getContext: (e2) => ct.contexts[e2], deleteContext: (e2) => {
    ...
    for (var o4 in ft.deferredCalls) {
      var a3 = ft.deferredCalls[o4];
    ...
    var t2 = r3 >> 2, n3 = E[t2 + 6], o4 = { alpha: !!E[t2 + 0], depth: !!E[t2 + 1], stencil: !!E[t2 + 2], antialias: !!E[t2 + 3], premultipliedAlpha: !!E[t2 + 4], preserveDrawingBuffer: !!E[t2 + 5], powerPreference: mt[n3], failIfMajorPerformanceCaveat: !!E[t2 + 7], majorVersion: E[t2 + 8], minorVersion: E[t2 + 9], enableExtensionsByDefault: E[t2 + 10], explicitSwapControl: E[t2 + 11], proxyContextToMainThread: E[t2 + 12], renderViaOffscreenBackBuffer: E[t2 + 13] }, a3 = gt(e2);
    return a3 ? o4.explicitSwapControl ? 0 : ct.createContext(a3, o4) : 0;
  }, wt = (e2) => {
    ...
    for (var t2 = 0; t2 < e2.length; ++t2)
      v[0 | r3++] = e2.charCodeAt(t2);
    v[0 | r3] = 0;
  }, Ft = (e2, r3) => {
    var t2 = 0;
    return kt().forEach((n3, o4) => {
      var a3 = r3 + t2;
      _[e2 + 4 * o4 >> 2] = a3, xt(n3, a3), t2 += n3.length + 1;
    }), 0;
  }, St = (e2, r3) => {
    var t2 = kt();
    _[e2 >> 2] = t2.length;
  ...
  function Ct(e2, r3, t2, n3) {
    try {
      var o4 = Se.getStreamFromFD(e2), a3 = Pt(o4, r3, t2);
      return _[n3 >> 2] = a3, 0;
    } catch (i3) {
  ...
  function Tt(e2, r3, t2, n3, o4) {
    var a3 = Dt(r3, t2);
    try {
      if (isNaN(a3))
        return 61;
      var i3 = Se.getStreamFromFD(e2);
      return Fe.llseek(i3, a3, n3), $ = [i3.position >>> 0, (U = i3.position, +Math.abs(U) >= 1 ? U > 0 ? +Math.floor(U / 4294967296) >>> 0 : ~~+Math.ceil((U - +(~~U >>> 0)) / 4294967296) >>> 0 : 0)], E[o4 >> 2] = $[0], E[o4 + 4 >> 2] = $[1], i3.getdents && 0 === a3 && 0 === n3 && (i3.getdents = null), 0;
    } catch (s2) {
  ...
  var Mt = (e2, r3, t2, n3) => {
    for (var o4 = 0, a3 = 0; a3 < t2; a3++) {
      ...
      if (u2 < 0)
        return -1;
      o4 += u2, void 0 !== n3 && (n3 += u2);
    }
    return o4;
  };
  function Bt(e2, r3, t2, n3) {
    try {
      var o4 = Se.getStreamFromFD(e2), a3 = Mt(o4, r3, t2);
      return _[n3 >> 2] = a3, 0;
    } catch (i3) {
      if (void 0 === Fe || "ErrnoError" !== i3.name)
        throw i3;
  ...
  var Lt = (e2, r3) => {
    ...
    qn.bindBufferRange(e2, r3, ct.buffers[t2], n3, o4);
  }, Wt = (e2, r3) => {
  ...
  var Zt = (e2, r3, t2, n3) => {
    ...
    for (var t2 = 0; t2 < e2; t2++) {
      var n3 = E[r3 + 4 * t2 >> 2], o4 = ct.buffers[n3];
      o4 && (qn.deleteBuffer(o4), o4.name = 0, ct.buffers[n3] = null, n3 == qn.currentPixelPackBufferBinding && (qn.currentPixelPackBufferBinding = 0), n3 == qn.currentPixelUnpackBufferBinding && (qn.currentPixelUnpackBufferBinding = 0));
    }
  }, on = (e2, r3) => {
    for (var t2 = 0; t2 < e2; ++t2) {
      var n3 = E[r3 + 4 * t2 >> 2], o4 = ct.framebuffers[n3];
      o4 && (qn.deleteFramebuffer(o4), o4.name = 0, ct.framebuffers[n3] = null);
    }
  }, an = (e2) => {
    if (e2) {
    ...
    for (var t2 = 0; t2 < e2; t2++) {
      var n3 = E[r3 + 4 * t2 >> 2], o4 = ct.queries[n3];
      o4 && (qn.deleteQuery(o4), ct.queries[n3] = null);
    }
  }, un = (e2) => {
    if (e2) {
    ...
    for (var t2 = 0; t2 < e2; t2++) {
      var n3 = E[r3 + 4 * t2 >> 2], o4 = ct.textures[n3];
      o4 && (qn.deleteTexture(o4), o4.name = 0, ct.textures[n3] = null);
    }
  }, dn = (e2, r3) => {
    for (var t2 = 0; t2 < e2; t2++) {
      var n3 = E[r3 + 4 * t2 >> 2];
    ...
    qn.drawElementsInstanced(e2, r3, t2, n3, o4);
  }, vn = (e2) => {
    qn.enableVertexAttribArray(e2);
  }, gn = (e2, r3, t2, n3, o4) => {
    qn.framebufferTexture2D(e2, r3, t2, ct.textures[n3], o4);
  }, yn = (e2, r3, t2, n3) => {
    for (var o4 = 0; o4 < e2; o4++) {
      var a3 = qn[t2](), i3 = a3 && ct.getNewId(n3);
      a3 ? (a3.name = i3, n3[i3] = a3) : ct.recordError(1282), E[r3 + 4 * o4 >> 2] = i3;
    }
  }, wn = (e2, r3) => {
  ...
  var Fn = (e2, r3) => {
    ...
    if (t2) {
      var n3, o4 = ct.queries[e2];
      n3 = ct.currentContext.version < 2 ? qn.disjointTimerQueryExt.getQueryObjectEXT(o4, r3) : qn.getQueryParameter(o4, r3), Fn(t2, "boolean" == typeof n3 ? n3 ? 1 : 0 : n3);
    } else
      ct.recordError(1281);
  }, Cn = (e2, r3, t2) => {
    if (t2) {
      var n3, o4 = ct.queries[e2], a3 = qn.disjointTimerQueryExt.getQueryObjectEXT(o4, r3);
    ...
    var r3, t2, n3 = e2.uniformLocsById, o4 = e2.uniformSizeAndIdsByName;
    if (!n3)
      for (e2.uniformLocsById = n3 = {}, e2.uniformArrayNamesById = {}, r3 = 0; r3 < qn.getProgramParameter(e2, 35718); ++r3) {
        ...
        for (e2.uniformIdCounter += s2, o4[l2] = [s2, d2], t2 = 0; t2 < s2; ++t2)
          n3[d2] = t2, e2.uniformArrayNamesById[d2++] = l2;
      }
  }, jn = (e2, r3) => {
    if (r3 = re(r3), e2 = ct.programs[e2]) {
      Bn(e2);
      var t2 = e2.uniformLocsById, n3 = 0, o4 = r3, a3 = Mn(r3);
      a3 > 0 && (n3 = Tn(r3.slice(a3 + 1)) >>> 0, o4 = r3.slice(0, a3));
      var i3 = e2.uniformSizeAndIdsByName[o4];
  ...
  var Nn = (e2) => 0 == (e2 -= 5120) ? v : 1 == e2 ? g : 2 == e2 ? y : 4 == e2 ? E : 6 == e2 ? b : 5 == e2 || 28922 == e2 || 28520 == e2 || 30779 == e2 || 30782 == e2 ? _ : w, Wn = (e2) => 31 - Math.clz32(e2.BYTES_PER_ELEMENT), Hn = (e2, r3, t2, n3, o4, a3, i3) => {
    if (qn.currentPixelPackBufferBinding)
      qn.readPixels(e2, r3, t2, n3, o4, a3, i3);
    else {
      var s2 = Nn(a3);
      qn.readPixels(e2, r3, t2, n3, o4, a3, s2, i3 >> Wn(s2));
    }
  }, zn = (e2, r3, t2, n3) => {
    var o4 = ct.getSource(e2, r3, t2, n3);
    qn.shaderSource(ct.shaders[e2], o4);
  }, Un = (e2, r3, t2, n3, o4, a3, i3, s2, u2, l2) => {
    if (qn.currentPixelUnpackBufferBinding)
      qn.texImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, l2);
    else if (l2) {
      var d2 = Nn(u2);
      qn.texImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, d2, l2 >> Wn(d2));
    } else
      qn.texImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, null);
  };
  function $n(e2, r3, t2) {
    qn.texParameteri(e2, r3, t2);
  }
  function Vn(e2, r3, t2, n3, o4) {
    qn.texStorage2D(e2, r3, t2, n3, o4);
  }
  var Gn, qn, Yn = (e2, r3, t2, n3, o4, a3, i3, s2, u2) => {
    if (qn.currentPixelUnpackBufferBinding)
      qn.texSubImage2D(e2, r3, t2, n3, o4, a3, i3, s2, u2);
    else if (u2) {
      var l2 = Nn(s2);
      qn.texSubImage2D(e2, r3, t2, n3, o4, a3, i3, s2, l2, u2 >> Wn(l2));
    } else
      qn.texSubImage2D(e2, r3, t2, n3, o4, a3, i3, s2, null);
  }, Xn = (e2, r3, t2, n3, o4, a3, i3, s2, u2, l2, d2) => {
    if (qn.currentPixelUnpackBufferBinding)
      qn.texSubImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, l2, d2);
    else if (d2) {
      var c2 = Nn(l2);
      qn.texSubImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, l2, c2, d2 >> Wn(c2));
    } else
      qn.texSubImage3D(e2, r3, t2, n3, o4, a3, i3, s2, u2, l2, null);
  }, Qn = (e2) => {
    ...
    qn.vertexAttribIPointer(e2, r3, t2, n3, o4);
  }, ro = (e2, r3, t2, n3, o4, a3) => {
    qn.vertexAttribPointer(e2, r3, t2, !!n3, o4, a3);
    ...
    for (var t2 = new Date(e2.getTime()); r3 > 0; ) {
      var n3 = to(t2.getFullYear()), o4 = t2.getMonth(), a3 = (n3 ? oo : ao)[o4];
      if (!(r3 > a3 - t2.getDate()))
        return t2.setDate(t2.getDate() + r3), t2;
      r3 -= a3 - t2.getDate() + 1, t2.setDate(1), o4 < 11 ? t2.setMonth(o4 + 1) : (t2.setMonth(0), t2.setFullYear(t2.getFullYear() + 1));
    }
    return t2;
  }, so = (e2, r3) => {
    v.set(e2, r3);
  }, uo = (e2, r3, t2, n3) => {
    var o4 = _[n3 + 40 >> 2], a3 = { tm_sec: E[n3 >> 2], tm_min: E[n3 + 4 >> 2], tm_hour: E[n3 + 8 >> 2], tm_mday: E[n3 + 12 >> 2], tm_mon: E[n3 + 16 >> 2], tm_year: E[n3 + 20 >> 2], tm_wday: E[n3 + 24 >> 2], tm_yday: E[n3 + 28 >> 2], tm_isdst: E[n3 + 32 >> 2], tm_gmtoff: E[n3 + 36 >> 2], tm_zone: o4 ? re(o4) : "" }, i3 = re(t2), s2 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" };
    for (var u2 in s2)
    ...
    function p2(e3) {
      var r4 = io(new Date(e3.tm_year + 1900, 0, 1), e3.tm_yday), t3 = new Date(r4.getFullYear(), 0, 4), n4 = new Date(r4.getFullYear() + 1, 0, 4), o5 = h2(t3), a4 = h2(n4);
      return m2(o5, r4) <= 0 ? m2(a4, r4) <= 0 ? r4.getFullYear() + 1 : r4.getFullYear() : r4.getFullYear() - 1;
    }
  ...
  }, lo = (e2, r3, t2, n3, o4) => uo(e2, r3, t2, n3), co = (e2, r3) => {
    ...
    var t2 = e2.slice(0, 1), n3 = e2.slice(1), o4 = { i: 127, p: 127, j: 126, f: 125, d: 124, e: 111 };
    r3.push(96), co(n3.length, r3);
    for (var a3 = 0; a3 < n3.length; ++a3)
      r3.push(o4[n3[a3]]);
    "v" == t2 ? r3.push(0) : r3.push(1, o4[t2]);
  }, ho = (e2, r3) => {
    ...
    return new WebAssembly.Instance(o4, { e: { f: e2 } }).exports.f;
  }, po = (e2, r3) => {
    if (Gn)
  ...
  } } }), Fe.FSNode = _o, Fe.createPreloadedFile = be, Fe.staticInit(), o3.FS_createPath = Fe.createPath, o3.FS_createDataFile = Fe.createDataFile, o3.FS_createPreloadedFile = Fe.createPreloadedFile, o3.FS_unlink = Fe.unlink, o3.FS_createLazyFile = Fe.createLazyFile, o3.FS_createDevice = Fe.createDevice, Be = o3.InternalError = class extends Error {
    constructor(e2) {
      super(e2), this.name = "InternalError";
    }
  }, Ue(), Le = o3.BindingError = class extends Error {
    constructor(e2) {
      super(e2), this.name = "BindingError";
    }
  }, Qe(), rr(), wr = o3.UnboundTypeError = Pr(Error, "UnboundTypeError");
  for (var xo = 0; xo < 32; ++xo)
    fn.push(new Array(xo));
  var Fo = { X: te, m: oe, z: Ae, $: Pe, aa: Ce, ia: He, Ta: ze, ea: Xe, da: nr, F: sr, k: hr, E: vr, e: Tr, g: Br, f: jr, D: Ir, w: Vr, ja: Gr, o: qr, fa: Yr, ga: Xr, a: Ze, n: Qr, b: Zr, h: et, c: rt, d: tt, A: nt, ca: ot, ba: st, la: yt, oa: wt, ha: Et, Y: Ft, Z: St, B: At, _: Ct, Sa: Tt, C: Bt, La: jt, q: Lt, Ca: Rt, Oa: It, Ma: Ot, Na: Nt, t: Wt, i: Ht, u: zt, Va: Ut, P: $t, S: Vt, Ga: Gt, y: qt, Fa: Yt, Q: Xt, Ja: Qt, Ia: Jt, Ha: Kt, ka: Zt, L: en, Da: rn, N: tn, W: nn, T: on, Ea: an, I: sn, p: un, R: ln, K: dn, Pa: cn, Ka: mn, Qa: hn, Ra: pn, qa: vn, s: gn, Wa: wn, U: En, J: _n, xa: bn, ra: kn, sa: xn, v: An, G: Pn, ma: Cn, Ba: Dn, za: jn, O: Ln, j: Rn, H: In, x: On, r: Hn, M: zn, va: Un, l: $n, wa: Vn, ta: Yn, ua: Xn, ya: Jn, Aa: Kn, V: Zn, na: eo, pa: ro, Ua: lo }, So = J(), Ao = o3._free = (e2) => (Ao = o3._free = So._a)(e2), Po = o3._malloc = (e2) => (Po = o3._malloc = So.$a)(e2), Co = (e2) => (Co = So.ab)(e2);
  o3.__embind_initialize_bindings = () => (o3.__embind_initialize_bindings = So.bb)();
  var Do, To = () => (To = So.cb)(), Mo = (e2) => (Mo = So.db)(e2);
  function Bo() {
    function e2() {
      Do || (Do = true, o3.calledRun = true, x || (T(), r2(o3), o3.onRuntimeInitialized && o3.onRuntimeInitialized(), M()));
    }
    R > 0 || (D(), R > 0 || (o3.setStatus ? (o3.setStatus("Running..."), setTimeout(function() {
      setTimeout(function() {
        o3.setStatus("");
      }, 1), e2();
    }, 1)) : e2()));
  }
  if (o3.dynCall_iij = (e2, r3, t2, n3) => (o3.dynCall_iij = So.eb)(e2, r3, t2, n3), o3.dynCall_jiji = (e2, r3, t2, n3, a3) => (o3.dynCall_jiji = So.fb)(e2, r3, t2, n3, a3), o3.dynCall_viijii = (e2, r3, t2, n3, a3, i3, s2) => (o3.dynCall_viijii = So.gb)(e2, r3, t2, n3, a3, i3, s2), o3.dynCall_iiiiij = (e2, r3, t2, n3, a3, i3, s2) => (o3.dynCall_iiiiij = So.hb)(e2, r3, t2, n3, a3, i3, s2), o3.dynCall_iiiiijj = (e2, r3, t2, n3, a3, i3, s2, u2, l2) => (o3.dynCall_iiiiijj = So.ib)(e2, r3, t2, n3, a3, i3, s2, u2, l2), o3.dynCall_iiiiiijj = (e2, r3, t2, n3, a3, i3, s2, u2, l2, d2) => (o3.dynCall_iiiiiijj = So.jb)(e2, r3, t2, n3, a3, i3, s2, u2, l2, d2), o3.___emscripten_embedded_file_data = 139592, o3.addRunDependency = N, o3.removeRunDependency = W, o3.FS_createPath = Fe.createPath, o3.FS_createLazyFile = Fe.createLazyFile, o3.FS_createDevice = Fe.createDevice, o3.addFunction = Eo, o3.stringToUTF8 = Rr, o3.lengthBytesUTF8 = ce, o3.FS_createPreloadedFile = Fe.createPreloadedFile, o3.FS_createDataFile = Fe.createDataFile, o3.FS_unlink = Fe.unlink, I = function e2() {
    Do || Bo(), Do || (I = e2);
  }, o3.preInit)
...
//# sourceMappingURL=vxlLayer-XXXCWS2Z.js.map
