...
var Meter = class {
  constructor(hostRef) {
    ...
    this.currentPercent = void 0;
    this.effectiveLocale = void 0;
    this.highActive = void 0;
    this.highPercent = void 0;
    this.lowActive = void 0;
    this.lowPercent = void 0;
  }
  handleRangeChange() {
  ...
  renderRangeLine(position) {
    ...
    return h("div", { class: CSS.stepLine, style });
  }
  renderValueLabel() {
    ...
    }, label, unitLabel && valueLabelType !== "percent" && h("span", { class: CSS.unitLabel }, " ", unitLabel));
  }
  renderMinLabel() {
    ...
    }, labelMin, unitLabel && rangeLabelType !== "percent" && h("span", { class: CSS.unitLabel }, " ", unitLabel));
  }
  renderLowLabel() {
  ...
  render() {
    ...
    }, this.renderMeterFill(), valueLabel && this.renderValueLabel(), lowActive && this.renderRangeLine(lowPercent), highActive && this.renderRangeLine(highPercent), rangeLabels && this.renderMinLabel(), rangeLabels && lowActive && this.renderLowLabel(), rangeLabels && highActive && this.renderHighLabel(), rangeLabels && this.renderMaxLabel()));
  }
  get el() {
...
export {
  Meter as calcite_meter
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-meter.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-meter.entry-W4TJPXFJ.js.map
