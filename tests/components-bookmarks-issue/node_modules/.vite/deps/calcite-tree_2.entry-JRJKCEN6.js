...
function isTreeItem(element) {
  return (element == null ? void 0 : element.tagName) === "CALCITE-TREE-ITEM";
}
...
var treeCss = ":host{display:block}:host(:focus){outline:2px solid transparent;outline-offset:2px}:host([hidden]){display:none}[hidden]{display:none}";
var Tree = class {
  constructor(hostRef) {
    ...
    this.keyDownHandler = (event) => {
      ...
      if (event.key === "ArrowUp") {
        ...
        previousItem == null ? void 0 : previousItem.focus();
        event.preventDefault();
        return;
      }
  ...
  componentWillRender() {
    var _a;
    const parent = (_a = this.el.parentElement) == null ? void 0 : _a.closest("calcite-tree");
  ...
  render() {
    return h(Host, { "aria-multiselectable": this.child ? void 0 : (this.selectionMode === "multiple" || this.selectionMode === "multichildren").toString(), onKeyDown: this.keyDownHandler, role: !this.child ? "tree" : void 0, tabIndex: this.getRootTabIndex() }, h("slot", null));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
  ...
  onInternalTreeItemSelect(event) {
    ...
    const shouldClearCurrentSelection = !shouldModifyToCurrentSelection && ((this.selectionMode === "single" || this.selectionMode === "multiple") && childItems.length <= 0 || this.selectionMode === "children" || this.selectionMode === "multichildren");
...
var TreeItem = class {
  ...
  connectedCallback() {
    var _a;
    this.parentTreeItem = (_a = this.el.parentElement) == null ? void 0 : _a.closest("calcite-tree-item");
  ...
  componentWillRender() {
    ...
    let nextParentTree;
    while (parentTree) {
      nextParentTree = (_a = parentTree.parentElement) == null ? void 0 : _a.closest("calcite-tree");
  ...
  render() {
    ...
    return h(Host, { "aria-expanded": this.hasChildren ? toAriaBoolean(isExpanded) : void 0, "aria-hidden": toAriaBoolean(hidden), "aria-selected": this.selected ? "true" : showCheckmark ? "false" : void 0, "calcite-hydrated-hidden": hidden, role: "treeitem", tabIndex: this.disabled ? -1 : 0 }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { class: { [CSS.itemExpanded]: isExpanded } }, h("div", { class: CSS.nodeAndActionsContainer }, h("div", {
      class: {
    ...
    }, chevron, itemIndicator, this.iconStart ? iconStartEl : null, checkbox ? checkbox : defaultSlotNode), h("div", { class: CSS.actionsEnd, hidden: !hasEndActions, ref: (el) => this.actionSlotWrapper = el }, slotNode)), h("div", { class: {
      [CSS.childrenContainer]: true,
      [CSS_UTILITY.rtl]: rtl
    }, "data-test-id": "calcite-tree-children", onClick: this.childrenClickHandler, role: this.hasChildren ? "group" : void 0 }, h("slot", { name: SLOTS.children })))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
  ...
  updateAncestorTree() {
    ...
    if (this.selected) {
      ...
      const siblings = Array.from(parentTree == null ? void 0 : parentTree.children);
...
export {
  Tree as calcite_tree,
  TreeItem as calcite_tree_item
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-tree_2.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-tree_2.entry-JRJKCEN6.js.map
