...
var r = {};
var n2 = {};
Object.defineProperty(n2, "__esModule", { value: true }), n2.loop = n2.conditional = n2.parse = void 0;
var a = function e(t2, r2) {
  var n3 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a2 = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : n3;
  if (Array.isArray(r2))
    r2.forEach(function(r3) {
      return e(t2, r3, n3, a2);
    });
  else if ("function" == typeof r2)
    r2(t2, n3, a2, e);
  else {
    var i2 = Object.keys(r2)[0];
    Array.isArray(r2[i2]) ? (a2[i2] = {}, e(t2, r2[i2], n3, a2[i2])) : a2[i2] = r2[i2](t2, n3, a2, e);
  }
  return n3;
};
n2.parse = a;
var i = function(e2, t2) {
  return function(r2, n3, a2, i2) {
    t2(r2, n3, a2) && i2(r2, e2, n3, a2);
  };
};
n2.conditional = i;
var o = function(e2, t2) {
  return function(r2, n3, a2, i2) {
    for (var o2 = [], d2 = r2.pos; t2(r2, n3, a2); ) {
      var s2 = {};
      if (i2(r2, e2, n3, s2), r2.pos === d2)
        break;
...
var y = function(e2, t2) {
  return function(r2, n3, a2) {
    for (var i2 = "function" == typeof t2 ? t2(r2, n3, a2) : t2, o2 = l(e2), d2 = new Array(i2), s2 = 0; s2 < i2; s2++)
      d2[s2] = o2(r2);
    return d2;
  };
};
...
var h = function(e2, t2, r2) {
  for (var n3 = 0, a2 = 0; a2 < r2; a2++)
    n3 += e2[t2 + a2] && Math.pow(2, r2 - a2 - 1);
  return n3;
};
var v = function(e2) {
  return function(t2) {
    for (var r2 = c()(t2), n3 = new Array(8), a2 = 0; a2 < 8; a2++)
      n3[7 - a2] = !!(r2 & 1 << a2);
    return Object.keys(e2).reduce(function(t3, r3) {
      var a3 = e2[r3];
      return a3.length ? t3[r3] = h(n3, a3.index, a3.length) : t3[r3] = n3[a3.index], t3;
    }, {});
  };
};
d.readBits = v, function(e2) {
  Object.defineProperty(e2, "__esModule", { value: true }), e2.default = void 0;
  var t2 = n2, r2 = d, a2 = { blocks: function(e3) {
    for (var t3 = 0, n3 = [], a3 = e3.data.length, i3 = 0, o3 = (0, r2.readByte)()(e3); o3 !== t3 && o3; o3 = (0, r2.readByte)()(e3)) {
      if (e3.pos + o3 >= a3) {
        var d2 = a3 - e3.pos;
        n3.push((0, r2.readBytes)(d2)(e3)), i3 += d2;
        break;
      }
      n3.push((0, r2.readBytes)(o3)(e3)), i3 += o3;
    }
    for (var s3 = new Uint8Array(i3), c3 = 0, u3 = 0; u3 < n3.length; u3++)
      s3.set(n3[u3], c3), c3 += n3[u3].length;
    return s3;
  ...
  }), s2 = (0, t2.conditional)({ text: [{ codes: (0, r2.readBytes)(2) }, { blockSize: (0, r2.readByte)() }, { preData: function(e3, t3, n3) {
    return (0, r2.readBytes)(n3.text.blockSize)(e3);
  } }, a2] }, function(e3) {
    var t3 = (0, r2.peekBytes)(2)(e3);
    return 33 === t3[0] && 1 === t3[1];
  }), c2 = (0, t2.conditional)({ application: [{ codes: (0, r2.readBytes)(2) }, { blockSize: (0, r2.readByte)() }, { id: function(e3, t3, n3) {
    return (0, r2.readString)(n3.blockSize)(e3);
  } }, a2] }, function(e3) {
    var t3 = (0, r2.peekBytes)(2)(e3);
...
var w = function(e2, t2) {
  for (var r2 = new Array(e2.length), n3 = e2.length / t2, a2 = function(n4, a3) {
    var i3 = e2.slice(a3 * t2, (a3 + 1) * t2);
    r2.splice.apply(r2, [n4 * t2, t2].concat(i3));
  }, i2 = [0, 4, 2, 1], o2 = [8, 8, 4, 2], d2 = 0, s2 = 0; s2 < 4; s2++)
    for (var c2 = i2[s2]; c2 < n3; c2 += o2[s2])
      a2(c2, d2), d2++;
  return r2;
};
m.deinterlace = w;
...
var B = function(e2, t2, r2) {
  var n3, a2, i2, o2, d2, s2, c2, u2, l2, f2, p2, g2, y2, h2, v2, m2, w2 = 4096, x2 = -1, B2 = r2, b2 = new Array(r2), k2 = new Array(w2), A2 = new Array(w2), U2 = new Array(w2 + 1);
  for (d2 = (a2 = 1 << (f2 = e2)) + 1, n3 = a2 + 2, c2 = x2, i2 = (1 << (o2 = f2 + 1)) - 1, u2 = 0; u2 < a2; u2++)
    k2[u2] = 0, A2[u2] = u2;
  for (p2 = g2 = y2 = h2 = v2 = m2 = 0, l2 = 0; l2 < B2; ) {
    if (0 === h2) {
      ...
      if (u2 = p2 & i2, p2 >>= o2, g2 -= o2, u2 > n3 || u2 == d2)
        break;
      if (u2 == a2) {
        i2 = (1 << (o2 = f2 + 1)) - 1, n3 = a2 + 2, c2 = x2;
        continue;
      }
      if (c2 == x2) {
      ...
      for (s2 = u2, u2 == n3 && (U2[h2++] = y2, u2 = c2); u2 > a2; )
        U2[h2++] = A2[u2], u2 = k2[u2];
      y2 = 255 & A2[u2], U2[h2++] = y2, n3 < w2 && (k2[n3] = c2, A2[n3] = y2, !(++n3 & i2) && n3 < w2 && (o2++, i2 += n3)), c2 = s2;
    }
    h2--, b2[v2++] = U2[h2], l2++;
  }
  for (l2 = v2; l2 < B2; l2++)
...
var b = t.decompressFrames = t.decompressFrame = C = t.parseGIF = void 0;
var k = I(r);
var A = n2;
var U = d;
var S = m;
...
var C = t.parseGIF = _;
var j = function(e2) {
  for (var t2 = e2.pixels.length, r2 = new Uint8ClampedArray(4 * t2), n3 = 0; n3 < t2; n3++) {
    var a2 = 4 * n3, i2 = e2.pixels[n3], o2 = e2.colorTable[i2] || [0, 0, 0];
...
var M = function(e2, t2, r2) {
  if (e2.image) {
    var n3 = e2.image, a2 = n3.descriptor.width * n3.descriptor.height, i2 = (0, z.lzw)(n3.data.minCodeSize, n3.data.blocks, a2);
    n3.descriptor.lct.interlaced && (i2 = (0, S.deinterlace)(i2, n3.descriptor.width));
    ...
    return n3.descriptor.lct && n3.descriptor.lct.exists ? o2.colorTable = n3.lct : o2.colorTable = t2, e2.gce && (o2.delay = 10 * (e2.gce.delay || 10), o2.disposalType = e2.gce.extras.disposal, e2.gce.extras.transparentColorGiven && (o2.transparentIndex = e2.gce.transparentColorIndex)), r2 && (o2.patch = j(o2)), o2;
  }
...
var T;
function P(e2, t2) {
  return D ?? (D = document.createElement("canvas")), D.width = e2, D.height = t2, D.getContext("2d", { willReadFrequently: true });
}
async function G(t2, r2) {
  const n3 = C(t2), a2 = b(n3, true), { width: i2, height: o2 } = n3.lsd, d2 = P(i2, o2), s2 = [], c2 = [];
  let u2 = 0;
  for (const l2 of a2) {
    const t3 = n(l2.delay || 100);
    c2.push(t3), u2 += t3;
    const r3 = R(new ImageData(l2.patch, l2.dims.width, l2.dims.height)), n4 = 3 === l2.disposalType ? d2.getImageData(l2.dims.left, l2.dims.top, l2.dims.width, l2.dims.height) : void 0;
    d2.drawImage(r3, l2.dims.left, l2.dims.top);
    const a3 = d2.getImageData(0, 0, i2, o2);
    s2.push(a3), 1 === l2.disposalType || (2 === l2.disposalType ? d2.clearRect(l2.dims.left, l2.dims.top, l2.dims.width, l2.dims.height) : 3 === l2.disposalType && d2.putImageData(n4, l2.dims.left, l2.dims.top));
  }
  return { frameCount: a2.length, duration: u2, frameDurations: c2, getFrame: (e2) => s2[e2], width: i2, height: o2 };
}
function R(e2) {
  return O ?? (O = document.createElement("canvas")), T ?? (T = O.getContext("2d", { willReadFrequently: true })), O.width = e2.width, O.height = e2.height, T.putImageData(e2, 0, 0), O;
}
...
function V(e2) {
  ...
  let n3 = 13 + (128 & r2 ? 3 * 2 ** (1 + (7 & r2)) : 0), a2 = 0, i2 = false;
  for (; !i2; ) {
    switch (t2.getUint8(n3++)) {
      case 33:
        if (!o2())
          return false;
        break;
  ...
  function d2() {
    a2++, n3 += 8;
    const e3 = t2.getUint8(n3++);
    n3 += 128 & e3 ? 3 * 2 ** (1 + (7 & e3)) : 0, n3++, f2();
  }
  function s2() {
    n3++, n3 += 4, f2();
  }
...
//# sourceMappingURL=gif-XQJ36LWC.js.map
