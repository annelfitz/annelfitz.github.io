...
e2 = i, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, a = function(n) {
  ...
  function $(n2, t, e4) {
    var r2 = t + e4;
    for (e4 = t; n2[e4] && !(e4 >= r2); )
      ++e4;
    if (16 < e4 - t && n2.buffer && P)
      return P.decode(n2.subarray(t, e4));
    for (r2 = ""; t < e4; ) {
      var a3 = n2[t++];
      if (128 & a3) {
        var i3 = 63 & n2[t++];
        if (192 == (224 & a3))
          r2 += String.fromCharCode((31 & a3) << 6 | i3);
        else {
          var o4 = 63 & n2[t++];
  ...
  function E() {
    var n2 = h.buffer;
    d = n2, e3.HEAP8 = p = new Int8Array(n2), e3.HEAP16 = m = new Int16Array(n2), e3.HEAP32 = g = new Int32Array(n2), e3.HEAPU8 = v = new Uint8Array(n2), e3.HEAPU16 = y = new Uint16Array(n2), e3.HEAPU32 = b = new Uint32Array(n2), e3.HEAPF32 = w = new Float32Array(n2), e3.HEAPF64 = _ = new Float64Array(n2), e3.HEAP64 = A = new BigInt64Array(n2), e3.HEAPU64 = T = new BigUint64Array(n2);
  }
  var j, O = [], S = [], F = [];
  function D() {
  ...
  function mn(n2, t, e4) {
    return t === e4 ? n2 : void 0 === e4.la || null === (n2 = mn(n2, t, e4.la)) ? null : e4.Ka(n2);
  }
  var yn = {}, gn = [];
  function bn() {
    for (; gn.length; ) {
  ...
  function $n(n2, t, e4) {
    if (void 0 === n2[t].ha) {
      var r2 = n2[t];
      n2[t] = function() {
        return n2[t].ha.hasOwnProperty(arguments.length) || cn("Function '" + e4 + "' called with an invalid number of arguments (" + arguments.length + ") - expects one of (" + n2[t].ha + ")!"), n2[t].ha[arguments.length].apply(this, arguments);
      }, n2[t].ha = [], n2[t].ha[r2.sa] = r2;
    }
  }
  function kn(n2, t, r2) {
    e3.hasOwnProperty(n2) ? ((void 0 === r2 || void 0 !== e3[n2].ha && void 0 !== e3[n2].ha[r2]) && cn("Cannot register public name '" + n2 + "' twice"), $n(e3, n2, n2), e3.hasOwnProperty(r2) && cn("Cannot register multiple overloads of a function with the same number of arguments (" + r2 + ")!"), e3[n2].ha[r2] = t) : (e3[n2] = t, void 0 !== r2 && (e3[n2].kb = r2));
  }
  function Wn(n2, t, e4, r2, a3, i3, o4, u3) {
    this.name = n2, this.constructor = t, this.oa = e4, this.na = r2, this.la = a3, this.Pa = i3, this.va = o4, this.Ka = u3, this.$a = [];
  }
  function En(n2, t, e4) {
    for (; t !== e4; )
      t.va || cn("Expected null or instance of " + e4.name + ", got an instance of " + t.name), n2 = t.va(n2), t = t.la;
    return n2;
  }
  function jn(n2, t) {
  ...
  function On(n2, t) {
    if (null === t) {
      if (this.Aa && cn("null is not a valid " + this.name), this.xa) {
        var e4 = this.Ba();
        return null !== n2 && n2.push(this.na, e4), e4;
      }
      return 0;
    }
    if (t.da || cn('Cannot pass "' + rn(t) + '" as a ' + this.name), t.da.fa || cn("Cannot pass deleted object as a pointer of type " + this.name), !this.wa && t.da.ga.wa && cn("Cannot convert argument of type " + (t.da.ka ? t.da.ka.name : t.da.ga.name) + " to parameter type " + this.name), e4 = En(t.da.fa, t.da.ga.ea, this.ea), this.xa)
      switch (void 0 === t.da.ia && cn("Passing raw pointer to smart pointer is illegal"), this.fb) {
        case 0:
          t.da.ka === this ? e4 = t.da.ia : cn("Cannot convert argument of type " + (t.da.ka ? t.da.ka.name : t.da.ga.name) + " to parameter type " + this.name);
          break;
        case 1:
          e4 = t.da.ia;
          break;
        case 2:
          if (t.da.ka === this)
            ...
            var r2 = t.clone();
            e4 = this.ab(e4, Ln(function() {
              r2.delete();
            })), null !== n2 && n2.push(this.na, e4);
          }
          break;
        default:
  ...
  function Fn(n2, t, e4, r2, a3, i3, o4, u3, c2, f2, s2) {
    this.name = n2, this.ea = t, this.Aa = e4, this.wa = r2, this.xa = a3, this.Za = i3, this.fb = o4, this.Ga = u3, this.Ba = c2, this.ab = f2, this.na = s2, a3 || void 0 !== t.la ? this.toWireType = On : (this.toWireType = r2 ? jn : Sn, this.ja = null);
  }
  function Dn(n2, t, r2) {
    e3.hasOwnProperty(n2) || tn("Replacing nonexistant public symbol"), void 0 !== e3[n2].ha && void 0 !== r2 ? e3[n2].ha[r2] = t : (e3[n2] = t, e3[n2].sa = r2);
  }
  var Mn = [];
  function Un(n2, t) {
    n2 = on(n2);
  ...
  function xn(n2, t) {
    function e4(n3) {
      a3[n3] || J[n3] || (X[n3] ? X[n3].forEach(e4) : (r2.push(n3), a3[n3] = true));
    }
    var r2 = [], a3 = {};
  ...
  function Hn(n2, t, e4, r2, a3) {
    ...
    for (e4 = 1; e4 < t.length; ++e4)
      if (null !== t[e4] && void 0 === t[e4].ja) {
        u3 = true;
        break;
      }
    ...
    return function() {
      ...
      for (var i4 = 0; i4 < f2; ++i4)
        s2[i4] = t[i4 + 2].toWireType(h2, arguments[i4]), l2.push(s2[i4]);
      if (i4 = r2.apply(null, l2), u3)
        N(h2);
      else
        for (var d2 = o4 ? 1 : 2; d2 < t.length; d2++) {
          var p2 = 1 === d2 ? e5 : s2[d2 - 2];
  ...
  function Yn(n2, t) {
    for (var e4 = [], r2 = 0; r2 < n2; r2++)
      e4.push(b[t + 4 * r2 >> 2]);
    return e4;
  }
  function Vn(n2, t, e4) {
    return n2 instanceof Object || cn(e4 + ' with invalid "this": ' + n2), n2 instanceof t.ea.constructor || cn(e4 + ' incompatible with "this" of type ' + n2.constructor.name), n2.da.fa || cn("cannot call emscripten binding method " + e4 + " on deleted object"), En(n2.da.fa, n2.da.ga.ea, t.ea);
  }
  ...
  function Gn(n2, t, e4) {
    switch (t) {
      case 0:
        return function(n3) {
          return this.fromWireType((e4 ? p : v)[n3]);
        };
      case 1:
        return function(n3) {
          return this.fromWireType((e4 ? m : y)[n3 >> 1]);
        };
      case 2:
        return function(n3) {
          return this.fromWireType((e4 ? g : b)[n3 >> 2]);
        };
      default:
        throw new TypeError("Unknown integer type: " + n2);
    }
  ...
  function Kn(n2, t) {
    for (var e4 = n2 >> 1, r2 = e4 + t / 2; !(e4 >= r2) && y[e4]; )
      ++e4;
    if (32 < (e4 <<= 1) - n2 && Zn)
      return Zn.decode(v.subarray(n2, e4));
  ...
  function et(n2, t, e4) {
    ...
    for (var a3 = 0; a3 < n2.length; ++a3) {
      var i3 = n2.charCodeAt(a3);
      if (55296 <= i3 && 57343 >= i3 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & n2.charCodeAt(++a3)), g[t >> 2] = i3, (t += 4) + 4 > e4)
        break;
    }
    return g[t >> 2] = 0, t - r2;
  }
  ...
  function at(n2, t) {
    for (var e4 = Array(n2), r2 = 0; r2 < n2; ++r2)
      e4[r2] = Jn(b[t + 4 * r2 >> 2], "parameter " + r2);
    return e4;
  }
  var it = {};
  function ot(n2) {
  ...
  function bt(n2, t, e4, r2) {
    ...
    function c2(n3) {
      ...
      for (n3 = new Date(new Date(n3.ra + 1900, 0, 1).getTime()); 0 < t2; ) {
        var e5 = n3.getMonth(), r3 = (vt(n3.getFullYear()) ? mt : yt)[e5];
        if (!(t2 > r3 - n3.getDate())) {
    ...
    var f2 = g[r2 + 40 >> 2];
    for (var s2 in r2 = { ib: g[r2 >> 2], hb: g[r2 + 4 >> 2], ya: g[r2 + 8 >> 2], Da: g[r2 + 12 >> 2], za: g[r2 + 16 >> 2], ra: g[r2 + 20 >> 2], ma: g[r2 + 24 >> 2], qa: g[r2 + 28 >> 2], lb: g[r2 + 32 >> 2], gb: g[r2 + 36 >> 2], jb: f2 && f2 ? $(v, f2) : "" }, e4 = e4 ? $(v, e4) : "", f2 = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" })
    ...
    for (s2 in f2 = { "%a": function(n3) {
      ...
      return 0 == (n3 = n3.ya) ? n3 = 12 : 12 < n3 && (n3 -= 12), i3(n3, 2);
    }, "%j": function(n3) {
      for (var t2 = 0, e5 = 0; e5 <= n3.za - 1; t2 += (vt(n3.ra + 1900) ? mt : yt)[e5++])
        ;
      return i3(n3.Da + t2, 3);
    }, "%m": function(n3) {
      return i3(n3.za + 1, 2);
    }, "%M": function(n3) {
      return i3(n3.hb, 2);
      ...
      return i3(Math.floor((n3.qa + 7 - n3.ma) / 7), 2);
    }, "%V": function(n3) {
      var t2 = Math.floor((n3.qa + 7 - (n3.ma + 6) % 7) / 7);
      if (2 >= (n3.ma + 371 - n3.qa - 2) % 7 && t2++, t2)
        53 == t2 && (4 == (e5 = (n3.ma + 371 - n3.qa) % 7) || 3 == e5 && vt(n3.ra) || (t2 = 1));
      else {
        t2 = 52;
        var e5 = (n3.ma + 7 - n3.qa - 1) % 7;
        (4 == e5 || 5 == e5 && vt(n3.ra % 400 - 1)) && t2++;
      }
      return i3(t2, 2);
    }, "%w": function(n3) {
      return n3.ma;
    }, "%W": function(n3) {
      return i3(Math.floor((n3.qa + 7 - (n3.ma + 6) % 7) / 7), 2);
    }, "%y": function(n3) {
      ...
      e4.includes(s2) && (e4 = e4.replace(new RegExp(s2, "g"), f2[s2](r2)));
    return (s2 = gt(e4 = e4.replace(/\0\0/g, "%"))).length > t ? 0 : (p.set(s2, n2), s2.length - 1);
  }
  ...
  an = wt, un = e3.BindingError = Q("BindingError"), Pn.prototype.isAliasOf = function(n2) {
    if (!(this instanceof Pn && n2 instanceof Pn))
      return false;
    var t = this.da.ga.ea, e4 = this.da.fa, r2 = n2.da.ga.ea;
    ...
    var n2 = Cn, t = Object, e4 = t.create, r2 = Object.getPrototypeOf(this), a3 = this.da;
    return (n2 = n2(e4.call(t, r2, { da: { value: { count: a3.count, ta: a3.ta, ua: a3.ua, fa: a3.fa, ga: a3.ga, ia: a3.ia, ka: a3.ka } } }))).da.count.value += 1, n2.da.ta = false, n2;
    ...
    function t() {
      return this.xa ? _n(this.ea.oa, { ga: this.Za, fa: e4, ka: this, ia: n2 }) : _n(this.ea.oa, { ga: this, fa: n2 });
    }
    var e4 = this.Qa(n2);
    if (!e4)
      return this.Ea(n2), null;
    var r2 = Tn(this.ea, e4);
    if (void 0 !== r2)
      return 0 === r2.da.count.value ? (r2.da.fa = e4, r2.da.ia = n2, r2.clone()) : (r2 = r2.clone(), this.Ea(n2), r2);
    if (r2 = this.ea.Pa(e4), !(r2 = yn[r2]))
      return t.call(this);
    r2 = this.wa ? r2.Ha : r2.pointerType;
    var a3 = mn(e4, this.ea, r2.ea);
  ...
  var Tt = { n: function(n2) {
    ...
    throw new z(n2).Ia(t, e4), n2;
  }, u: function(n2) {
    var t = q[n2];
    delete q[n2];
    var e4 = t.Ba, r2 = t.na, a3 = t.Fa;
    en([n2], a3.map((n3) => n3.Ta).concat(a3.map((n3) => n3.cb)), (n3) => {
      var i3 = {};
      return a3.forEach((t2, e5) => {
        var r3 = n3[e5], o4 = t2.Ra, u3 = t2.Sa, c2 = n3[e5 + a3.length], f2 = t2.bb, s2 = t2.eb;
        i3[t2.Na] = { read: (n4) => r3.fromWireType(o4(u3, n4)), write: (n4, t3) => {
          var e6 = [];
        ...
        var o4 = e4();
        for (a4 in i3)
          i3[a4].write(o4, t2[a4]);
        return null !== n4 && n4.push(r2, o4), o4;
      }, argPackAdvance: 8, readValueFromPointer: L, ja: r2 }];
    });
  }, E: function(n2, t, e4, r2, a3) {
    t = on(t), e4 = ln(e4);
    var i3 = -1 != t.indexOf("u");
    i3 && (a3 = (1n << 64n) - 1n), fn(n2, { name: t, fromWireType: function(n3) {
      return n3;
    }, toWireType: function(n3, e5) {
      if ("bigint" != typeof e5 && "number" != typeof e5)
        throw new TypeError('Cannot convert "' + rn(e5) + '" to ' + this.name);
      if (e5 < r2 || e5 > a3)
        throw new TypeError('Passing a number "' + rn(e5) + '" from JS side to C/C++ side to an argument of type "' + t + '", which is outside the valid range [' + r2 + ", " + a3 + "]!");
      return e5;
    }, argPackAdvance: 8, readValueFromPointer: sn(t, e4, !i3), ja: null });
    ...
    kn(d2, function() {
      ...
      if (t2 = t2[0], r2)
        var e5 = t2.ea, a4 = e5.oa;
      else
        a4 = Pn.prototype;
      t2 = K(d2, function() {
        if (Object.getPrototypeOf(this) !== o5)
      ...
      var o5 = Object.create(a4, { constructor: { value: t2 } });
      t2.prototype = o5;
      ...
      return yn[n2] = { pointerType: a4, Ha: l3 }, Dn(d2, t2), [e5, a4, l3];
    });
  }, o: function(n2, t, e4, r2, a3, i3, o4) {
    var u3 = Yn(e4, r2);
    t = on(t), i3 = Un(a3, i3), en([], [n2], function(n3) {
      ...
      return void 0 === c2[t] ? (r3.sa = e4 - 1, c2[t] = r3) : ($n(c2, t, a4), c2[t].ha[e4 - 1] = r3), en([], u3, function(n4) {
        return n4 = Hn(a4, [n4[0], null].concat(n4.slice(1)), null, i3, o4), void 0 === c2[t].ha ? (n4.sa = e4 - 1, c2[t] = n4) : c2[t].ha[e4 - 1] = n4, [];
      }), [];
    });
    ...
    a3 = Un(r2, a3), en([], [n2], function(n3) {
      ...
      return n3.ea.pa[t - 1] = () => {
        ...
        return r3.splice(1, 0, null), n3.ea.pa[t - 1] = Hn(e5, r3, null, a3, i3), [];
      }), [];
    });
    ...
    t = on(t), i3 = Un(a3, i3), en([], [n2], function(n3) {
      ...
      return void 0 === s2 || void 0 === s2.ha && s2.className !== n3.name && s2.sa === e4 - 2 ? (r3.sa = e4 - 2, r3.className = n3.name, f2[t] = r3) : ($n(f2, t, a4), f2[t].ha[e4 - 2] = r3), en([], c2, function(r4) {
        return r4 = Hn(a4, r4, n3, i3, o4), void 0 === f2[t].ha ? (r4.sa = e4 - 2, f2[t] = r4) : f2[t].ha[e4 - 2] = r4, [];
      }), [];
    });
    ...
    t = on(t), a3 = Un(r2, a3), en([], [n2], function(n3) {
      ...
      }, Object.defineProperty(n3.ea.oa, t, s2), en([], c2 ? [e4, o4] : [e4], function(e5) {
        var o5 = e5[0], s3 = { get: function() {
  ...
  }, s: function(n2, t, e4, r2) {
    function a3() {
    }
    e4 = ln(e4), t = on(t), a3.values = {}, fn(n2, { name: t, constructor: a3, fromWireType: function(n3) {
      return this.constructor.values[n3];
    }, toWireType: function(n3, t2) {
      return t2.value;
    }, argPackAdvance: 8, readValueFromPointer: Gn(t, e4, r2), ja: null }), kn(t, a3);
  }, e: function(n2, t, e4) {
    var r2 = Jn(n2, "enum");
    t = on(t), n2 = r2.constructor, r2 = Object.create(r2.constructor.prototype, { value: { value: e4 }, constructor: { value: K(r2.name + "_" + t, function() {
    }) } }), n2.values[e4] = r2, n2[t] = r2;
  }, D: function(n2, t, e4) {
    e4 = ln(e4), fn(n2, { name: t = on(t), fromWireType: function(n3) {
      return n3;
    }, toWireType: function(n3, t2) {
      return t2;
    }, argPackAdvance: 8, readValueFromPointer: Xn(t, e4), ja: null });
  }, V: function(n2, t, e4, r2, a3, i3) {
    var o4 = Yn(t, e4);
    ...
    e4 = t.includes("unsigned") ? function(n3, t2) {
      ...
      return t2;
    }, fn(n2, { name: t, fromWireType: i3, toWireType: e4, argPackAdvance: 8, readValueFromPointer: sn(t, a3, 0 !== r2), ja: null });
  }, q: function(n2, t, e4) {
    function r2(n3) {
      var t2 = b;
    ...
    fn(n2, { name: e4 = on(e4), fromWireType: r2, argPackAdvance: 8, readValueFromPointer: r2 }, { Wa: true });
    ...
    e4 = on(e4), i3 = Un(a3, i3), u3 = Un(o4, u3), f2 = Un(c2, f2), l2 = Un(s2, l2), en([n2], [t], function(n3) {
      return n3 = n3[0], [new Fn(e4, n3.ea, false, false, true, n3, r2, i3, u3, f2, l2)];
    });
  }, F: function(n2, t) {
    ...
    fn(n2, { name: t, fromWireType: function(n3) {
      ...
      if (e4)
        for (var a3 = r2, i3 = 0; i3 <= t2; ++i3) {
          var o4 = r2 + i3;
          if (i3 == t2 || 0 == v[o4]) {
            if (a3 = a3 ? $(v, a3, o4 - a3) : "", void 0 === u3)
              var u3 = a3;
            else
        ...
        for (u3 = Array(t2), i3 = 0; i3 < t2; ++i3)
          u3[i3] = String.fromCharCode(v[r2 + i3]);
        u3 = u3.join("");
      }
      return Pt(n3), u3;
    }, toWireType: function(n3, t2) {
      ...
      if (b[i3 >> 2] = a3, e4 && r2)
        ...
        for (r2 = 0; r2 < a3; ++r2) {
          ...
          255 < u3 && (Pt(o4), cn("String has UTF-16 code units that do not fit in 8 bits")), v[o4 + r2] = u3;
        }
      else
        for (r2 = 0; r2 < a3; ++r2)
          v[o4 + r2] = t2[r2];
    ...
    if (e4 = on(e4), 2 === t)
      var r2 = Kn, a3 = Qn, i3 = nt, o4 = () => y, u3 = 1;
    else
      4 === t && (r2 = tt, a3 = et, i3 = rt, o4 = () => b, u3 = 2);
    ...
    q[n2] = { name: on(t), Ba: Un(e4, r2), na: Un(a3, i3), Fa: [] };
  }, l: function(n2, t, e4, r2, a3, i3, o4, u3, c2, f2) {
    q[n2].Fa.push({ Na: on(t), Ta: e4, Ra: Un(r2, a3), Sa: i3, cb: o4, bb: Un(u3, c2), eb: f2 });
  }, T: function(n2, t) {
    ...
    return a3 = ft((t2, a4, o4, u3) => {
      for (var c2 = 0, f2 = 0; f2 < n2 - 1; ++f2)
        i3[f2] = e4[f2 + 1].readValueFromPointer(u3 + c2), c2 += e4[f2 + 1].argPackAdvance;
      for (t2 = t2[a4].apply(t2, i3), f2 = 0; f2 < n2 - 1; ++f2)
        e4[f2 + 1].Ja && e4[f2 + 1].Ja(i3[f2]);
      if (!r2.Xa)
        return r2.toWireType(o4, t2);
    }), st[t] = a3;
  }, r: function(n2, t) {
    ...
    return ht().forEach(function(r2, a3) {
      var i3 = t + e4;
      for (a3 = b[n2 + 4 * a3 >> 2] = i3, i3 = 0; i3 < r2.length; ++i3)
        p[0 | a3++] = r2.charCodeAt(i3);
      p[0 | a3] = 0, e4 += r2.length + 1;
    }), 0;
  }, L: function(n2, t) {
    var e4 = ht();
    b[n2 >> 2] = e4.length;
  ...
  !function() {
    function n2(n3) {
      e3.asm = n3.exports, h = e3.asm.X, E(), j = e3.asm.ba, S.unshift(e3.asm.Y), U--, e3.monitorRunDependencies && e3.monitorRunDependencies(U), 0 == U && I && (n3 = I, I = null, n3());
    }
    function t(t2) {
      n2(t2.instance);
    }
    ...
    return (e3.___wasm_call_ctors = e3.asm.Y).apply(null, arguments);
  };
  var _t, Ct = e3._malloc = function() {
    return (Ct = e3._malloc = e3.asm.Z).apply(null, arguments);
  }, Pt = e3._free = function() {
    return (Pt = e3._free = e3.asm._).apply(null, arguments);
  }, $t = e3.___getTypeName = function() {
    return ($t = e3.___getTypeName = e3.asm.$).apply(null, arguments);
  };
  function kt() {
    function n2() {
      if (!_t && (_t = true, e3.calledRun = true, !C)) {
        if (B(S), a2(e3), e3.onRuntimeInitialized && e3.onRuntimeInitialized(), e3.postRun)
  ...
  if (e3.__embind_initialize_bindings = function() {
    return (e3.__embind_initialize_bindings = e3.asm.aa).apply(null, arguments);
  }, e3.___cxa_is_pointer_type = function() {
    return (e3.___cxa_is_pointer_type = e3.asm.ca).apply(null, arguments);
  }, I = function n2() {
    _t || kt(), _t || (I = n2);
  }, e3.preInit)
...
var o2 = o(i.exports);
var u = Object.freeze(Object.defineProperty({ __proto__: null, default: o2 }, Symbol.toStringTag, { value: "Module" }));
export {
  u as a
};
//# sourceMappingURL=arcgis-knowledge-client-core-simd-ERLGMP4I.js.map
