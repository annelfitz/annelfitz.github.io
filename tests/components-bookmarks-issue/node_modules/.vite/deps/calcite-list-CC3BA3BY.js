  ...
  component.sortable = Sortable.create(component.el, {
    ...
    ...!!group && {
      group: {
        name: group,
        ...!!component.canPull && {
          pull: (to, from, dragEl2, { newIndex: newIndex2, oldIndex: oldIndex2 }) => component.canPull({ toEl: to.el, fromEl: from.el, dragEl: dragEl2, newIndex: newIndex2, oldIndex: oldIndex2 })
        },
        ...!!component.canPut && {
          put: (to, from, dragEl2, { newIndex: newIndex2, oldIndex: oldIndex2 }) => component.canPut({ toEl: to.el, fromEl: from.el, dragEl: dragEl2, newIndex: newIndex2, oldIndex: oldIndex2 })
        }
      }
    },
    handle,
    filter: "[drag-disabled]",
    onStart: ({ from: fromEl, item: dragEl2, to: toEl, newIndex: newIndex2, oldIndex: oldIndex2 }) => {
      dragState.active = true;
      onGlobalDragStart();
      component.onDragStart({ fromEl, dragEl: dragEl2, toEl, newIndex: newIndex2, oldIndex: oldIndex2 });
    },
    onEnd: ({ from: fromEl, item: dragEl2, to: toEl, newIndex: newIndex2, oldIndex: oldIndex2 }) => {
      dragState.active = false;
      onGlobalDragEnd();
      component.onDragEnd({ fromEl, dragEl: dragEl2, toEl, newIndex: newIndex2, oldIndex: oldIndex2 });
    },
    onSort: ({ from: fromEl, item: dragEl2, to: toEl, newIndex: newIndex2, oldIndex: oldIndex2 }) => {
...
var Stack = proxyCustomElement(class Stack2 extends H {
  ...
  renderActionsStart() {
    ...
    return h("div", { class: CSS2.actionsStart, hidden: !hasActionsStart, key: "actions-start-container" }, h("slot", { name: SLOTS.actionsStart, onSlotchange: this.handleActionsStartSlotChange }));
  }
  renderActionsEnd() {
    const { hasActionsEnd } = this;
    return h("div", { class: CSS2.actionsEnd, hidden: !hasActionsEnd, key: "actions-end-container" }, h("slot", { name: SLOTS.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }));
  }
  renderContentStart() {
    const { hasContentStart } = this;
    return h("div", { class: CSS2.contentStart, hidden: !hasContentStart }, h("slot", { name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }));
  }
  renderDefaultContent() {
    return h("div", { class: CSS2.content }, h("slot", null));
  }
  renderContentEnd() {
    const { hasContentEnd } = this;
    return h("div", { class: CSS2.contentEnd, hidden: !hasContentEnd }, h("slot", { name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }));
  }
  render() {
    return h(Host, null, h("div", { class: CSS2.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd()));
  }
  static get style() {
    return stackCss;
  }
...
var Filter = proxyCustomElement(class Filter2 extends H {
  ...
  render() {
    ...
    return h(InteractiveContainer, { disabled }, h("div", { class: CSS3.container }, h("label", null, h("calcite-input", {
      clearable: true,
      disabled,
      icon: ICONS.search,
...
var List = proxyCustomElement(class List2 extends H {
  constructor() {
    ...
    this.updateListItems = debounce((emit = false) => {
      ...
      if (!!this.parentListEl) {
        const items2 = this.queryListItems(true);
        items2.forEach((item) => {
    ...
    this.findAncestorOfFirstFilteredItem = (filteredItems) => {
      var _a, _b;
      (_a = this.ancestorOfFirstFilteredItem) == null ? void 0 : _a.removeAttribute("data-filter");
      ...
      (_b = this.ancestorOfFirstFilteredItem) == null ? void 0 : _b.setAttribute("data-filter", "0");
    };
  ...
  async setFocus() {
    ...
    await componentFocusable(this);
    if (this.filterEnabled) {
      return (_a = this.filterEl) == null ? void 0 : _a.setFocus();
    }
    return (_b = this.focusableItems.find((listItem) => listItem.active)) == null ? void 0 : _b.setFocus();
  }
  // --------------------------------------------------------------------------
  //
  //  Render Methods
  ...
  render() {
    ...
    return h(InteractiveContainer, { disabled: this.disabled }, h("div", { class: CSS4.container }, this.dragEnabled ? h("span", { "aria-live": "assertive", class: CSS4.assistiveText }, this.assistiveText) : null, this.renderItemAriaLive(), loading ? h("calcite-scrim", { class: CSS4.scrim, loading }) : null, h("table", { "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS4.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? h("thead", null, h("tr", { class: { [CSS4.sticky]: true } }, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS4.stack }, h("slot", { name: SLOTS2.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS.actionsStart }), h("calcite-filter", {
    ...
    }), h("slot", { name: SLOTS2.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS.actionsEnd }))))) : null, h("tbody", { class: CSS4.tableContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange }))), h("div", { "aria-live": "polite", "data-test-id": "no-results-container", hidden: !(hasFilterNoResults && filterEnabled && filterText && !filteredItems.length) }, h("slot", { name: SLOTS2.filterNoResults, onSlotchange: this.handleFilterNoResultsSlotChange }))));
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
  ...
  renderItemAriaLive() {
    ...
    return !parentListEl ? h("div", { "aria-live": "polite", class: CSS4.assistiveText }, filterEnabled && filterText && (filteredData == null ? void 0 : filteredData.length) ? h("div", { key: "aria-filter-enabled" }, messages.filterEnabled) : null, h("div", { key: "aria-item-count" }, messages.total.replace("{count}", numberStringFormatter.localize(filteredItems.length.toString()))), filteredItems.length ? h("ol", { key: "aria-item-list" }, filteredItems.map((item) => h("li", null, item.label))) : null) : null;
  }
  connectObserver() {
    var _a;
  ...
  setParentList() {
    var _a;
    this.parentListEl = (_a = this.el.parentElement) == null ? void 0 : _a.closest("calcite-list");
  }
  ...
  handleNudgeEvent(event) {
    ...
    const handle = composedPath.find((el) => (el == null ? void 0 : el.tagName) && el.matches(handleSelector));
    const dragEl2 = composedPath.find((el) => (el == null ? void 0 : el.tagName) && el.matches(dragSelector));
    const parentEl2 = dragEl2 == null ? void 0 : dragEl2.parentElement;
    if (!parentEl2) {
      return;
    }
    const { filteredItems } = this;
    const sameParentItems = filteredItems.filter((item) => item.parentElement === parentEl2);
    const lastIndex = sameParentItems.length - 1;
    const oldIndex2 = sameParentItems.indexOf(dragEl2);
    let newIndex2;
    if (direction === "up") {
      newIndex2 = oldIndex2 === 0 ? lastIndex : oldIndex2 - 1;
    } else {
      newIndex2 = oldIndex2 === lastIndex ? 0 : oldIndex2 + 1;
    }
    this.disconnectObserver();
    handle.blurUnselectDisabled = true;
    const referenceEl = direction === "up" && newIndex2 !== lastIndex || direction === "down" && newIndex2 === 0 ? sameParentItems[newIndex2] : sameParentItems[newIndex2].nextSibling;
...
@esri/calcite-components/dist/components/sortableComponent.js:
  (*!
...
@esri/calcite-components/dist/components/stack.js:
  (*!
   * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
   * See https://github.com/Esri/calcite-design-system/blob/main/LICENSE.md for details.
   * v2.6.0
...
@esri/calcite-components/dist/components/filter2.js:
  (*!
   * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
   * See https://github.com/Esri/calcite-design-system/blob/main/LICENSE.md for details.
   * v2.6.0
...
@esri/calcite-components/dist/components/calcite-list.js:
  (*!
   * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
   * See https://github.com/Esri/calcite-design-system/blob/main/LICENSE.md for details.
   * v2.6.0
   *)
*/
//# sourceMappingURL=calcite-list-CC3BA3BY.js.map
