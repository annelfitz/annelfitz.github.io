...
function h(t) {
  if (null != t && !g(t)) {
    let e2 = Number(t);
    return n2(e2) && c(t) && "" != t ? h(t.replace(/[^0-9.\-]+/g, "")) : e2;
  }
  return t;
}
function l(t) {
...
function O(t, e2, i2) {
  let s2 = b(t, e2);
  -1 !== s2 && E(t, s2), null == i2 ? t.push(e2) : j(t, i2, e2);
}
function T(t, e2) {
...
function H(t, e2) {
  ...
  for (; i2 < s2; ) {
    const a2 = i2 + s2 >> 1, n3 = e2(t[a2]);
    n3 < 0 ? i2 = a2 + 1 : 0 === n3 ? (r2 = true, i2 = a2 + 1) : s2 = a2;
  }
...
function I(t, e2) {
  ...
  for (; i2 < s2; ) {
    const a2 = i2 + s2 >> 1, n3 = e2(t[a2]);
    n3 < 0 ? i2 = a2 + 1 : 0 === n3 ? (r2 = true, s2 = a2) : s2 = a2;
  }
...
function Tt(t, e2, i2 = 1, s2 = false) {
...
function jt(t, e2 = false, i2 = false, s2 = false, r2) {
  if (s2)
  ...
  let a2 = t.toLocaleString("UTC"), n3 = t.toLocaleString("UTC", { timeZoneName: e2 ? "long" : "short" }).substr(a2.length);
  return false === i2 && (n3 = n3.replace(/ (standard|daylight|summer|winter) /i, " ")), ft(n3);
}
function Et(t) {
...
function Mt(t) {
  let e2, i2, s2, r2 = t.h, a2 = t.s, n3 = t.l;
  if (0 == a2)
    e2 = i2 = s2 = n3;
  else {
    let t2 = function(t3, e3, i3) {
      return i3 < 0 && (i3 += 1), i3 > 1 && (i3 -= 1), i3 < 1 / 6 ? t3 + 6 * (e3 - t3) * i3 : i3 < 0.5 ? e3 : i3 < 2 / 3 ? t3 + (e3 - t3) * (2 / 3 - i3) * 6 : t3;
    }, o2 = n3 < 0.5 ? n3 * (1 + a2) : n3 + a2 - n3 * a2, h2 = 2 * n3 - o2;
    e2 = t2(h2, o2, r2 + 1 / 3), i2 = t2(h2, o2, r2), s2 = t2(h2, o2, r2 - 1 / 3);
  }
  return { r: Math.round(255 * e2), g: Math.round(255 * i2), b: Math.round(255 * s2) };
}
function Bt(t) {
  let e2 = t.r / 255, i2 = t.g / 255, s2 = t.b / 255, r2 = Math.max(e2, i2, s2), a2 = Math.min(e2, i2, s2), n3 = 0, o2 = 0, h2 = (r2 + a2) / 2;
  if (r2 === a2)
    n3 = o2 = 0;
  else {
    let t2 = r2 - a2;
...
function Rt(t, e2 = { r: 255, g: 255, b: 255 }, i2 = { r: 255, g: 255, b: 255 }) {
  let s2 = e2, r2 = i2;
  return Lt(i2) && (s2 = i2, r2 = e2), Lt(t) ? r2 : s2;
}
function Ft(t, e2) {
...
var zt = class _zt {
  ...
  static fromAny(t) {
    if (c(t)) {
      if ("#" == t[0])
        return _zt.fromString(t);
      if ("rgb" == t.substr(0, 3))
        return _zt.fromCSS(t);
    } else {
      if (g(t))
        return _zt.fromHex(t);
      if (t instanceof _zt)
        return _zt.fromHex(t.hex);
    }
    throw new Error("Unknown color syntax: " + t);
  }
  static alternative(t, e2, i2) {
    const s2 = Rt({ r: t.r, g: t.g, b: t.b }, e2 ? { r: e2.r, g: e2.g, b: e2.b } : void 0, i2 ? { r: i2.r, g: i2.g, b: i2.b } : void 0);
    return this.fromRGB(s2.r, s2.g, s2.b);
  }
  static interpolate(t, e2, i2, s2 = "rgb") {
    if ("hsl" == s2) {
      const s3 = e2.toHSL(), r2 = i2.toHSL();
      return _zt.fromHSL(Xt(t, s3.h, r2.h), Xt(t, s3.s, r2.s), Xt(t, s3.l, r2.l));
    }
    return _zt.fromRGB(Xt(t, e2.r, i2.r), Xt(t, e2.g, i2.g), Xt(t, e2.b, i2.b));
  }
  static lighten(t, e2) {
    const i2 = At({ r: t.r, g: t.g, b: t.b }, e2);
    return _zt.fromRGB(i2.r, i2.g, i2.b);
  }
...
var Gt = class {
  ...
  has(t, e2, i2) {
    return -1 !== C(this._listeners, (s2) => true !== s2.once && s2.type === t && (void 0 === e2 || s2.callback === e2) && s2.context === i2);
  }
  _shouldDispatch(t) {
    if (this._disposed)
      throw new Error("EventDispatcher is disposed");
  ...
  _on(t, e2, i2, s2, r2, a2) {
    ...
    const n3 = { type: e2, callback: i2, context: s2, shouldClone: r2, dispatch: a2, killed: false, once: t, disposer: new z(() => {
      n3.killed = true, this._removeListener(n3);
    }) };
    return this._listeners.push(n3), n3;
  }
  onAll(t, e2, i2 = true) {
...
function Zt(t, i2, s2) {
  return new e(Xt(t, i2.percent, s2.percent));
}
function Jt(t, e2, i2) {
...
function ge(t, e2, i2, s2, r2) {
  let a2 = Number.MAX_VALUE, n3 = Number.MAX_VALUE, o2 = -Number.MAX_VALUE, h2 = -Number.MAX_VALUE, l2 = [];
  l2.push(_e(r2, i2)), l2.push(_e(r2, s2));
  ...
  for (let p2 = d2; p2 <= u2; p2 += 90)
    p2 >= i2 && p2 <= s2 && l2.push(_e(r2, p2));
  for (let p2 = 0; p2 < l2.length; p2++) {
    let t2 = l2[p2];
    t2.x < a2 && (a2 = t2.x), t2.y < n3 && (n3 = t2.y), t2.x > o2 && (o2 = t2.x), t2.y > h2 && (h2 = t2.y);
  }
  return { left: t + a2, top: e2 + n3, right: t + o2, bottom: e2 + h2 };
}
function _e(t, e2) {
...
function me(t) {
  const e2 = t.length;
  if (e2 > 0) {
    let i2 = t[0], s2 = i2.left, r2 = i2.top, a2 = i2.right, n3 = i2.bottom;
    if (e2 > 1)
      for (let o2 = 1; o2 < e2; o2++)
        i2 = t[o2], s2 = Math.min(i2.left, s2), a2 = Math.max(i2.right, a2), r2 = Math.min(i2.top, r2), n3 = Math.max(i2.bottom, n3);
    return { left: s2, right: a2, top: r2, bottom: n3 };
  }
...
var we = class {
  ...
  applyAnimate(t) {
    ...
    return this._eachSetting((a2, n3) => {
      if (!s2[a2]) {
        s2[a2] = true, this != i2 && (a2 in i2._settings || (i2._settings[a2] = this._entity.get(a2)));
        const o2 = this._entity.animate({ key: a2, to: n3, duration: t, easing: e2 });
        o2 && (r2[a2] = o2);
      }
    }), r2;
  }
    ...
    if (!this._disabled[t]) {
      ...
      if (void 0 !== i2)
        for (let s2 = 0, r2 = i2.length; s2 < r2; ++s2)
          e2 = i2[s2](e2, this._entity, t);
    }
    return e2;
  }
};
var Ee = class {
  constructor(t, e2, i2, s2, r2, a2, n3) {
    Object.defineProperty(this, "_animation", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_from", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_to", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_duration", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_easing", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_loops", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_interpolate", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_oldTime", { enumerable: true, configurable: true, writable: true, value: void 0 }), Object.defineProperty(this, "_time", { enumerable: true, configurable: true, writable: true, value: 0 }), Object.defineProperty(this, "_stopped", { enumerable: true, configurable: true, writable: true, value: false }), Object.defineProperty(this, "_playing", { enumerable: true, configurable: true, writable: true, value: true }), Object.defineProperty(this, "events", { enumerable: true, configurable: true, writable: true, value: new Gt() }), this._animation = t, this._from = e2, this._to = i2, this._duration = s2, this._easing = r2, this._loops = a2, this._interpolate = qt(e2, i2), this._oldTime = n3;
  }
  get to() {
    return this._to;
  }
...
var Me = class {
    ...
    if (!this.isDisposed()) {
      ...
      W(this._animatingSettings, (e3, r2) => {
        ...
        if (r2.stopped)
          ...
          s2 = true;
      }), i2 ? e2 = Qt.Playing : s2 && (e2 = Qt.Paused);
    }
    return e2;
  }
  _markDirtyKey(t) {
  ...
  animate(t) {
    const e2 = t.key, i2 = t.to, s2 = t.duration || 0, r2 = t.loops || 1, a2 = void 0 === t.from ? this.get(e2) : t.from, n3 = void 0 === t.easing ? be : t.easing;
    if (0 === s2)
      this.set(e2, i2);
    else {
      if (void 0 !== a2 && a2 !== i2) {
        this.set(e2, a2);
        const t2 = this._animatingSettings[e2] = new Ee(this, a2, i2, s2, n3, r2, this._animationTime());
        return this._startAnimation(), t2;
      }
      this.set(e2, i2);
    }
    const o2 = new Ee(this, a2, i2, s2, n3, r2, null);
    return o2.stop(), o2;
  }
  animatePrivate(t) {
    const e2 = t.key, i2 = t.to, s2 = t.duration || 0, r2 = t.loops || 1, a2 = void 0 === t.from ? this.getPrivate(e2) : t.from, n3 = void 0 === t.easing ? be : t.easing;
    if (0 === s2)
      this.setPrivate(e2, i2);
    else {
      if (void 0 !== a2 && a2 !== i2) {
        this.setPrivate(e2, a2);
        const t2 = this._animatingPrivateSettings[e2] = new Ee(this, a2, i2, s2, n3, r2, this._animationTime());
        return this._startAnimation(), t2;
      }
      this.setPrivate(e2, i2);
    }
...
var Be = class extends Me {
  ...
  _applyThemes(t = false) {
    ...
    return a2 && w(a2, (t2) => {
      ...
      a3 && s2.push(a3);
      const n3 = t2.get("themeTags");
      n3 && w(n3, (t3) => {
        r2.add(t3);
      });
    }), s2 = i2.concat(s2), this._removeTemplates(), (e2 || t) && P(this.classNames, (t2) => {
      const e3 = [];
      w(s2, (i3) => {
        w(i3, (i4) => {
...
var Ie = class {
  ...
  _apply(t) {
    const e2 = [];
    return W(this._callbacks, (i2, s2) => {
      w(s2, (s3) => {
...
var Le = class _Le {
  ...
  _apply(t, e2) {
    const i2 = [];
    return W(this._settingEvents, (e3, s2) => {
      w(s2, (s3) => {
        i2.push(t.on(e3, s3));
      });
    }), W(this._privateSettingEvents, (e3, s2) => {
      w(s2, (s3) => {
...
var Ne = class _Ne extends Gt {
  ...
  _on(t, e2, i2, s2, r2, a2) {
    const n3 = super._on(t, e2, i2, s2, r2, a2), o2 = _Ne.RENDERER_EVENTS[e2];
    return void 0 !== o2 && (n3.disposer = new Y([n3.disposer, this._onRenderer(e2, o2)])), n3;
  }
  stopParentDispatch() {
...
Object.defineProperty(Ne, "RENDERER_EVENTS", { enumerable: true, configurable: true, writable: true, value: { click: function(t) {
  ...
  if (e2.getPrivate("trustBounds")) {
    ...
    fe(t.point, s2) || (i2 = false, e2._root._renderer.removeHovering(e2._display));
  }
...
var Re = class extends Be {
  ...
  _processTemplateField() {
    ...
    if (e2) {
      ...
      if (i2) {
        ...
        s2 && (t = s2[e2], t instanceof Le || !t || (t = Le.new(t)));
      }
    }
  ...
  _changed() {
    ...
    if (this.isDirty("tooltipText") || this.isDirty("tooltipHTML") || this.isDirty("showTooltipOn")) {
      ...
      this._tooltipDp && (this._tooltipDp.dispose(), this._tooltipDp = void 0), (t2 || e2) && ("click" == s3 ? (this._tooltipDp = new Y([i2.on("click", () => {
        this.setTimeout(() => this.showTooltip(), 10);
      }), Z(document, "click", (t3) => {
        this.hideTooltip();
      })]), this._disposers.push(this._tooltipDp)) : "always" == s3 || (this._tooltipDp = new Y([i2.on("pointerover", () => {
        this.showTooltip();
      }), i2.on("pointerout", () => {
        this.hideTooltip();
    ...
    if (s2 && (t.filter = s2), this.isDirty("cursorOverStyle") && (t.cursorOverStyle = this.get("cursorOverStyle")), this.isDirty("hoverOnFocus") && (this.get("hoverOnFocus") ? this._focusDp = new Y([i2.on("focus", () => {
      this.showTooltip();
    }), i2.on("blur", () => {
      this.hideTooltip();
      ...
      this.get("interactive") && !t2.isDisposed() ? this._hoverDp = new Y([t2.on("click", (t3) => {
  ...
  dragMove(t) {
    ...
    if (e2) {
      ...
      for (; null != s2; )
        i2 += s2.get("rotation", 0), s2 = s2.parent, s2 && (r2 *= s2.get("scale", 1));
      let a2 = (t.point.x - e2.point.x) / r2, n3 = (t.point.y - e2.point.y) / r2;
      ...
      if (this._isDragging) {
        ...
        this.set("x", e3.x + a2 * pe(i2) + n3 * ue(i2)), this.set("y", e3.y + n3 * pe(i2) - a2 * ue(i2));
        const s3 = "dragged";
        o2.isEnabled(s3) && o2.dispatch(s3, { type: s3, target: this, originalEvent: t.originalEvent, point: t.point, simulated: t.simulated });
      } else if (Math.hypot(a2, n3) > 5) {
        this._isDragging = true, this._dragEvent = t, this._dragPoint = { x: this.x(), y: this.y() };
        const e3 = "dragstart";
        o2.isEnabled(e3) && o2.dispatch(e3, { type: e3, target: this, originalEvent: t.originalEvent, point: t.point, simulated: t.simulated });
      }
  ...
  _fixMinBounds(t) {
    ...
    g(s2) && (s2 > 0 ? t.right = t.left + s2 : t.left = t.right + s2), g(r2) && (r2 > 0 ? t.bottom = t.top + r2 : t.top = t.bottom + r2);
  }
  _removeParent(t) {
  ...
  showTooltip(t) {
    ...
    if ((i2 || s2) && e2) {
      ...
      const n3 = this.dataItem;
      if (n3 && e2.label._setDataItem(n3), "always" == this.get("showTooltipOn") && (t.x < 0 || t.x > this._root.width() || t.y < 0 || t.y > this._root.height()))
  ...
  _updatePosition() {
    const t = this.parent;
    let i2 = this.get("dx", 0), s2 = this.get("dy", 0), r2 = this.get("x"), a2 = this.getPrivate("x"), n3 = 0, o2 = 0;
    const h2 = this.get("position");
    r2 instanceof e && (r2 = t ? t.innerWidth() * r2.value + t.get("paddingLeft", 0) : 0), g(r2) ? n3 = r2 + i2 : null != a2 ? n3 = a2 : t && "relative" == h2 && (n3 = t.get("paddingLeft", 0) + i2);
    let l2 = this.get("y"), d2 = this.getPrivate("y");
    l2 instanceof e && (l2 = t ? t.innerHeight() * l2.value + t.get("paddingTop", 0) : 0), g(l2) ? o2 = l2 + s2 : null != d2 ? o2 = d2 : t && "relative" == h2 && (o2 = t.get("paddingTop", 0) + s2);
    const u2 = this._display;
    if (u2.x != n3 || u2.y != o2) {
      u2.invalidateBounds(), u2.x = n3, u2.y = o2;
  ...
  x() {
    ...
    return s2 ? t instanceof e ? pt(t, s2.innerWidth()) + s2.get("paddingLeft", 0) : g(t) ? t : null != i2 ? i2 : s2.get("paddingLeft", this._display.x) : this._display.x;
  }
  y() {
    ...
    let i2 = this.get("y");
    const s2 = this.parent;
    return s2 ? i2 instanceof e ? pt(i2, s2.innerHeight()) + s2.get("paddingTop", 0) : g(i2) ? i2 : null != t ? t : s2.get("paddingTop", this._display.y) : this._display.y;
  }
  _dispose() {
  ...
  width() {
    ...
    if (g(r2))
      ...
      g(t) && (a2 = t);
    return g(s2) && (a2 = Math.max(s2, a2)), g(i2) && (a2 = Math.min(i2, a2)), a2;
  }
  maxWidth() {
...
var Fe = class extends Be {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      const t = this.get("repetition", ""), e2 = this.get("width", 100), i2 = this.get("height", 100), s2 = this.get("fill"), r2 = this.get("fillOpacity", 1), a2 = this._backgroundDisplay, n3 = this._display;
      n3.clear(), a2.clear(), s2 && r2 > 0 && (a2.beginFill(s2, r2), a2.drawRect(0, 0, e2, i2), a2.endFill()), n3.angle = this.get("rotation", 0), this._draw(), this._pattern = this._root._renderer.createPattern(n3, a2, t, e2, i2);
    }
    this._clear = false;
  }
};
...
var We = class extends Fe {
  ...
  _draw() {
    ...
    const t = this._image;
    if (t) {
      const e3 = this.get("width", 100), i2 = this.get("height", 100), s2 = this.get("fit", "image");
      let r2 = 0, a2 = 0;
      "pattern" == s2 ? (r2 = e3, a2 = i2) : (r2 = t.width, a2 = t.height, "image" == s2 && (this.set("width", r2), this.set("height", a2)));
      let n3 = 0, o2 = 0;
      this.get("centered", true) && (n3 = e3 / 2 - r2 / 2, o2 = i2 / 2 - a2 / 2), this._display.image(t, r2, a2, n3, o2);
    }
...
var Ve = ["fill", "fillOpacity", "stroke", "strokeWidth", "strokeOpacity", "fillPattern", "strokePattern", "fillGradient", "strokeGradient", "strokeDasharray", "strokeDashoffset", "shadowBlur", "shadowColor", "shadowOpacity", "shadowOffsetX", "shadowOffsetY", "blur", "sepia", "invert", "brightness", "hue", "contrast", "saturate"];
var Ke = class extends Re {
  ...
  _changed() {
    if (super._changed(), this._clear) {
      ...
      const i2 = this.get("blendMode", Ue.NORMAL);
  ...
  _afterChanged() {
    if (super._afterChanged(), this._clear) {
      const t = this.get("fill"), e2 = this.get("fillGradient"), i2 = this.get("fillPattern"), s2 = this.get("fillOpacity"), r2 = this.get("stroke"), a2 = this.get("strokeGradient"), n3 = this.get("strokePattern"), o2 = this.get("shadowColor"), h2 = this.get("shadowBlur"), l2 = this.get("shadowOffsetX"), d2 = this.get("shadowOffsetY"), u2 = this.get("shadowOpacity");
      if (o2 && (h2 || l2 || d2) && this._display.shadow(o2, h2, l2, d2, u2), t && !e2 && (this._display.beginFill(t, s2), this._display.endFill()), e2) {
        if (t) {
      ...
      if (i2) {
        const t2 = i2.pattern;
        t2 && (this._display.beginFill(t2, s2), this._display.endFill(), i2 instanceof We && i2.events.once("loaded", () => {
      ...
      if (r2 || a2 || n3) {
        ...
        if (r2 && !a2 && (this._display.lineStyle(e3, r2, t2, i3), this._display.endStroke()), a2) {
          ...
          const n4 = a2.getFill(this);
          n4 && (this._display.lineStyle(e3, n4, t2, i3), this._display.endStroke());
        }
        if (n3) {
          let s3 = n3.pattern;
          s3 && (this._display.lineStyle(e3, s3, t2, i3), this._display.endStroke(), n3 instanceof We && n3.events.once("loaded", () => {
            this._clear = true, this.markDirty();
          }));
        }
      }
  ...
  updateContainer(t) {
    ...
    Ge(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        ...
        if (i3 instanceof e) {
          ...
          let n3 = t2.get("maxWidth", t2.getPrivate("maxWidth", 1 / 0));
          e2 > n3 && (s2 -= n3, r2 -= i3.value);
        } else
          g(i3) || (i3 = t2.width()), s2 -= i3 + t2.get("marginLeft", 0) + t2.get("marginRight", 0);
      }
    }), (s2 <= 0 || s2 == 1 / 0) && (s2 = 0.1), Ge(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        let i3 = t2.get("width");
        if (i3 instanceof e) {
          let e2 = s2 * i3.value / r2 - t2.get("marginLeft", 0) - t2.get("marginRight", 0), a3 = t2.get("minWidth", t2.getPrivate("minWidth", -1 / 0)), n3 = t2.get("maxWidth", t2.getPrivate("maxWidth", 1 / 0));
          e2 = Math.min(Math.max(a3, e2), n3), t2.setPrivate("width", e2);
        } else
    ...
    Ge(t, (t2) => {
      if ("relative" == t2.get("position"))
        if (t2.isVisible()) {
          let e2 = t2.adjustedLocalBounds(), i3 = t2.get("marginLeft", 0), s3 = t2.get("marginRight", 0), r3 = t2.get("maxWidth"), n3 = e2.left, o2 = e2.right;
          r3 && o2 - n3 > r3 && (o2 = n3 + r3);
          let h2 = a2 + i3 - n3;
          t2.setPrivate("x", h2), a2 = h2 + o2 + s3;
        } else
...
var $e = class extends Ye {
  updateContainer(t) {
    ...
    Ge(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        ...
        if (i3 instanceof e) {
          ...
          a3 > e2 && (s2 -= a3, r2 -= i3.value);
          let n3 = t2.get("maxHeight", t2.getPrivate("maxHeight", 1 / 0));
          e2 > n3 && (s2 -= n3, r2 -= i3.value);
        } else
          g(i3) || (i3 = t2.height()), s2 -= i3 + t2.get("marginTop", 0) + t2.get("marginBottom", 0);
      }
    }), (s2 <= 0 || s2 == 1 / 0) && (s2 = 0.1), Ge(t, (t2) => {
      if (t2.isVisible() && "relative" == t2.get("position")) {
        let i3 = t2.get("height");
        if (i3 instanceof e) {
          let e2 = s2 * i3.value / r2 - t2.get("marginTop", 0) - t2.get("marginBottom", 0), a3 = t2.get("minHeight", t2.getPrivate("minHeight", -1 / 0)), n3 = t2.get("maxHeight", t2.getPrivate("maxHeight", 1 / 0));
          e2 = Math.min(Math.max(a3, e2), n3), t2.setPrivate("height", e2);
        } else
    ...
    Ge(t, (t2) => {
      if ("relative" == t2.get("position"))
        if (t2.isVisible()) {
          let e2 = t2.adjustedLocalBounds(), i3 = t2.get("marginTop", 0), s3 = e2.top, r3 = e2.bottom, n3 = t2.get("maxHeight");
          n3 && r3 - s3 > n3 && (r3 = s3 + n3);
          let o2 = t2.get("marginBottom", 0), h2 = a2 + i3 - s3;
...
var Ze = class extends Ye {
  ...
  updateContainer(t) {
    let e2 = t.get("paddingLeft", 0), i2 = t.get("paddingRight", 0), s2 = t.get("paddingTop", 0), r2 = t.maxWidth() - e2 - i2, a2 = r2, n3 = 1;
    Ge(t, (t2) => {
      if (t2.get("visible") && t2.getPrivate("visible") && !t2.get("forceHidden") && "absolute" != t2.get("position")) {
        let e3 = t2.width();
        e3 < a2 && (a2 = e3), e3 > n3 && (n3 = e3);
      }
    }), a2 = de(a2, 1, r2), n3 = de(n3, 1, r2);
    let o2 = 1;
    o2 = this.get("fixedWidthGrid") ? r2 / n3 : r2 / a2, o2 = Math.max(1, Math.floor(o2)), o2 = Math.min(this.get("maxColumns", Number.MAX_VALUE), o2);
    let h2 = this.getColumnWidths(t, o2, n3, r2), l2 = s2, d2 = 0, u2 = 0;
    o2 = h2.length;
    let p2 = e2;
    Ge(t, (t2) => {
      if ("relative" == t2.get("position") && t2.isVisible()) {
        const i3 = t2.get("marginTop", 0), s3 = t2.get("marginBottom", 0);
        let r3 = t2.adjustedLocalBounds(), a3 = t2.get("marginLeft", 0), n4 = t2.get("marginRight", 0), c2 = p2 + a3 - r3.left, g2 = l2 + i3 - r3.top;
        t2.setPrivate("x", c2), t2.setPrivate("y", g2), p2 += h2[d2] + n4, u2 = Math.max(u2, t2.height() + i3 + s3), d2++, d2 >= o2 && (d2 = 0, p2 = e2, l2 += u2);
      }
    });
  }
  getColumnWidths(t, e2, i2, s2) {
    ...
    return Ge(t, (s3) => {
      ...
      "absolute" != s3.get("position") && s3.isVisible() && (this.get("fixedWidthGrid") ? a2[n3] = i2 : a2[n3] = Math.max(0 | a2[n3], r3.right - r3.left + s3.get("marginLeft", 0) + s3.get("marginRight", 0)), n3 < t.children.length - 1 && (n3++, n3 == e2 && (n3 = 0)));
    }), w(a2, (t2) => {
      r2 += t2;
      ...
      if ("" !== t2)
        if (a2 % 2 == 0) {
          ...
          for (let t3 = 0; t3 < e3.length; t3++) {
            ...
            r3 !== m && ("" !== r3 && (t3 % 2 == 0 ? s2.push({ type: "value", text: r3 }) : s2.push({ type: i2 ? "value" : "format", text: "[" + r3 + "]" })));
          }
        } else {
          let e3 = t2.split(/[\[\]]+/);
          for (let t3 = 0; t3 < e3.length; t3++) {
...
function qe(t, e2) {
  if (null != e2) {
    e2 = "" + e2;
    let i2, s2 = (e2 = Je.escape(e2)).match(/\{([^}]+)\}/g);
    if (s2)
      for (i2 = 0; i2 < s2.length; i2++) {
        let r2 = Qe(t, s2[i2].replace(/\{([^}]+)\}/, "$1"));
...
function Qe(t, e2, i2) {
  ...
  for (; a2 = o2.exec(e2), null !== a2; )
    if (a2[3]) {
      ...
      -1 !== e3.indexOf(a2[3]) ? n3.push({ method: "formatDate", params: [] }) : -1 !== i3.indexOf(a2[3]) ? n3.push({ method: "formatNumber", params: [] }) : -1 !== s3.indexOf(a2[3]) && n3.push({ method: "formatDuration", params: [] });
    } else {
      let t2 = [];
      if ("" != ft(a2[2])) {
        let e3, i3 = /'([^']*)'|"([^"]*)"|([0-9\-]+)/g;
      ...
      n3.push({ method: a2[1], params: t2 });
    }
  if (r2) {
    s2 = ei(t, n3, r2._settings), (null == s2 || _(s2)) && (s2 = ei(t, n3, r2));
    let i3 = r2.dataContext;
    null == s2 && i3 && (s2 = ei(t, n3, i3), null == s2 && (s2 = ei(t, [{ prop: e2 }], i3)), null == s2 && i3.dataContext && (s2 = ei(t, n3, i3.dataContext))), null == s2 && r2.component && r2.component.dataItem !== r2 && (s2 = Qe(r2.component, e2));
  }
  return null == s2 && (s2 = ei(t, n3, t)), null == s2 && t.parent && (s2 = Qe(t.parent, e2)), s2;
}
function ti(t, e2) {
  ...
  for (let o2 = 0, d2 = e2.length; o2 < d2; o2++) {
    ...
    if (d3.prop) {
      ...
      switch (d3.method) {
        case "formatNumber":
          let e3 = h(r2);
          null != e3 && (r2 = t.getNumberFormatter().format(e3, s2 || d3.params[0] || void 0), a2 = true);
          break;
        case "formatDate":
          let o3 = l(r2);
          if (!p(o3) || n2(o3.getTime()))
            return;
          null != o3 && (r2 = t.getDateFormatter().format(o3, s2 || d3.params[0] || void 0), a2 = true);
          break;
        case "formatDuration":
          let u2 = h(r2);
          null != u2 && (r2 = t.getDurationFormatter().format(u2, s2 || d3.params[0] || void 0, d3.params[1] || void 0), a2 = true);
          break;
        case "urlEncode":
...
var ii = class _ii extends Re {
  ...
  updateBackground() {
    ...
    if (e2 && !this.isHidden()) {
      let i2 = e2.left, s2 = e2.top, r2 = e2.right - i2, a2 = e2.bottom - s2, n3 = this.get("maxWidth"), o2 = this.get("maxHeight");
      o2 && a2 > o2 && (a2 = o2), n3 && r2 > n3 && (r2 = n3);
  ...
  _getBounds() {
    let t = this.get("width"), e2 = this.get("height"), i2 = this.getPrivate("width"), s2 = this.getPrivate("height"), r2 = { left: 0, top: 0, right: this.width(), bottom: this.height() }, a2 = this.get("layout"), n3 = false, o2 = false;
    if ((a2 instanceof Xe || a2 instanceof Ze) && (n3 = true), a2 instanceof $e && (o2 = true), null == t && null == i2 || null == e2 && null == s2 || this.get("verticalScrollbar")) {
      ...
      this.children.each((t3) => {
        if ("absolute" != t3.get("position") && t3.get("isMeasured")) {
          ...
          n3 && (d3 -= t3.get("marginLeft", 0), u3 += t3.get("marginRight", 0)), o2 && (p3 -= t3.get("marginTop", 0), c3 += t3.get("marginBottom", 0)), d3 < e3 && (e3 = d3), u3 > i3 && (i3 = u3), p3 < s3 && (s3 = p3), c3 > a3 && (a3 = c3);
        }
      ...
      ;
    this._contentWidth = r2.right - r2.left, this._contentHeight = r2.bottom - r2.top, g(t) && (r2.left = 0, r2.right = t), g(i2) && (r2.left = 0, r2.right = i2), g(e2) && (r2.top = 0, r2.bottom = e2), g(s2) && (r2.top = 0, r2.bottom = s2), this._localBounds = r2;
  }
  _updateBounds() {
  ...
  _prepareChildren() {
    ...
    if (t != this._prevWidth || i2 != this._prevHeight) {
      ...
      s2 && ((s2 instanceof Xe || s2 instanceof Ze) && (r2 = true), s2 instanceof $e && (a2 = true)), w(this._percentageSizeChildren, (s3) => {
        if (!r2) {
          let i3 = s3.get("width");
  ...
  walkChildren(t) {
    this.children.each((e2) => {
      e2 instanceof _ii && e2.walkChildren(t), t(e2);
    });
  }
  eachChildren(t) {
    const e2 = this.get("background");
...
var ri = class extends ii {
  ...
  _updateChildren() {
    ...
    }), this.isDirty("maxWidth") && this._setMaxDimentions(), this.isDirty("maxHeight") && this._setMaxDimentions(), this.isDirty("rotation") && this._setMaxDimentions(), "" !== this.get("html", "") ? this._text.set("text", "") : (this._text.set("text", this.get("text")), this._maybeUpdateHTMLColor()), this.isDirty("fill") && this._maybeUpdateHTMLColor(), this.isDirty("textAlign") || this.isDirty("width")) {
  ...
  _setMaxDimentions() {
    ...
    g(s2) ? this.text.set(e2 ? "maxWidth" : "maxHeight", s2 - this.get("paddingTop", 0) - this.get("paddingBottom", 0)) : this.text.set(e2 ? "maxWidth" : "maxHeight", void 0);
  }
  _setDataItem(t) {
...
var ai = class {
  ...
  ruleRaw(t, e2 = []) {
    ...
    const { index: s2, found: r2 } = H(i2, (t2) => {
...
//# sourceMappingURL=chunk-LGCEZHPO.js.map
