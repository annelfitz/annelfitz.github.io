...
var n = class extends u(N) {
  ...
  initialize() {
    this.addHandles([p(() => this.view.basemapTerrain.ready, () => this._initializeMaximumDataResolution(), { once: true, initial: true }), this.layer.on("redraw", () => this._updatingHandles.addPromise(this.redrawDebounced()))]), this._updatingHandles.add(() => {
      var _a, _b;
...
//# sourceMappingURL=ImageryLayerView3D-URBJ453Q.js.map
