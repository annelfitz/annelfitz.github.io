...
var DropdownItem = proxyCustomElement(class DropdownItem2 extends H {
  ...
  render() {
    ...
    const { disabled } = this;
    return h(Host, { "aria-checked": itemAria, "aria-label": !href ? label : "", role: itemRole, tabIndex: disabled ? -1 : 0 }, h(InteractiveContainer, { disabled }, h("div", { class: {
      [CSS.container]: true,
...
@esri/calcite-components/dist/components/calcite-dropdown-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-dropdown-item-J3TR6MXT.js.map
