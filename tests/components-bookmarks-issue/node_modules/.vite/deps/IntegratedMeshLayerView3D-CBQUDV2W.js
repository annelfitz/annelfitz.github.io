...
var d = 0.2;
var c = class extends At(n(u)) {
  constructor() {
    super(...arguments), this.type = "integrated-mesh-3d", this._elevationContext = "im", this._isIntegratedMesh = true, this._supportsLabeling = false, this._needsNormals = has("enable-feature:im-shading"), this.drapeTargetType = t2.WithoutRasterImage;
  }
  get i3slayer() {
    return this.layer;
  }
  ...
  initialize() {
    this._updatingHandles.add(() => this.layer.modifications, () => this._loadModifications(), P), this.view.basemapTerrain.overlayManager.registerDrapeTarget(this);
  }
  destroy() {
    this.view.basemapTerrain.overlayManager.unregisterDrapeTarget(this);
  }
  _createLayerGraphic() {
    return new f({ layer: this.layer, sourceLayer: this.layer });
  }
  canResume() {
  ...
  _loadModifications() {
    ...
    this.addHandles(this._updatingHandles.addOnCollectionChange(() => e2, () => this._modifications = e2.toArray(), P), "modifications");
  }
};
e([y()], c.prototype, "layer", void 0), e([y()], c.prototype, "i3slayer", null), e([y(t)], c.prototype, "updatingProgress", void 0), e([y()], c.prototype, "updatingProgressValue", null), e([y()], c.prototype, "lodFactor", null), e([y({ readOnly: true })], c.prototype, "progressiveLoadFactor", null), c = e([a("esri.views.3d.layers.IntegratedMeshLayerView3D")], c);
var m = c;
export {
  m as default
};
//# sourceMappingURL=IntegratedMeshLayerView3D-CBQUDV2W.js.map
