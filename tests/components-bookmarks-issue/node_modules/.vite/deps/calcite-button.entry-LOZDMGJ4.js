...
var Button = class {
  constructor(hostRef) {
    ...
    this.setChildEl = (el) => {
      ...
      this.childEl = el;
      if (el) {
        (_a = this.resizeObserver) == null ? void 0 : _a.observe(el);
      }
    };
  ...
  render() {
    ...
    return h(InteractiveContainer, { disabled: this.disabled }, h(Tag, {
      ...
      ref: this.setChildEl
    }, loaderNode, this.iconStart ? iconStartEl : null, this.hasContent ? contentEl : null, this.iconEnd ? iconEndEl : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
  ...
  updateHasContent() {
    ...
    this.hasContent = this.el.childNodes.length === 1 && ((_a = this.el.childNodes[0]) == null ? void 0 : _a.nodeName) === "#text" ? ((_b = this.el.textContent) == null ? void 0 : _b.trim().length) > 0 : slottedContent;
  }
...
export {
  Button as calcite_button
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-button.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-button.entry-LOZDMGJ4.js.map
