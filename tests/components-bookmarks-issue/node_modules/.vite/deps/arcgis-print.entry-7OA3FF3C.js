...
var ArcgisPrint = class {
  constructor(hostRef) {
    ...
    this.exportedLinks = void 0;
    this.extraParameters = void 0;
    this.icon = void 0;
    this.includeDefaultTemplates = true;
    this.portal = void 0;
    this.printServiceUrl = void 0;
    this.templateCustomTextElements = void 0;
    this.templateOptions = void 0;
  ...
  _createParams() {
    ...
    if (this.includeDefaultTemplates !== void 0) {
...
@arcgis/map-components/dist/esm/arcgis-print.entry.js:
   ...
   *)
*/
//# sourceMappingURL=arcgis-print.entry-7OA3FF3C.js.map
