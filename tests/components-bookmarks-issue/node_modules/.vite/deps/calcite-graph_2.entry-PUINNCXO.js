...
function range(data) {
  ...
  return data.reduce(({ min: min2, max: max2 }, [x, y]) => ({
...
var Graph = class {
  ...
  render() {
    ...
    if (!data || data.length === 0) {
      return h("svg", { "aria-hidden": "true", class: "svg", height, preserveAspectRatio: "none", viewBox: `0 0 ${width} ${height}`, width });
    }
    ...
    return h("svg", { "aria-hidden": "true", class: "svg", height, preserveAspectRatio: "none", viewBox: `0 0 ${width} ${height}`, width }, colorStops ? h("defs", null, h("linearGradient", { id: `linear-gradient-${id}`, x1: "0", x2: "1", y1: "0", y2: "0" }, colorStops.map(({ offset, color, opacity }) => h("stop", { offset: `${offset * 100}%`, "stop-color": color, "stop-opacity": opacity })))) : null, highlightMin !== void 0 ? [
      ...
      h("mask", { height: "100%", id: `${id}3`, width: "100%", x: "0%", y: "0%" }, h("path", { d: `
                ...
                Z
              `, fill: "white" })),
      h("path", { class: "graph-path", d: areaPath, fill, mask: `url(#${id}1)` }),
      h("path", { class: "graph-path--highlight", d: areaPath, fill, mask: `url(#${id}2)` }),
      h("path", { class: "graph-path", d: areaPath, fill, mask: `url(#${id}3)` })
    ] : h("path", { class: "graph-path", d: areaPath, fill }));
  }
  get el() {
...
var Slider = class {
  ...
  render() {
    ...
    return h(Host, { id, onTouchStart: this.handleTouchStart }, h(InteractiveContainer, { disabled: this.disabled }, h("div", { "aria-label": getLabelText(this), class: {
      [CSS.container]: true,
    ...
    }, h("div", { class: CSS.trackRange, onPointerDown: this.onTrackPointerDown, style: {
  ...
  async setFocus() {
    ...
    handle == null ? void 0 : handle.focus();
  }
  //--------------------------------------------------------------------------
  //
  //  Private Methods
...
export {
  Graph as calcite_graph,
  Slider as calcite_slider
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-graph_2.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-graph_2.entry-PUINNCXO.js.map
