...
var Tip = class {
  ...
  renderHeader() {
    ...
    return heading ? h("header", { class: CSS$1.header }, h(Heading, { class: CSS$1.heading, level }, heading)) : null;
  }
  renderDismissButton() {
...
var TipManager = class {
  ...
  updateGroupTitle() {
    ...
    if (this.tips) {
      ...
      this.groupTitle = (tipParent == null ? void 0 : tipParent.groupTitle) || ((_a = this.messages) == null ? void 0 : _a.defaultGroupTitle);
    }
  }
  // --------------------------------------------------------------------------
  //
  ...
  render() {
    ...
    }, h("header", { class: CSS.header }, h(Heading, { class: CSS.heading, level: headingLevel }, groupTitle), h("calcite-action", { class: CSS.close, onClick: this.hideTipManager, scale: "m", text: closeLabel }, h("calcite-icon", { icon: ICONS.close, scale: "m" }))), h("div", { class: {
...
export {
  Tip as calcite_tip,
  TipGroup as calcite_tip_group,
  TipManager as calcite_tip_manager
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-tip_3.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-tip_3.entry-VU2AHRHV.js.map
