...
var Card = class {
  ...
  renderSelectionIcon() {
    ...
    return h("div", { class: CSS.checkboxWrapper, onPointerDown: this.cardSelectClick, tabIndex: -1 }, h("calcite-icon", { icon, scale: "s" }));
  }
  renderHeader() {
    const { el } = this;
  ...
  render() {
    ...
    return h(Host, null, h(InteractiveContainer, { disabled: this.disabled }, h("div", {
      "aria-checked": this.selectionMode !== "none" ? toAriaBoolean(this.selected) : void 0,
    ...
    }, this.loading ? h("div", { "aria-live": "polite", class: "calcite-card-loader-container" }, h("calcite-loader", { label: this.messages.loading })) : null, thumbnailStart && this.renderThumbnail(), h("section", { "aria-busy": toAriaBoolean(this.loading), class: { [CSS.container]: true } }, this.renderHeader(), h("div", { class: {
...
Card.style = cardCss;
export {
  Card as calcite_card
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-card.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-card.entry-3C57M2MD.js.map
