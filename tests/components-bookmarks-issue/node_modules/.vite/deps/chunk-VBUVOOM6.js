...
function o(e2, r2, l2, a2 = 1) {
  const o2 = (e2 % 360 + 360) % 360 / 360, i2 = l2 <= 0.5 ? l2 * (r2 + 1) : l2 + r2 - l2 * r2, t = 2 * l2 - i2;
  return [Math.round(255 * n(t, i2, o2 + 1 / 3)), Math.round(255 * n(t, i2, o2)), Math.round(255 * n(t, i2, o2 - 1 / 3)), a2];
}
function i(e2) {
  ...
  const t = [0, 0, 0, 1];
  let u;
  return o2 && (u = i2 & a2, i2 >>= l2, t[3] = n2 * u / 255), u = i2 & a2, i2 >>= l2, t[2] = n2 * u, u = i2 & a2, i2 >>= l2, t[1] = n2 * u, u = i2 & a2, i2 >>= l2, t[0] = n2 * u, t;
}
...
//# sourceMappingURL=chunk-VBUVOOM6.js.map
