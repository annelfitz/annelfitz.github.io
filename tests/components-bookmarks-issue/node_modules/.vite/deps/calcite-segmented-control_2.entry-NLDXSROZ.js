...
var SegmentedControl = class {
  ...
  disconnectedCallback() {
    ...
    disconnectForm(this);
    (_a = this.mutationObserver) == null ? void 0 : _a.unobserve(this.el);
  }
  componentDidRender() {
    updateHostInteraction(this);
  }
  render() {
    return h(Host, { onClick: this.handleClick, role: "radiogroup" }, h("div", { class: CSS$1.itemWrapper }, h(InteractiveContainer, { disabled: this.disabled }, h("slot", null), h(HiddenFormInputSlot, { component: this }))), this.validationMessage && this.status === "invalid" ? h(Validation, { icon: this.validationIcon, message: this.validationMessage, scale: this.scale, status: this.status }) : null);
  }
  ...
  async setFocus() {
    ...
    (_a = this.selectedItem || this.getItems()[0]) == null ? void 0 : _a.focus();
  }
...
export {
  SegmentedControl as calcite_segmented_control,
  SegmentedControlItem as calcite_segmented_control_item
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-segmented-control_2.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-segmented-control_2.entry-NLDXSROZ.js.map
