...
var ArcgisVersionManagementVersionItem = class {
  constructor(hostRef) {
    ...
    this.strings = void 0;
    this.hasAdvEditingUte = void 0;
    this.isVersioningApiAvailable = void 0;
  ...
  render() {
    ...
    return h(Host, null, h("calcite-list-item", { description: fullVersionName.split(".")[0], label: fullVersionName.split(".")[1], value: guid }, h("calcite-action", { id: actionElementId, icon: "switch", text: "", onClick: () => {
      ...
      this.versionItemActionClickedEvent.emit({ actionType: "changeVersion", versionInfo });
    }, scale: "s", text: actions.switchToVersion, textEnabled: true }), h("calcite-action", { disabled: fullVersionName.toUpperCase() === "SDE.DEFAULT" || !this.hasAdvEditingUte || !this.isVersioningApiAvailable, icon: "edit-attributes", onClick: () => {
...
var ArcgisVersionManagementVersionList = class {
  constructor(hostRef) {
    ...
    this.strings = void 0;
    this.userHasAdvancedEditingUserTypeExtension = void 0;
    this.versionInfos = void 0;
  ...
  render() {
    ...
    return h(Host, null, h("calcite-flow-item", { heading, description: serviceName }, currentVersionIdentifier ? h("calcite-panel", { disabled: state === "executing", class: "panel-versions", heading: "Current version", description: currentVersionIdentifier.name }) : void 0, h("calcite-panel", { loading: state === "executing", class: "panel-versions", heading: versionInfos.length ? `${strings.headers.manageVersions} (${versionInfos.length})` : strings.headers.manageVersions }, h("calcite-action", { id: "actionRefreshVersions", icon: "refresh", text: "", onClick: () => {
      this.versionListActionClickedEvent.emit({
        actionType: "refreshVersions",
        serviceUrl
      });
    }, slot: "header-actions-end" }), h("calcite-tooltip", { "overlay-positioning": "fixed", referenceElement: "actionRefreshVersions" }, h("span", null, strings.actions.refreshVersions)), h("calcite-list", { class: "version-list", filterEnabled: true }, versionInfos.map((versionInfo) => h("arcgis-version-management-version-item", { strings, hasAdvEditingUte: viewModel.advancedEditingUserTypeExtensionLookup.get(serviceUrl), isVersioningApiAvailable: (viewModel.serverVersionLookup.get(serviceUrl) ?? 0) >= 11.2, versionInfo, onVersionItemActionClickedEvent: (e) => {
...
@arcgis/map-components/dist/esm/arcgis-version-management-version-item_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=arcgis-version-management-version-item_2.entry-JVUJVQMQ.js.map
