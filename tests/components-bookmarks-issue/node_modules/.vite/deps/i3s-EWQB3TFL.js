...
r = i, e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, t = function(n = {}) {
  ...
  function N(n2) {
    return l || !a2 && !u || "function" != typeof fetch ? Promise.resolve().then(() => q(n2)) : fetch(n2, { credentials: "same-origin" }).then((r3) => {
      if (!r3.ok)
  ...
  function G(n2, r3, e2, t3) {
    return n2 || "function" != typeof WebAssembly.instantiateStreaming || B(r3) || "function" != typeof fetch ? L(r3, e2, t3) : fetch(r3, { credentials: "same-origin" }).then((n3) => WebAssembly.instantiateStreaming(n3, e2).then(t3, function(n4) {
  ...
  function hn(n2) {
    ...
    vn([n2], i3.map((n3) => n3.getterReturnType).concat(i3.map((n3) => n3.setterArgumentType)), (n3) => {
      ...
      return i3.forEach((r4, e3) => {
        ...
        o4[t4] = { read: (n4) => a3.fromWireType(u2(c2, n4)), write: (n4, r5) => {
          var e4 = [];
  ...
  function jn() {
    En.allocated.push({ value: void 0 }, { value: null }, { value: true }, { value: false }), En.reserved = En.allocated.length, i2.count_emval_handles = kn;
  }
  ...
  function Un(n2, r3, e2, t3, i3, o4) {
    ...
    for (var u2 = null !== r3[1] && null !== e2, c2 = false, f2 = 1; f2 < r3.length; ++f2)
    ...
    return function() {
      ...
      for (var o5 = 0; o5 < l2; ++o5)
        d2[o5] = r3[o5 + 2].toWireType(v2, arguments[o5]), p2.push(d2[o5]);
      function a4(n3) {
        if (c2)
          rn(v2);
        else
          for (var t4 = u2 ? 1 : 2; t4 < r3.length; t4++) {
  ...
  function $n(n2, r3, e2) {
    ...
    Tn(n2, { name: e2 = wn(e2), fromWireType: i3, argPackAdvance: 8, readValueFromPointer: i3 }, { ignoreDuplicateRegistrations: true });
  }
  ...
  function nr(n2, r3, e2) {
    for (var t3 = r3 + e2, i3 = r3; n2[i3] && !(i3 >= t3); )
      ++i3;
    ...
    for (var o4 = ""; r3 < i3; ) {
      ...
      if (128 & a3) {
        ...
        if (192 != (224 & a3)) {
          var c2 = 63 & n2[r3++];
          if ((a3 = 224 == (240 & a3) ? (15 & a3) << 12 | u2 << 6 | c2 : (7 & a3) << 18 | u2 << 12 | c2 << 6 | 63 & n2[r3++]) < 65536)
          ...
          o4 += String.fromCharCode((31 & a3) << 6 | u2);
      } else
        o4 += String.fromCharCode(a3);
    }
    return o4;
  ...
  function ir(n2, r3) {
    for (var e2 = n2, t3 = e2 >> 1, i3 = t3 + r3 / 2; !(t3 >= i3) && y[t3]; )
      ++t3;
    if ((e2 = t3 << 1) - n2 > 32 && tr)
      return tr.decode(m.subarray(n2, e2));
  ...
  function or(n2, r3, e2) {
    if (void 0 === e2 && (e2 = 2147483647), e2 < 2)
      return 0;
  ...
  function cr(n2, r3, e2) {
    if (void 0 === e2 && (e2 = 2147483647), e2 < 4)
      return 0;
    for (var t3 = r3, i3 = t3 + e2 - 4, o4 = 0; o4 < n2.length; ++o4) {
      var a3 = n2.charCodeAt(o4);
      if (a3 >= 55296 && a3 <= 57343 && (a3 = 65536 + ((1023 & a3) << 10) | 1023 & n2.charCodeAt(++o4)), _[r3 >> 2] = a3, (r3 += 4) + 4 > i3)
        break;
    }
  ...
  function sr(n2, r3, e2) {
    var t3, i3, o4, a3, u2;
    e2 = wn(e2), 2 === r3 ? (t3 = ir, i3 = or, a3 = ar, o4 = () => y, u2 = 1) : 4 === r3 && (t3 = ur, i3 = cr, a3 = fr, o4 = () => w, u2 = 2), Tn(n2, { name: e2, fromWireType: function(n3) {
  ...
  function lr(n2, r3, e2, t3, i3, o4) {
    nn[n2] = { name: wn(r3), rawConstructor: Bn(e2, t3), rawDestructor: Bn(i3, o4), fields: [] };
  }
  function dr(n2, r3, e2, t3, i3, o4, a3, u2, c2, f2) {
    nn[n2].fields.push({ fieldName: wn(r3), getterReturnType: e2, getter: Bn(t3, i3), getterContext: o4, setterArgumentType: a3, setter: Bn(u2, c2), setterContext: f2 });
  }
  function pr(n2, r3) {
  ...
  function Cr(n2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o4 = r3 * (1 + 0.2 / i3);
      if (o4 = Math.min(o4, n2 + 100663296), Tr(Math.min(e2, t3(Math.max(n2, o4), 65536))))
        return true;
    }
    return false;
  }
...
//# sourceMappingURL=i3s-EWQB3TFL.js.map
