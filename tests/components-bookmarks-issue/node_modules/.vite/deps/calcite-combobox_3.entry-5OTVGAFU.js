...
var ComboboxItem$1 = "CALCITE-COMBOBOX-ITEM";
var ComboboxItemGroup$1 = "CALCITE-COMBOBOX-ITEM-GROUP";
var ComboboxChildSelector = `${ComboboxItem$1}, ${ComboboxItemGroup$1}`;
var CSS$3 = {
...
function getAncestors(element) {
  var _a, _b;
  const parent = (_a = element.parentElement) == null ? void 0 : _a.closest(ComboboxChildSelector);
  const grandparent = (_b = parent == null ? void 0 : parent.parentElement) == null ? void 0 : _b.closest(ComboboxChildSelector);
...
var isGroup = (el) => el.tagName === ComboboxItemGroup$1;
...
var Combobox = class {
  constructor(hostRef) {
    ...
    this.clickHandler = (event) => {
      ...
      if (composedPath.some((node) => {
        var _a;
        return (_a = node.classList) == null ? void 0 : _a.contains(CSS$2.button);
      })) {
        this.clearValue();
        event.preventDefault();
        return;
  ...
  renderAllSelectedIndicatorChip() {
    ...
    return h("calcite-chip", {
      class: {
        chip: true,
        [CSS$3.chipInvisible]: !(this.isAllSelected() && !selectedVisibleChipsCount && !compactSelectionDisplay)
      },
      scale,
      title: label,
      value: "",
...
var ComboboxItem = class {
  ...
  render() {
    ...
    return h(Host, { "aria-hidden": "true" }, h(InteractiveContainer, { disabled }, h("div", { class: `container scale--${this.scale}`, style: { "--calcite-combobox-item-spacing-indent-multiplier": `${depth}` } }, h("li", { class: classes, id: this.guid, onClick: this.itemClickHandler }, this.renderSelectIndicator(showDot, iconPath), this.renderIcon(iconPath), h("span", { class: "title" }, this.textLabel)), this.renderChildren())));
  }
  get el() {
    return getElement(this);
  }
...
export {
  Combobox as calcite_combobox,
  ComboboxItem as calcite_combobox_item,
  ComboboxItemGroup as calcite_combobox_item_group
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-combobox_3.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-combobox_3.entry-5OTVGAFU.js.map
