...
var Action = class {
  ...
  renderIconContainer() {
    ...
    const calciteIconNode = icon ? h("calcite-icon", { class: { [CSS.indicatorWithIcon]: indicator }, flipRtl: iconFlipRtl, icon, scale: getIconScale(this.scale) }) : null;
  ...
  render() {
    ...
    return h(Host, null, h(InteractiveContainer, { disabled }, h("button", {
    ...
    }, this.renderIconContainer(), this.renderTextContainer(), !icon && indicator && h("div", { class: CSS.indicatorWithoutIcon, key: "indicator-no-icon" })), h("slot", { name: SLOTS.tooltip, onSlotchange: this.handleTooltipSlotChange }), this.renderIndicatorText()));
  }
...
export {
  Action as calcite_action
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-action.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-action.entry-6VMMCPFK.js.map
