...
function r(e = c()) {
  ...
  return { decimal: s2, group: l2, pattern: o3 };
}
function s(e, t) {
...
function o2(e, t, n2) {
  ...
  return false === n2.fractional && (n2.places = 0), t.replace(c3, i(e, p2[0], { decimal: s2, group: r2, places: n2.places, round: n2.round }));
}
function i(e, t, n2) {
...
function c2(t) {
  ...
  const p2 = g(c3, (n3) => (n3 = "(?:" + o(n3, ".") + ")").replace(l, (e) => {
    const n4 = { signed: false, separator: t.strict ? o3 : [o3, ""], fractional: t.fractional, decimal: i2, exponent: false }, r2 = e.split(".");
    let s3 = t.places;
...
//# sourceMappingURL=chunk-QD3CP3I4.js.map
