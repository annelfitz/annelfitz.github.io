...
var TableRow = class {
  constructor(hostRef) {
    ...
    this.keyDownHandler = (event) => {
      ...
      if (el.matches("calcite-table-cell") || el.matches("calcite-table-header")) {
        switch (key) {
          ...
          case "End":
            if (isControl) {
              this.emitTableRowFocusRequest((_a = this.rowCells) == null ? void 0 : _a.length, this.positionAll, "last", true);
              event.preventDefault();
            } else {
    ...
    this.updateCells = () => {
      var _a, _b, _c, _d;
      const slottedCells = (_b = (_a = this.tableRowSlotEl) == null ? void 0 : _a.assignedElements({ flatten: true })) == null ? void 0 : _b.filter((el) => el.matches("calcite-table-cell") || el.matches("calcite-table-header"));
      const renderedCells = (_d = Array.from((_c = this.tableRowEl) == null ? void 0 : _c.querySelectorAll("calcite-table-header, calcite-table-cell"))) == null ? void 0 : _d.filter((el) => el.numberCell || el.selectionCell);
      const cells = renderedCells ? renderedCells.concat(slottedCells) : slottedCells;
      if (cells.length > 0) {
        cells == null ? void 0 : cells.forEach((cell, index) => {
      ...
      this.rowCells = cells || [];
      this.cellCount = cells == null ? void 0 : cells.length;
    };
  ...
  calciteInternalTableRowFocusChangeHandler(event) {
    ...
    if (event.target.contains(this.el)) {
      ...
      if (rowPosition === this.positionAll) {
        ...
        const cellPosition = lastCell ? this.rowCells[this.rowCells.length - 1] : (_a = this.rowCells) == null ? void 0 : _a.find((_, index) => index + 1 === position);
        if (cellPosition) {
  ...
  renderSelectionIcon() {
    ...
    return h("calcite-icon", { icon, scale: getIconScale(this.scale) });
  }
  ...
  render() {
    ...
    }, this.numbered && this.renderNumberedCell(), this.selectionMode !== "none" && this.renderSelectableCell(), h("slot", { onSlotchange: this.updateCells, ref: (el) => this.tableRowSlotEl = el }))));
  }
  get el() {
...
export {
  TableRow as calcite_table_row
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-table-row.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-table-row.entry-LJT3BPLS.js.map
