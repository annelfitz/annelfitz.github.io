...
var Alert = class {
  ...
  render() {
    ...
    return h(Host, { "aria-hidden": toAriaBoolean(hidden), "aria-label": label, "calcite-hydrated-hidden": hidden, role }, h("div", {
      class: {
        [CSS.container]: true,
    ...
    }, effectiveIcon && this.renderIcon(effectiveIcon), h("div", { class: CSS.textContainer }, h("slot", { name: SLOTS.title }), h("slot", { name: SLOTS.message }), h("slot", { name: SLOTS.link })), this.renderActionsEnd(), hasQueuedAlerts ? this.renderQueueCount() : null, this.renderCloseButton(), open && !queued && autoClose ? h("div", { class: CSS.dismissProgress }) : null));
  }
  renderCloseButton() {
    return h("button", {
    ...
    }, h("calcite-icon", { icon: "x", scale: getIconScale(this.scale) }));
  }
  renderQueueCount() {
  ...
  renderIcon(icon) {
    return h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon, scale: getIconScale(this.scale) }));
  }
  ...
  determineActiveAlert() {
    var _a;
    if (((_a = this.queue) == null ? void 0 : _a[0]) === this.el) {
      this.openAlert();
      if (this.autoClose && !this.autoCloseTimeoutId) {
...
export {
  Alert as calcite_alert
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-alert.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-alert.entry-C2ZYLYWF.js.map
