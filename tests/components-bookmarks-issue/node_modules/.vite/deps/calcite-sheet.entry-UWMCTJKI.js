...
var Sheet = class {
  ...
  render() {
    ...
    } }, h("calcite-scrim", { class: CSS.scrim, onClick: this.handleOutsideClose }), h("div", {
      class: {
        [CSS.content]: true
      },
...
export {
  Sheet as calcite_sheet
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-sheet.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-sheet.entry-UWMCTJKI.js.map
