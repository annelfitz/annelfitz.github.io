...
var Notice = class {
  ...
  render() {
    ...
    }, this.requestedIcon ? h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: getIconScale(this.scale) })) : null, h("div", { class: CSS.content }, h("slot", { name: SLOTS.title }), h("slot", { name: SLOTS.message }), h("slot", { name: SLOTS.link })), hasActionEnd ? h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd })) : null, this.closable ? closeButton : null);
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
export {
  Notice as calcite_notice
};
/*! Bundled license information:

@esri/calcite-components/dist/esm/calcite-notice.entry.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=calcite-notice.entry-FG2JSL6K.js.map
