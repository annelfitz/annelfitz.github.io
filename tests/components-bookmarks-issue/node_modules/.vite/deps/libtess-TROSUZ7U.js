...
var o2;
var i = { exports: {} };
e = i, r = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, o2 = function(t = {}) {
  var n2, e2, o3 = t;
  o3.ready = new Promise((t2, r2) => {
    n2 = t2, e2 = r2;
  });
  var i2 = Object.assign({}, o3), a2 = "object" == typeof window, u2 = "function" == typeof importScripts;
  "object" == typeof process && "object" == typeof process.versions && process.versions.node;
  var f, s = "";
  function c(t2) {
    return o3.locateFile ? o3.locateFile(t2, s) : s + t2;
  }
  ...
  var l, p, h = o3.print || console.log.bind(console), m = o3.printErr || console.error.bind(console);
  Object.assign(o3, i2), i2 = null, o3.arguments && o3.arguments, o3.thisProgram && o3.thisProgram, o3.quit && o3.quit, o3.wasmBinary && (l = o3.wasmBinary), "object" != typeof WebAssembly && O("no native wasm support detected");
  var y, d, v = false;
  function g() {
    var t2 = p.buffer;
    o3.HEAP8 = new Int8Array(t2), o3.HEAP16 = new Int16Array(t2), o3.HEAPU8 = y = new Uint8Array(t2), o3.HEAPU16 = new Uint16Array(t2), o3.HEAP32 = new Int32Array(t2), o3.HEAPU32 = d = new Uint32Array(t2), o3.HEAPF32 = new Float32Array(t2), o3.HEAPF64 = new Float64Array(t2);
  }
  var b = [], w = [], A = [];
  function E() {
    if (o3.preRun)
  ...
  function x(t2) {
    var _a;
    j++, (_a = o3.monitorRunDependencies) == null ? void 0 : _a.call(o3, j);
  }
  function T(t2) {
    var _a;
    if (j--, (_a = o3.monitorRunDependencies) == null ? void 0 : _a.call(o3, j), 0 == j && I) {
      var n3 = I;
      I = null, n3();
    }
  }
  function O(t2) {
    var _a;
    (_a = o3.onAbort) == null ? void 0 : _a.call(o3, t2), m(t2 = "Aborted(" + t2 + ")"), v = true, t2 += ". Build with -sASSERTIONS for more info.";
  ...
  function k() {
    ...
    if (x(), o3.instantiateWasm)
      try {
        return o3.instantiateWasm(t2, n3);
      } catch (i3) {
  ...
  var L, z = () => {
    ...
    if (t2 > e3)
      return false;
    for (var r2 = (t3, n4) => t3 + (n4 - t3 % n4) % n4, o4 = 1; o4 <= 4; o4 *= 2) {
      var i3 = n3 * (1 + 0.2 / o4);
    ...
    for (var r2 = n3 + e3, o4 = n3; t2[o4] && !(o4 >= r2); )
      ++o4;
    if (o4 - n3 > 16 && t2.buffer && J)
      return J.decode(t2.subarray(n3, o4));
    for (var i3 = ""; n3 < o4; ) {
      var a3 = t2[n3++];
      if (128 & a3) {
        var u3 = 63 & t2[n3++];
  ...
  o3._malloc = (t2) => (o3._malloc = nt.k)(t2), o3._free = (t2) => (o3._free = nt.l)(t2), o3._triangulate = (t2, n3, e3, r2, i3, a3) => (o3._triangulate = nt.n)(t2, n3, e3, r2, i3, a3);
  ...
  function ct() {
    function t2() {
      et || (et = true, o3.calledRun = true, v || (R(), n2(o3), o3.onRuntimeInitialized && o3.onRuntimeInitialized(), P()));
    }
    j > 0 || (E(), j > 0 || (o3.setStatus ? (o3.setStatus("Running..."), setTimeout(function() {
      setTimeout(function() {
        o3.setStatus("");
      }, 1), t2();
    }, 1)) : t2()));
  ...
  let vt = 0;
  const gt = (t2, n3, e3) => {
    lt || (lt = o3._triangulate);
    let r2 = o3.HEAPF32;
    const i3 = o3.HEAP32.BYTES_PER_ELEMENT, a3 = 2, u3 = r2.BYTES_PER_ELEMENT;
    e3 > vt && (vt = e3, ht && (o3._free(ht), ht = 0), pt && (o3._free(pt), pt = 0)), ht || (ht = o3._malloc(e3 * u3)), mt || (mt = o3._malloc(dt * i3));
    const f2 = e3 * yt;
    pt || (pt = o3._malloc(f2 * u3)), r2 = o3.HEAPF32, r2.set(t2, ht / u3), o3.HEAP32.set(n3, mt / i3);
  ...
  return o3.triangulate = gt, t.ready;
}, e.exports = o2;
var a = i.exports;
var u = n({ __proto__: null, default: o(a) }, [a]);
export {
  u as l
};
//# sourceMappingURL=libtess-TROSUZ7U.js.map
