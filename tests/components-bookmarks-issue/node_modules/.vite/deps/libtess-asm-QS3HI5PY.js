...
f = n, i = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, a = function(r = {}) {
      ...
      function v2(r4) {
            ...
            e: {
                          ...
                          o: {
                            if ((r5 |= 0) >>> 0 <= 244) {
                              if (3 & (e5 = (t4 = k3[854]) >>> (f4 = (b5 = r5 >>> 0 < 11 ? 16 : r5 + 11 & 504) >>> 3 | 0) | 0)) {
                                e5 = 3456 + (r5 = (f4 = f4 + (1 & ~e5) | 0) << 3) | 0, i4 = k3[r5 + 3464 >> 2], (0 | e5) != (0 | (r5 = k3[i4 + 8 >> 2])) ? (k3[r5 + 12 >> 2] = e5, k3[e5 + 8 >> 2] = r5) : (A3 = 3416, l3 = Vr(f4) & t4, k3[A3 >> 2] = l3), r5 = i4 + 8 | 0, e5 = f4 << 3, k3[i4 + 4 >> 2] = 3 | e5, k3[4 + (e5 = e5 + i4 | 0) >> 2] = 1 | k3[e5 + 4 >> 2];
                                break r;
                              }
                              if ((c3 = k3[856]) >>> 0 >= b5 >>> 0)
                                break o;
                              ...
                              k: {
                                u: {
                                  if (e5 = k3[3720 + (t4 << 2) >> 2])
                                    for (r5 = 0, f4 = b5 << (31 != (0 | t4) ? 25 - (t4 >>> 1 | 0) : 0); ; ) {
                    ...
                    n: {
                      t: {
                        ...
                        if (r5 = 31, n5 >>> 0 <= 16777215 && (r5 = 62 + ((n5 >>> 38 - (r5 = E2(n5 >>> 8 | 0)) & 1) - (r5 << 1) | 0) | 0), k3[a5 + 28 >> 2] = r5, k3[a5 + 16 >> 2] = 0, k3[a5 + 20 >> 2] = 0, e5 = 3720 + (r5 << 2) | 0, (i4 = k3[855]) & (f4 = 1 << r5)) {
                          for (r5 = n5 << (31 != (0 | r5) ? 25 - (r5 >>> 1 | 0) : 0), i4 = k3[e5 >> 2]; ; ) {
                            ...
                            if (k3[a5 + 4 >> 2] = -2 & f4, k3[o5 + 4 >> 2] = 1 | t4, k3[t4 + o5 >> 2] = t4, t4 >>> 0 <= 255)
                              ...
                              b: {
                                if ((i4 = k3[855]) & (r5 = 1 << f4)) {
                                  for (f4 = t4 << (31 != (0 | f4) ? 25 - (f4 >>> 1 | 0) : 0), r5 = k3[e5 >> 2]; ; ) {
              ...
              f:
                if (a5 >>> 0 <= 15)
                  ...
                  i: {
                    if ((f4 = 1 << r5) & u3) {
                      for (r5 = a5 << (31 != (0 | r5) ? 25 - (r5 >>> 1 | 0) : 0), b5 = k3[e5 >> 2]; ; ) {
              ...
              e: {
                ...
                if ((0 | i4) < 0)
                  for (R3 = 1 + ((d3 + 25 >>> 0) / 9 | 0) | 0, E3 = 102 == (0 | M3); ; ) {
                    if (h3 = (0 | (i4 = 0 - i4 | 0)) >= 9 ? 9 : i4, t4 >>> 0 <= c3 >>> 0)
                      ...
                      for (y3 = 1e9 >>> h3 | 0, s3 = ~(-1 << h3), i4 = 0, o5 = c3; _3 = i4, i4 = k3[o5 >> 2], k3[o5 >> 2] = _3 + (i4 >>> h3 | 0), i4 = p2(y3, i4 & s3), (o5 = o5 + 4 | 0) >>> 0 < t4 >>> 0; )
                        ;
                ...
                if (i4 = 0, !(t4 >>> 0 <= c3 >>> 0 || (i4 = p2(m3 - c3 >> 2, 9), o5 = 10, (s3 = k3[c3 >> 2]) >>> 0 < 10)))
                  for (; i4 = i4 + 1 | 0, s3 >>> 0 >= (o5 = p2(o5, 10)) >>> 0; )
                    ;
                if ((0 | (o5 = (d3 - (102 != (0 | M3) ? i4 : 0) | 0) - (103 == (0 | M3) & !!(0 | d3)) | 0)) < (p2(t4 - m3 >> 2, 9) - 9 | 0)) {
                ...
                for (; s3 = t4, !(y3 = t4 >>> 0 <= c3 >>> 0) && !k3[(t4 = t4 - 4 | 0) >> 2]; )
                  ;
                if (103 == (0 | M3)) {
                  if (d3 = ((t4 = (0 | (o5 = d3 || 1)) > (0 | i4) & (0 | i4) > -5) ? ~i4 : -1) + o5 | 0, n5 = (t4 ? -1 : -2) + n5 | 0, !(l3 = 8 & a5)) {
                                              ...
                                              l: {
                                                v: {
                                                  d: {
                                                        ...
                                                        y: {
                                                          p: {
                                                            ...
                                                            if (e5 = E3, (s3 = k3[c3 + 64 >> 2]) | (u3 = k3[c3 + 68 >> 2]))
                                                              for (F3 = 32 & t4; b4[0 | (e5 = e5 - 1 | 0)] = F3 | v3[1600 + (15 & s3) | 0], S3 = !u3 & s3 >>> 0 > 15 | !!(0 | u3), h3 = u3, u3 = u3 >>> 4 | 0, s3 = (15 & h3) << 28 | s3 >>> 4, S3; )
                                                                ;
                                                          ...
                                                          if (e5 = E3, u3 = t4 = k3[c3 + 68 >> 2], t4 | (s3 = k3[c3 + 64 >> 2]))
                                                            for (; b4[0 | (e5 = e5 - 1 | 0)] = 7 & s3 | 48, h3 = !u3 & s3 >>> 0 > 7 | !!(0 | u3), u3 = (t4 = u3) >>> 3 | 0, s3 = (7 & t4) << 29 | s3 >>> 3, h3; )
                                                              ;
                                                          if (s3 = e5, !(8 & d3))
                                                            break h;
                                                    ...
                                                    if ((0 | A3) < 0 & I3)
                                                      break i;
                                                    if (d3 = I3 ? -65537 & d3 : d3, !(A3 | !!((e5 = k3[c3 + 64 >> 2]) | (t4 = k3[c3 + 68 >> 2])))) {
                                                      s3 = E3, A3 = 0;
                                                      break b;
                                                    }
                                                  ...
                                                  d: {
                                                    h: {
                                                      w: {
                                                        ...
                                                        if (!(!v3[0 | e5] | h3 >>> 0 < 4))
                                                          for (; ; ) {
                                                            if (~(t4 = k3[e5 >> 2]) & t4 - 16843009 & -2139062144)
                                                              break w;
                ...
                e: {
                  f: {
                    if ((a5 = k3[855]) & (t4 = 1 << f4)) {
                      for (f4 = r5 << (31 != (0 | f4) ? 25 - (f4 >>> 1 | 0) : 0), e5 = k3[e5 >> 2]; ; ) {
          ...
          r: {
            ...
            e: {
              if ((a5 = k3[855]) & (t4 = 1 << i4)) {
                for (i4 = e5 << (31 != (0 | i4) ? 25 - (i4 >>> 1 | 0) : 0), f4 = k3[f4 >> 2]; ; ) {
        ...
        function hr2(r5, e5, f4) {
          switch (e5 - 100100 | 0) {
            ...
            case 4:
              return b4[r5 + 80 | 0] = !!(0 | f4), void (k3[r5 + 92 >> 2] = f4 || 14);
            case 10:
              return b4[r5 + 80 | 0] = !!(0 | f4), void (k3[r5 + 1720 >> 2] = f4 || 4);
            case 1:
  ...
  function Q(r2) {
    var _a;
    B++, (_a = a2.monitorRunDependencies) == null ? void 0 : _a.call(a2, B);
  }
  function T(r2) {
    var _a;
    if (B--, (_a = a2.monitorRunDependencies) == null ? void 0 : _a.call(a2, B), 0 == B && F) {
      var e3 = F;
      F = null, e3();
    }
  }
  function H(r2) {
    var _a;
    (_a = a2.onAbort) == null ? void 0 : _a.call(a2, r2), A(r2 = "Aborted(" + r2 + ")"), p = true, r2 += ". Build with -sASSERTIONS for more info.";
...
var t = n.exports;
var b = e({ __proto__: null, default: o(t) }, [t]);
export {
  b as l
};
//# sourceMappingURL=libtess-asm-QS3HI5PY.js.map
