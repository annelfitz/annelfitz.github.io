...
var m2 = class extends n(u2) {
  ...
  async elevationAlignPointsInFeatures(e2, s2) {
    ...
    if (null == (i == null ? void 0 : i.graphics3DGraphics))
      throw new s("graphicslayerview3d:missing-processor", "A Graphics3D processor is needed to resolve graphics elevation.");
    const { graphics3DGraphics: t2 } = i, o = (e3) => "number" == typeof e3 ? t2.get(e3) : void 0;
    return m(this.view, this.layer, o, e2, s2);
  }
  ...
  get performanceInfo() {
    return new t(this.usedMemory, this.loadedGraphics.length, -1, -1);
  }
  get usedMemory() {
    var _a, _b;
...
e([y()], m2.prototype, "loadedGraphics", null), e([y({ readOnly: true })], m2.prototype, "legendEnabled", null), e([y()], m2.prototype, "layer", void 0), e([y({ readOnly: true })], m2.prototype, "processor", void 0), e([y()], m2.prototype, "_slicePlaneEnabled", void 0), e([y({ type: Boolean })], m2.prototype, "slicePlaneEnabled", null), m2 = e([a("esri.views.3d.layers.GraphicsLayerView3D")], m2);
var y2 = m2;
export {
  y2 as default
};
//# sourceMappingURL=GraphicsLayerView3D-TPDTNDCM.js.map
