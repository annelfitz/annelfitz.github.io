...
n = i, e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, "undefined" != typeof __filename && (e = e || __filename), r = function(t) {
  ...
  var i2, o3, u2, s, a, c, f = Object.assign({}, t), p = "object" == typeof window, l = "function" == typeof importScripts, h = "object" == typeof process && "object" == typeof process.versions && "string" == typeof process.versions.node, d = "";
  function m(n3) {
    return t.locateFile ? t.locateFile(n3, d) : d + n3;
  }
  h ? (d = l ? require_path().dirname(d) + "/" : __dirname + "/", c = () => {
    a || (s = require_fs(), a = require_path());
  }, i2 = function(t2, n3) {
      ...
      if (128 & u3) {
        ...
        if (192 != (224 & u3)) {
          ...
          if ((u3 = 224 == (240 & u3) ? (15 & u3) << 12 | s2 << 6 | a2 : (7 & u3) << 18 | s2 << 12 | a2 << 6 | 63 & t2[n3++]) < 65536)
            o4 += String.fromCharCode(u3);
          else {
            var c2 = u3 - 65536;
            o4 += String.fromCharCode(55296 | c2 >> 10, 56320 | 1023 & c2);
          }
        } else
          o4 += String.fromCharCode((31 & u3) << 6 | s2);
      } else
        o4 += String.fromCharCode(u3);
    }
    return o4;
  ...
  function Q() {
    ...
    function u3() {
      return _ || "function" != typeof WebAssembly.instantiateStreaming || N(G) || Y(G) || h || "function" != typeof fetch ? o4(i3) : fetch(G, { credentials: "same-origin" }).then(function(t2) {
        return WebAssembly.instantiateStreaming(t2, n3).then(i3, function(t3) {
          return g("wasm streaming compile failed: " + t3), g("falling back to ArrayBuffer instantiation"), o4(i3);
        });
      });
    }
  ...
  function at(t2) {
    ...
    for (var i3 = 1; i3 <= 4; i3 *= 2) {
      var o4 = n3 * (1 + 0.2 / i3);
      if (o4 = Math.min(o4, t2 + 100663296), st(Math.min(e2, r3(Math.max(t2, o4), 65536))))
        return true;
    }
    return false;
  }
...
//# sourceMappingURL=lerc-wasm-AMULALN6.js.map
