...
r = a, t = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, n = function(e = {}) {
  ...
  var o3 = Object.assign({}, a2), i2 = "./this.program", u = true, s = "";
  function l(e2) {
  ...
  Object.assign(a2, o3), o3 = null, a2.arguments && a2.arguments, a2.thisProgram && (i2 = a2.thisProgram), a2.quit && a2.quit, a2.wasmBinary && (c = a2.wasmBinary), "object" != typeof WebAssembly && k("no native wasm support detected");
  ...
  function L() {
    ...
    if (R(), a2.instantiateWasm)
      try {
        ...
        d(`Module.instantiateWasm callback failed with error: ${o4}`), n2(o4);
      }
  ...
  var K, Q, ee, re = {}, te = {}, ne = {}, ae = (e2) => {
    ...
    var a3 = new Array(r3.length), o4 = [], i3 = 0;
    r3.forEach((e3, r4) => {
      te.hasOwnProperty(e3) ? a3[r4] = te[e3] : (o4.push(e3), re.hasOwnProperty(e3) || (re[e3] = []), re[e3].push(() => {
        a3[r4] = te[e3], ++i3 === o4.length && n3(a3);
      }));
    }), 0 === o4.length && n3(a3);
  }, ie = (e2) => {
    var r3 = J[e2];
    delete J[e2];
    var t2 = r3.elements, n3 = t2.length, a3 = t2.map((e3) => e3.getterReturnType).concat(t2.map((e3) => e3.setterArgumentType)), o4 = r3.rawConstructor, i3 = r3.rawDestructor;
    oe([e2], a3, function(e3) {
      return t2.forEach((r4, t3) => {
        var a4 = e3[t3], o5 = r4.getter, i4 = r4.getterContext, u2 = e3[t3 + n3], s2 = r4.setter, l2 = r4.setterContext;
        r4.read = (e4) => a4.fromWireType(o5(i4, e4)), r4.write = (e4, r5) => {
          var t4 = [];
    ...
    var r3 = ue[e2];
    delete ue[e2];
    var t2 = r3.rawConstructor, n3 = r3.rawDestructor, a3 = r3.fields, o4 = a3.map((e3) => e3.getterReturnType).concat(a3.map((e3) => e3.setterArgumentType));
    oe([e2], o4, (e3) => {
      var o5 = {};
      return a3.forEach((r4, t3) => {
        ...
        o5[n4] = { read: (e4) => i3.fromWireType(u2(s2, e4)), write: (e4, r5) => {
          var t4 = [];
  ...
  function je(e2, r3, t2, n3, a3, o4) {
    ...
    return function() {
      ...
      for (var o5 = 0; o5 < f2; ++o5)
        d2[o5] = r3[o5 + 2].toWireType(p2, arguments[o5]), h2.push(d2[o5]);
      function i4(e3) {
        if (s2)
          X(p2);
        else
  ...
  var ze, Be = (e2, r3) => {
    ...
    e2 = fe(e2), e2 = Ge(e2), a3 = Ye(n3, a3), De(e2, function() {
      ...
      return Re(e2, je(e2, n4, null, a3, o4), r3 - 1), [];
    });
  }, Je = (e2, r3, t2) => {
    switch (r3) {
      case 1:
        return t2 ? (e3) => h[0 | e3] : (e3) => p[0 | e3];
      case 2:
    ...
    pe(e2, { name: r3, fromWireType: o4, toWireType: u2 ? function(e3, r4) {
  ...
  var Qe = (e2, r3, t2, n3) => {
    if (!(n3 > 0))
      return 0;
    for (var a3 = t2, o4 = t2 + n3 - 1, i3 = 0; i3 < e2.length; ++i3) {
      ...
      if (128 & i3) {
        ...
        if (192 != (224 & i3)) {
          ...
          if ((i3 = 224 == (240 & i3) ? (15 & i3) << 12 | u2 << 6 | s2 : (7 & i3) << 18 | u2 << 12 | s2 << 6 | 63 & e2[r3++]) < 65536)
            o4 += String.fromCharCode(i3);
          else {
            var l2 = i3 - 65536;
            o4 += String.fromCharCode(55296 | l2 >> 10, 56320 | 1023 & l2);
          }
        } else
          o4 += String.fromCharCode((31 & i3) << 6 | u2);
      } else
        o4 += String.fromCharCode(i3);
    }
    return o4;
    ...
    pe(e2, { name: r3, fromWireType(e3) {
      ...
      if (t2)
        for (var o4 = a3, i3 = 0; i3 <= n3; ++i3) {
          var u2 = a3 + i3;
          if (i3 == n3 || 0 == p[u2]) {
            var s2 = ar(o4, u2 - o4);
            void 0 === r4 ? r4 = s2 : (r4 += String.fromCharCode(0), r4 += s2), o4 = u2 + 1;
          }
        }
      else {
        var l2 = new Array(n3);
      ...
      if (y[o4 >> 2] = n3, t2 && a3)
        ...
        for (u2 = 0; u2 < n3; ++u2)
          p[i3 + u2] = r4[u2];
      return null !== e3 && e3.push(ut, o4), o4;
    ...
    if (void 0 === t2 && (t2 = 2147483647), t2 < 2)
      return 0;
    for (var n3 = r3, a3 = (t2 -= 2) < 2 * e2.length ? t2 / 2 : e2.length, o4 = 0; o4 < a3; ++o4) {
      var i3 = e2.charCodeAt(o4);
      m[r3 >> 1] = i3, r3 += 2;
    }
    ...
    if (void 0 === t2 && (t2 = 2147483647), t2 < 4)
      return 0;
    for (var n3 = r3, a3 = n3 + t2 - 4, o4 = 0; o4 < e2.length; ++o4) {
      var i3 = e2.charCodeAt(o4);
      if (i3 >= 55296 && i3 <= 57343 && (i3 = 65536 + ((1023 & i3) << 10) | 1023 & e2.charCodeAt(++o4)), g[r3 >> 2] = i3, (r3 += 4) + 4 > a3)
        break;
    }
    ...
    var n3, a3, o4, i3, u2;
    t2 = fe(t2), 2 === r3 ? (n3 = ur, a3 = sr, i3 = lr, o4 = () => v, u2 = 1) : 4 === r3 && (n3 = cr, a3 = fr, i3 = dr, o4 = () => y, u2 = 2), pe(e2, { name: t2, fromWireType: (e3) => {
      for (var t3, a4 = y[e3 >> 2], i4 = o4(), s2 = e3 + 4, l2 = 0; l2 <= a4; ++l2) {
        var c2 = e3 + 4 + l2 * r3;
        if (l2 == a4 || 0 == i4[c2 >> u2]) {
          var f2 = n3(s2, c2 - s2);
      ...
      var o5 = i3(n4), s2 = st(4 + o5 + r3);
      return y[s2 >> 2] = o5 >> u2, a3(n4, s2 + 4, o5 + r3), null !== e3 && e3.push(ut, s2), s2;
    }, argPackAdvance: me, readValueFromPointer: Z, destructorFunction(e3) {
      ut(e3);
    } });
  }, pr = (e2, r3, t2, n3, a3, o4) => {
    J[e2] = { name: fe(r3), rawConstructor: Ye(t2, n3), rawDestructor: Ye(a3, o4), elements: [] };
  }, mr = (e2, r3, t2, n3, a3, o4, i3, u2, s2) => {
    J[e2].elements.push({ getterReturnType: r3, getter: Ye(t2, n3), getterContext: a3, setterArgumentType: o4, setter: Ye(i3, u2), setterContext: s2 });
  }, vr = (e2, r3, t2, n3, a3, o4) => {
    ue[e2] = { name: fe(r3), rawConstructor: Ye(t2, n3), rawDestructor: Ye(a3, o4), fields: [] };
  }, gr = (e2, r3, t2, n3, a3, o4, i3, u2, s2, l2) => {
    ue[e2].fields.push({ fieldName: fe(r3), getterReturnType: t2, getter: Ye(n3, a3), getterContext: o4, setterArgumentType: i3, setter: Ye(u2, s2), setterContext: l2 });
  }, yr = (e2, r3) => {
    ...
    for (var n3 = (e3, r4) => e3 + (r4 - e3 % r4) % r4, a3 = 1; a3 <= 4; a3 *= 2) {
      var o4 = r3 * (1 + 0.2 / a3);
      o4 = Math.min(o4, e2 + 100663296);
      var i3 = Math.min(t2, n3(Math.max(e2, o4), 65536));
      if (xr(i3))
        return true;
    }
    return false;
    ...
    for (var t2 = 0; t2 < e2.length; ++t2)
      h[0 | r3++] = e2.charCodeAt(t2);
    h[0 | r3] = 0;
  }, kr = (e2, r3) => {
    var t2 = 0;
    return Rr().forEach((n3, a3) => {
      var o4 = r3 + t2;
      y[e2 + 4 * a3 >> 2] = o4, $r(n3, o4), t2 += n3.length + 1;
    }), 0;
  }, Hr = (e2, r3) => {
    var t2 = Rr();
    y[e2 >> 2] = t2.length;
    ...
    for (var t2 = new Date(e2.getTime()); r3 > 0; ) {
      var n3 = Ir(t2.getFullYear()), a3 = t2.getMonth(), o4 = (n3 ? Yr : Vr)[a3];
      if (!(r3 > o4 - t2.getDate()))
        return t2.setDate(t2.getDate() + r3), t2;
      r3 -= o4 - t2.getDate() + 1, t2.setDate(1), a3 < 11 ? t2.setMonth(a3 + 1) : (t2.setMonth(0), t2.setFullYear(t2.getFullYear() + 1));
    }
    return t2;
  };
  function Br(e2, r3, t2) {
    var n3 = t2 > 0 ? t2 : rr(e2) + 1, a3 = new Array(n3), o4 = Qe(e2, a3, 0, a3.length);
    return r3 && (a3.length = o4), a3;
  }
  var Lr, Nr = (e2, r3) => {
    h.set(e2, r3);
  }, Gr = (e2, r3, t2, n3) => {
    ...
    function m2(e3) {
      var r4 = zr(new Date(e3.tm_year + 1900, 0, 1), e3.tm_yday), t3 = new Date(r4.getFullYear(), 0, 4), n4 = new Date(r4.getFullYear() + 1, 0, 4), a4 = p2(t3), o5 = p2(n4);
      return h2(a4, r4) <= 0 ? h2(o5, r4) <= 0 ? r4.getFullYear() + 1 : r4.getFullYear() : r4.getFullYear() - 1;
    }
    ...
    for (var s2 in i3 = i3.replace(/%%/g, "\0\0"), v2)
      i3.includes(s2) && (i3 = i3.replace(new RegExp(s2, "g"), v2[s2](o4)));
  ...
  if (a2.dynCall_viji = (e2, r3, t2, n3, o4) => (a2.dynCall_viji = it.M)(e2, r3, t2, n3, o4), a2.dynCall_ji = (e2, r3) => (a2.dynCall_ji = it.N)(e2, r3), a2.dynCall_viijii = (e2, r3, t2, n3, o4, i3, u2) => (a2.dynCall_viijii = it.O)(e2, r3, t2, n3, o4, i3, u2), a2.dynCall_iiiiij = (e2, r3, t2, n3, o4, i3, u2) => (a2.dynCall_iiiiij = it.P)(e2, r3, t2, n3, o4, i3, u2), a2.dynCall_iiiiijj = (e2, r3, t2, n3, o4, i3, u2, s2, l2) => (a2.dynCall_iiiiijj = it.Q)(e2, r3, t2, n3, o4, i3, u2, s2, l2), a2.dynCall_iiiiiijj = (e2, r3, t2, n3, o4, i3, u2, s2, l2, c2) => (a2.dynCall_iiiiiijj = it.R)(e2, r3, t2, n3, o4, i3, u2, s2, l2, c2), a2.addFunction = at, a2.UTF8ToString = ar, M = function e2() {
    ct || dt(), ct || (M = e2);
  }, a2.preInit)
...
var o2 = o(a.exports);
var i = Object.freeze(Object.defineProperty({ __proto__: null, default: o2 }, Symbol.toStringTag, { value: "Module" }));
export {
  i as l
};
//# sourceMappingURL=lyr3DMain-4GEAUNSW.js.map
