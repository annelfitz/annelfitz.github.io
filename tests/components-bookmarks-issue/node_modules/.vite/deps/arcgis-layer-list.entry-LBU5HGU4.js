...
var ArcgisLayerList = class {
  constructor(hostRef) {
    ...
    this.arcgisLayerListReady = createEvent(this, "arcgisLayerListReady", 7);
    this.layerListTriggerAction = createEvent(this, "layerListTriggerAction", 7);
    this._watchHandles = [];
  ...
  async triggerAction(action, item) {
    var _a;
    (_a = this.widget) == null ? void 0 : _a.triggerAction(action, item);
  }
  //--------------------------------------------------------------------------
  //
  //  Lifecycle
  ...
  async componentDidLoad() {
    ...
    const widget = await newWidgetsLayerList(params);
    this.widget = widget;
  ...
  _proxyEvents() {
    var _a;
    (_a = this.widget) == null ? void 0 : _a.on("trigger-action", (e) => this.layerListTriggerAction.emit(e));
  }
  get el() {
...
@arcgis/map-components/dist/esm/arcgis-layer-list.entry.js:
   ...
   *)
*/
//# sourceMappingURL=arcgis-layer-list.entry-LBU5HGU4.js.map
