...
var ArcgisAreaMeasurement3d = class {
  constructor(hostRef) {
    ...
    this.arcgisAreaMeasurement3dReady = createEvent(this, "arcgisAreaMeasurement3dReady", 7);
  ...
  async clear() {
    var _a;
    (_a = this.widget) == null ? void 0 : _a.viewModel.clear();
  }
  async start() {
    var _a;
  ...
  async componentDidLoad() {
    ...
    this.arcgisAreaMeasurement3dReady.emit();
    checkForView(this);
  }
  ...
  async _addWatchers() {
    ...
    addHandles(this, [
      watch(() => this.widget.analysis, (value) => {
        this.analysis = value;
...
@arcgis/map-components/dist/esm/arcgis-area-measurement-3d.entry.js:
   ...
   *)
*/
//# sourceMappingURL=arcgis-area-measurement-3d.entry-WMAPK244.js.map
