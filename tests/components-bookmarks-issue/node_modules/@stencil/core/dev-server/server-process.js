/*!
 Stencil Dev Server Process v4.9.0 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
var signalExit$1 = createCommonjsModule(function (module) {
...
const setExitHandler$2 = async (spawned, {cleanup, detached}, timedPromise) => {
	...
	const removeExitHandler = signalExit$1(() => {
		spawned.kill();
	});
